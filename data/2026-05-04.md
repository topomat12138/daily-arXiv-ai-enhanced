...
### [1] [Long range proximity effects in planar structures involving the halfmetal ferromagnet La0.7Sr0.3MnO3 and Pt interlayers](https://arxiv.org/abs/2605.00577)
*Junxiang Yao, Julian van Doorn, Mariona Cabero, Jan Aarts*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.00577)

**TL;DR**: Experimental study of planar La0.7Sr0.3MnO3 (LSMO) nanostrip Josephson junctions with NbTi contacts finds robust long-range triplet supercurrents (previously observed up to 1.3 μm). Systematic dependence of Ic on strip length and width is not observed, likely due to fabrication variability. Introducing a Pt interlayer at the LSMO/NbTi interface yields sharp transitions and zero-resistance states for electrode separations of 2 μm, indicating improved triplet generation and promise for even larger distances.  
**Method**: Device fabrication and low-temperature transport measurements: patterned LSMO nanostrip Josephson junctions with NbTi superconducting contacts (varying strip length and width) and a separate NbTi/Pt electrode structure etched on full LSMO films; characterization via critical current (Ic) vs geometry and superconducting transition/zero-resistance measurements to assess triplet-mediated supercurrent and interface effects.  
**Tags**: `superconducting_impurity, quantum_devices, triplet_superconductivity, half-metal, Josephson_junction, LSMO, NbTi, Pt_interlayer, interface_engineering`
...
**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.00477)

**TL;DR**: Observation of a zero-field Josephson diode effect in noncentrosymmetric 2H-TaS2/2H-NbSe2 van der Waals junctions; experimental controls and nonlinear Hall measurements argue against extrinsic mechanisms and support an intrinsic multiband superconducting phase in 2H-TaS2 that breaks time-reversal symmetry. Modeling shows interband scattering can produce an anomalous phase difference and a nonsinusoidal, asymmetric current–phase relation that yields zero-field rectification.  
**Method**: Combined experimental transport study (zero-field Josephson diode measurements in TaS2/NbSe2 vdW junctions, symmetry-controlled and molecule-intercalated control devices, normal-state nonlinear Hall measurements) together with Josephson-junction modeling showing interband-scattering-induced phase locking that generates an intrinsic anomalous phase and nonsinusoidal asymmetric current–phase relation.  
**Tags**: `superconductivity,time-reversal-symmetry-breaking,Josephson_diode,Josephson_junction,multiband_superconductivity,interband_scattering,nonlinear_Hall,van_der_Waals_heterostructure,quantum_devices`
...
### [3] [Demonstration of a fermion Quadrupling Condensate via Quantum Monte Carlo Simulation](https://arxiv.org/abs/2605.00137)
*Alexandru Golic, Egor Babaev, Johan Carlström*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.00137)

**TL;DR**: Microscopic fermion model with correlated hopping is shown (via sign-problem-mitigated large-scale Monte Carlo) to host a fermion-quadrupling condensate (charge-4e / charge-0 counterflow) with a transition temperature of order the hopping energy, providing direct numerical evidence for quartic fermionic order and suggesting experimental relevance for ultracold atoms.  
**Method**: Design of a correlated-hopping fermionic lattice model that substantially reduces the fermionic sign problem, followed by rigorous large-scale Monte Carlo simulations to detect and characterize a finite-temperature fermion-quadrupling (quartet) condensate and its transition temperature.  
**Tags**: `charge-4e, fermion-quadrupling, correlated-hopping, quantum_monte_carlo, sign_problem, ultracold_atoms, unconventional_superconductivity`
...
### [4] [Superconducting diode effect in correlated electron systems by nonreciprocal magnetism](https://arxiv.org/abs/2605.00601)
*Kyohei Nakamura, Youichi Yanase*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.00601)

**TL;DR**: Correlation-driven mechanism for the superconducting diode effect (SDE): in the Rashba–Zeeman–Hubbard model (d-wave superconductivity near an antiferromagnetic quantum critical point) electron correlations suppress the conventional depairing-current SDE but enable a dominant effect where a supercurrent nonreciprocally induces antiferromagnetic order, which controls the critical current and can produce perfect diode efficiency.  
**Method**: Solution of the Dyson–Gor'kov equations for the Rashba–Zeeman–Hubbard model using the fluctuation–exchange (FLEX) approximation to treat electronic correlations and to compute superconducting order, magnetic response, and nonreciprocal critical currents.  
**Tags**: `superconductivity, superconducting_diode, strong_correlations, antiferromagnetism, quantum_criticality, Rashba_spin-orbit, Hubbard_model, d-wave_pairing, Dyson-Gor'kov, fluctuation-exchange`
...
### [5] [Experimental Evidence of Fractional Entropy in Critical Kondo Systems](https://arxiv.org/abs/2605.00669)
*C. Piquard, A. Veillon, Y. Sato, F. Zanichelli, A. Aassime, A. Cavanna, U. Gennser, A. K. Mitchell, A. Anthore, F. Pierre*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.00669)

**TL;DR**: Authors report experimental observation of fractional low-temperature entropy ΔS associated with single non-Abelian anyons by tuning a micrometre-scale metallic island coupled to two or three leads into two-channel and three-channel Kondo critical points; extracted ΔS via charge measurements and a Maxwell thermodynamic relation matches kB ln(√2) (Majorana) and kB ln(φ) (Fibonacci), supporting non-Abelian statistics.  
**Method**: Engineered metal–semiconductor quantum circuits with a micrometre-scale metallic island coupled to two or three electronic leads are tuned to two- and three-channel Kondo quantum-critical points. The island charge is measured and a thermodynamic Maxwell relation is applied to extract the low-temperature entropy difference ΔS, which is compared to theoretical kB ln(d) predictions for non-Abelian anyons.  
**Tags**: `topology, quantum_computing, quantum_devices, two-channel_Kondo, three-channel_Kondo, Majorana, Fibonacci_anyon, fractional_entropy, thermodynamic_measurement, quantum_criticality, metal-semiconductor_circuit`
...
### [6] [Suppressing spin qubit decoherence during shuttling via confinement modulation](https://arxiv.org/abs/2605.00611)
*Daniel Q. L. Nguyen, Maximilian Rimbach-Russ, Stefano Bosco*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.00611)

**TL;DR**: Confinement-modulated ‘breathing’ shuttling protocols use electrically driven spin-orbit coupling to implement continuous dressed-state rotations of hole-spin qubits during transport, providing dynamical decoupling that suppresses low-frequency magnetic and electric noise and significantly improves coherence; effectiveness depends on noise correlation length and is demonstrated for Ge hole-spin devices.  
**Method**: Introduce temporal and spatial ‘‘breathing’’ modulation of the confinement potential to electrically drive hole spins via spin–orbit interaction, realising continuous dressed-state shuttling (continuous dynamical decoupling). Analyze noise-filtering and identify optimal driving regimes using the filter-function formalism; evaluate performance for both global and local magnetic/electric noise and apply the framework to germanium hole-spin qubits.  
**Tags**: `quantum_computing, quantum_devices, dynamical_decoupling, spin_qubits, hole_spin, spin_orbit, filter_function, coherent_shuttling, germanium`
...
### [7] [Observation of single antiferromagnetic magnon modes in the tunnelling transistors of spin-1/2 Kitaev system a-RuCl3](https://arxiv.org/abs/2605.00202)
*Servet Ozdemir, Mikhail Kashchenko, Kostya S. Novoselov*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.00202)

**TL;DR**: Planar transport and tunnelling spectroscopy on atomically thin α‑RuCl3 films report n‑type semiconducting behavior at room temperature, a crossover to Mott‑insulating behavior below ≈120 K, and inelastic tunnelling features appearing below the Néel temperature (7–14.5 K) that are attributed to single‑magnon modes—evidence that the bulk zigzag antiferromagnetic order and its magnon signatures persist in few‑layer limit, with implications for probing proximate quantum spin liquid / Majorana physics in devices.  
**Method**: Systematic electrical characterization combining planar transport and tunnelling spectroscopy on van‑der‑Waals α‑RuCl3 films (focus on ≤3 layers), temperature‑dependent measurements down to <T_N to resolve inelastic scattering features attributed to magnon excitations.  
**Tags**: `quantum_spin_liquid,Mott_insulator,antiferromagnetism,magnon,tunneling_spectroscopy,van_der_Waals,alpha-RuCl3,quantum_devices,Majorana`
...
### [8] [Thermodynamic Charge Partition in Accumulation-Layer Heterostructures](https://arxiv.org/abs/2605.00441)
*Elmar Böckenhoff*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.00441)

**TL;DR**: Thermodynamic framework that treats the partition of induced sheet density between a near-interface accumulation layer and surrounding screening charge as a central state variable, yielding a complete Helmholtz free energy, modified chemical/release potentials, and a spectral selection rule that unifies differential capacitance, tunneling current and plateau widths. A two-stage self-consistent Poisson–Schrödinger reduction produces universal master functions/surfaces and comparison with magnetocapacitance/magnetotunneling data indicates refilling by nearby extended charge and magnetic-field–dependent growth of effective screening depth.  
**Method**: Construct a thermodynamic description using the partitioned sheet density as the state variable to derive Helmholtz free energy, a locked-branch chemical potential and release potential; apply spectral selection between compressible and incompressible segments; perform a canonical two-stage self-consistent Poisson–Schrödinger reduction to produce universal master functions and finite-buffer master surfaces; validate against magnetocapacitance and magnetotunneling measurements.  
**Tags**: `accumulation_layer,screening,capacitance,Poisson_Schrödinger,magnetocapacitance,magnetotunneling,quantum_devices`
...
### [9] [Polarization-controlled effective Rabi dynamics in driven Graphene: A Floquet-Magnus approach](https://arxiv.org/abs/2605.00325)
*V. G. Ibarra-Sierra, J. L. Cardoso, C. Flores-Valente, A. Kunold, J. C. Sandoval-Santana*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.00325)

**TL;DR**: Resonantly driven Dirac electrons in graphene exhibit polarization-dependent coherent dynamics: ellipticity β and momentum–field angle Δ tune quasienergy splitting and induce a polarization-dependent phase (an effective initial Floquet kick) that shifts occupation oscillation timing. Circular polarization restores isotropy; elliptical/linear polarization produce π-periodic angular anisotropy. Zeroth-order Floquet-Magnus (rotating-wave-type) effective two-level model captures macromotion; numerics validate the approximation (∼1% RMS error over 100 periods in weak-field regime).  
**Method**: Floquet-Magnus expansion formulated in the interaction picture with a rotating-wave-type transformation to derive an effective two-level quasienergy Hamiltonian at resonance (ω=Ω/2); explicit Fourier decomposition separates macromotion and micromotion; numerical time-evolution validates the zeroth-order Magnus approximation.  
**Tags**: `graphene, Dirac_materials, Floquet-Magnus, Floquet_theory, polarization_control, Rabi_oscillations, micromotion, time-resolved_spectroscopy`
...
### [10] [Investigation of nonlocal transport associated with the orbital Hall effect in Ti](https://arxiv.org/abs/2605.00359)
*Keitaro Takashina, Naoki Yano, Asahi Oe, Mari Taniguchi, Shuto Kimura, Kazuya Ando*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.00359)

**TL;DR**: Finite nonlocal resistance is observed in single-layer Ti Hall bars despite negligible spin Hall effect. Finite-element modelling shows a sizable but insufficient Ohmic bypass contribution (suppressed at small channel widths); the residual nonlocal signal is consistent with an additional orbital-current contribution possibly from the orbital Hall effect in Ti.  
**Method**: Nonlocal electrical transport measurements in single-layer Ti Hall bars as a function of central-channel width, combined with finite-element simulations of current spreading and Ohmic bypass accounting for resistivity variations to separate geometric/Ohmic backgrounds from nonlocal signals.  
**Tags**: `orbital_Hall_effect, orbital_transport, nonlocal_transport, Hall_bar_devices, finite_element_simulation, Ohmic_bypass, titanium, spin_Hall_negligible`
