...
### [1] [Sequential Topological Superconductivity in a Square Lattice with Chiral Charge Density Waves](https://arxiv.org/abs/2607.21525)
*Zhong-Xian Jin, Junkang Huang, Yu-Xuan Li, Tao Zhou*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.21525)

**TL;DR**: A theoretical study showing that a square-lattice superconductor coexisting with a composite CDW—real bond (CBO) plus imaginary hopping (CFP)—hosts topological superconducting phases with Chern numbers C=+2 and C=-2; the phases produce quantized low-temperature thermal Hall conductivity κ_{xy} as an experimental signature.  
**Method**: Modeling of a square-lattice superconductor with coexisting composite charge density wave (real bond modulation CBO and imaginary hopping CFP), topological characterization via Chern-number calculation, and evaluation of low-temperature thermal Hall response.  
**Tags**: `topological superconductivity, charge order, time-reversal symmetry breaking, thermal Hall effect, quantum materials`
...
### [2] [Geometric Superconducting Diode Effect in an NbN Nanoring](https://arxiv.org/abs/2607.20794)
...
**TL;DR**: A geometrically induced superconducting diode effect is demonstrated in a single-material asymmetric NbN nanoring: the device shows polarity-switchable, pronounced critical-current nonreciprocity, with field and temperature dependences that link maximal diode efficiency to the superconducting energy gap and maximal nonreciprocity to the superfluid density.  
**Method**: Realize structurally minimal asymmetric NbN nanorings (single material, inversion-symmetry breaking via geometry) and perform systematic magnetic-field- and temperature-dependent critical-current measurements to characterize nonreciprocal transport, efficiency, and their relation to energy gap and superfluid density.  
**Tags**: `nonreciprocal superconductivity, superconducting electronics, geometric symmetry breaking, quantum materials`
...
### [3] [Evidence for fully-gapped superconductivity in BCS superconductor NiBi3](https://arxiv.org/abs/2607.20974)
*Atul Gangwar, Kunal Yadav, S. Patnaik, Sandip Chatterjee*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.20974)

**TL;DR**: NiBi3 single crystals (Tc = 4.0 K, RRR = 18) are characterized as type-II, BCS-like, fully gapped superconductors in the dirty limit: penetration-depth and magnetization data fit an s-wave BCS model, Hc2 is below the Pauli limit implying orbital pair breaking, and extracted parameters (xi(0)=26.78 nm, lambda0=181.8 nm, λ_e−p=0.81) indicate moderate electron–phonon coupling.  
**Method**: Experimental characterization using electrical resistivity, magnetization, and London penetration-depth measurements on single crystals; extraction of Hc2 from magnetization in two orientations; fitting lambda(T) to an s-wave BCS model and deriving coherence length, penetration depth, electron–phonon coupling, superfluid density, and gap magnitude.  
**Tags**: `type-II superconductivity, BCS superconductivity, electron-phonon coupling, penetration depth measurements, critical-field physics, dirty-limit superconductivity`
...
### [4] [Magnetically memorable inductance in superconducting multilayer resonators](https://arxiv.org/abs/2607.21147)
...
**TL;DR**: Nb/Co/Nb/Co/Nb/Al “spin‑trigger” multilayers were fabricated into split‑ring microwave resonators that show a non‑volatile, zero‑field spin‑valve control of kinetic inductance: reversing Co layer magnetizations shifts the resonance up to 4 MHz. A proximitized Al overlayer increases the inductance contrast ≈3×. Results quantitatively match a microscopic Usadel‑equation model, demonstrating field‑programmable inductive elements for superconducting digital and neuromorphic circuits.  
**Method**: Experimental fabrication of Nb/Co/Nb/Co/Nb/Al spin‑trigger multilayer split‑ring resonators with microwave (resonant) characterization to measure kinetic inductance changes, combined with quantitative modeling using the Usadel equations.  
**Tags**: `spintronics, superconducting devices, quantum materials, neuromorphic computing, field‑programmable inductors`
...
### [5] [Puzzling superconductivity in strontium ruthenate: then and now](https://arxiv.org/abs/2607.21194)
*James F. Annett, Karol I. Wysokiński*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.21194)

**TL;DR**: Re-evaluation of Sr2RuO4: authors calculate the polar Kerr / optical Hall response for a candidate chiral d-wave (Eg) spin-singlet state—motivated by recent evidence against chiral p-wave—and find a nonzero Hall conductance qualitatively similar to prior chiral p-wave (Eu) predictions. They analyze this Hall response using two sum rules tied to Berry curvatures of Bogoliubov quasiparticles and an f‑sum rule that signals inter-orbital pairing.  
**Method**: Theoretical calculation of the Kerr effect / optical Hall conductivity for a chiral d-wave (Eg) superconducting state, with analytical/numerical characterization of the Hall conductance via two sum rules: one relating to Berry curvatures in Bogoliubov quasiparticle states and one f‑sum rule probing inter‑orbital pairing.  
**Tags**: `unconventional superconductivity, topological superconductivity, quantum geometry, quantum materials, optical transport/Kerr effect`
...
### [6] [Supercurrent effect in a charge density wave intertwined superconductor](https://arxiv.org/abs/2607.21507)
...
**TL;DR**: Meissner currents from an in-plane magnetic field induce selective Doppler shifts of Bogoliubov quasiparticles in superconducting NbSe2, breaking the native C3v symmetry of precursor CDW modulations to Cs and allowing field-direction control of anisotropic CDW amplitudes in momentum space.  
**Method**: Scanning tunneling spectroscopic imaging under applied in-plane magnetic field combined with model calculations showing Doppler-shift-induced reconstruction of the Bogoliubov E–k dispersion.  
**Tags**: `superconductivity, charge density waves, quantum materials, momentum-space engineering, scanning tunneling spectroscopy`
...
**TL;DR**: The paper proposes a geometric formulation of weak topology by analytically continuing the Bloch Hamiltonian into complex momentum space: weak-topological edge states map to exceptional points and corner zero modes to exceptional curves, with a 2D plaquette chiral model providing a minimal dual-weak-topology example and compact localized states appearing when exceptional roots collapse to the origin.  
**Method**: Analytic continuation of the Bloch Hamiltonian into complex momentum space to identify exceptional singularities (points and curves) that encode weak-topological invariants; demonstrated on a two-dimensional plaquette chiral lattice model supporting two independent families of weak invariants (one per spatial direction).  
**Tags**: `topological phases, non-Hermitian topology, higher-order topology, edge and corner states, quantum materials`
...
### [8] [Ideal Bands in Tight-Binding Models](https://arxiv.org/abs/2607.20624)
*Lexu Zhao, Yang Ge, Shinsei Ryu, Jiabin Yu*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.20624)

**TL;DR**: Constructs |Ch|=1 ‘ideal’ Chern bands in finite-band tight-binding models with exponentially decaying hopping (requiring at least two orbitals with different embedded positions), proves a no-go result that isolated Chern-ideal bands with nonzero Chern number cannot exist in finite-band models with strictly finite-range hopping (provided Berry curvature stays finite), and extends the impossibility to Wilson-loop-ideal bands with zero total Chern number (e.g., Kane–Mele Z2-ideal bands).  
**Method**: Analytic construction of isolated |Ch|=1 ideal bands in finite-band tight-binding models with exponentially decaying hopping; rigorous no-go proofs ruling out isolated Chern-ideal bands for any nonzero Chern number in finite-band, finite-range-hopping models under the assumption of non-divergent Berry curvature; extension of arguments to Wilson-loop-ideal (Z2) bands.  
**Tags**: `quantum geometry, topological band theory, Chern bands, tight-binding models, topological constraints`
...
### [9] [High Order Geometric Channels for Nonlinear Transport in Bloch Bands](https://arxiv.org/abs/2607.20702)
*Sami Farrag, Eugene Mele, Tony Low*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.20702)

**TL;DR**: Geometric perturbation theory for Bloch states is constructed using a gauge-invariant Bargmann trace that builds a hierarchy Q^{(N)} (starting from the quantum geometric tensor) which dresses band dispersion and connection order-by-order. Higher Q^{(N)} capture multiband geometry beyond the quantum metric and Berry curvature; connected amplitudes produce vertex-order corrections while strict-order terms factorize. Applied to a uniform electric field, the theory isolates the fully coherent, purely geometric sector of the third-order response.  
**Method**: Develop a gauge-invariant geometric perturbation expansion of Bloch-state dispersion and connection via the Bargmann trace, defining an order-by-order hierarchy Q^{(N)} (with Q^{(1)} = quantum geometric tensor) and classifying corrections into connected (vertex-order) and strict-order (disconnected product) amplitudes; apply to compute the coherent geometric contribution to third-order response under a uniform electric field.  
**Tags**: `quantum geometry, multiband Bloch theory, Berry connection, nonlinear response, gauge-invariant methods`
...
### [10] [Exceptional Points in a Parallel Double-Quantum-Dot Josephson Junction Coupled to a Ferromagnetic Reservoir](https://arxiv.org/abs/2607.20856)
*Yiyan Wang, Ruixin Zhou, Bing Dong*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.20856)

**TL;DR**: Non-Hermitian exceptional points (EPs) appear in a parallel double-quantum-dot Josephson junction coupled to a dissipative reservoir. Integrating out leads yields a non-Hermitian BdG model where superconducting phase difference and orbital flux tune the complex Andreev spectrum. Spin-independent dissipation produces EPs only in the infinite-gap approximation and they disappear for finite superconducting gap, whereas spin-dependent (ferromagnetic) dissipation plus magnetic flux yields second-order EPs that survive finite gap and can be merged into a third-order EP with cubic-root eigenvalue splitting. A many-body parity analysis explains the different finite-gap behaviors, and Josephson currents computed from two methods remain continuous across EPs.  
**Method**: Integrate out leads to obtain a non-Hermitian Bogoliubov–de Gennes effective model for the parallel double-quantum-dot Josephson junction coupled to a dissipative reservoir; analyze complex Andreev spectra and EPs under both infinite-gap and finite-gap superconducting leads; classify EPs (2nd and 3rd order) and scaling laws; perform many-body parity sector analysis; compute Josephson currents via free-energy derivative and surrogate-model density matrix.  
**Tags**: `Josephson physics, non-Hermitian physics, open quantum systems, impurity physics, superconducting nanostructures`
...
### [11] [Machine Learning for Charge State Characterization of Isolated Double Quantum Dots](https://arxiv.org/abs/2607.20871)
...
**TL;DR**: Two compact CNNs (<1M parameters, 6.5 MB) analyze isolated-mode charge stability maps from SiMOS double quantum dots measured at ≈1 K: CSMClassifier flags image quality/artifacts (94% macro accuracy) and ChargeLineNet localizes charge-transition lines and infers electron occupancy (95.3% exact line-count); synthetic pre-training and fine-tuning enable label-efficient, cross-device generalization, yielding a fast (<60 ms) automated pipeline for scalable tuneup.  
**Method**: Train two task-specific convolutional neural networks on experimentally measured isolated-mode CSM images from 32 SiMOS double-quantum-dot devices (16 training / 16 held-out) with pre-training on synthetic images; evaluate cross-device generalization, per-image classification (CSMClassifier) and line localization/occupancy (ChargeLineNet), and test fine-tuning vs. training-from-scratch label efficiency.  
**Tags**: `quantum dot arrays, device characterization, automated tuning, machine learning for quantum devices, silicon quantum dots`
...
### [12] [End-State-Controlled Quantum Transport in Armchair Graphene Nanoribbon Artificial Quantum Materials](https://arxiv.org/abs/2607.21141)
*David M T Kuo*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.21141)

**TL;DR**: Real-space theory shows how zero-energy modes of n‑triangulenes and end states of armchair graphene nanoribbons (AGNRs) hybridize into compact localized node orbitals at three-arm junctions. A universal counting relation N_node,δ = |N_es,t,A(B) - N_tri,0,B(A)| determines node number and sublattice chirality; an extended Anderson model reproduces triangulene tunneling spectra. These node orbitals can be assembled into artificial GNRs with tunable flat subbands and anisotropic transport.  
**Method**: Real-space theoretical construction and continuous coupling tuning between atomically precise graphene building blocks, combined with modeling of tunneling spectra via an extended Anderson model; analysis of zero-energy mode evolution into compact localized states and band engineering of resulting ribbons.  
**Tags**: `quantum materials, graphene nanostructures, compact localized states, flat band engineering, impurity physics, quantum transport`
...
**TL;DR**: Proximity to a superconducting NbSe2 substrate converts monolayer NiI2 from its intrinsic multiferroic non-collinear state into a ferromagnetic ground state by renormalizing exchange interactions; this change is detected in situ via Yu–Shiba–Rusinov (YSR) states measured with low-temperature STM/STS.  
**Method**: Low-temperature scanning tunnelling microscopy and spectroscopy (STM/STS) of monolayer NiI2 on superconducting NbSe2, using YSR subgap states in the NbSe2 to infer substrate-induced renormalization of magnetic exchange and the resulting magnetic ground state.  
**Tags**: `multiferroicity, two-dimensional magnetism, proximity effects, impurity physics, quantum materials`
...
**TL;DR**: Finite-momentum circular phonon dichroism (CPD) is proposed as a direct, symmetry-protected probe of the Néel vector in 2D d-wave altermagnets: the CPD sign flips under Néel reversal for in-plane phonon momenta and is traced to interband coherent transitions, with predicted asymmetric ratios as large as |η_CPD|=37.3%.  
**Method**: Theory: symmetry-constrained analysis combining Onsager reciprocity and C2z lattice symmetry, plus channel-resolved decomposition of phonon absorption to identify interband coherent transition contributions; numerical/analytical evaluation of finite-momentum phonon dichroic response (circular-ultrasound absorption).  
**Tags**: `altermagnetism, antiferromagnetic spintronics, phonon physics, quantum materials`
...
**TL;DR**: Layer- and environment-dependent long-wavelength exciton dispersion in freestanding hBN is quantitatively resolved using defocus‑engineered momentum‑resolved EELS in STEM (momentum resolution 0.0002 Å⁻¹). The authors measure a thickness-driven crossover from a nonanalytic linear regime to bulk-like parabolic dispersion, extract crossover momentum q_c and low-q group velocity, and probe effects of temperature, adjacent graphene and twist in BN/graphene heterostructures.  
**Method**: Defocus‑engineered momentum‑resolved electron energy‑loss spectroscopy (EELS) in scanning transmission electron microscopy (STEM) on freestanding hBN, achieving ultrahigh momentum resolution (0.0002 Å⁻¹); systematic thickness and heterostructure (graphene proximity and twist) and temperature-dependent measurements to extract exciton dispersion, crossover momentum q_c and group velocity in the long‑wavelength limit.  
**Tags**: `quantum materials, two-dimensional materials, low-dimensional excitons, momentum-resolved spectroscopy, optical excitations`
...
**TL;DR**: STM/STS study identifies the microscopic structure and electronic signature of two common defects in bulk CrSBr; comparison with ab initio STM simulations indicates that a prevalent defect is a b-axis-aligned double sulfur vacancy with electronic states near the valence-band edge.  
**Method**: Low-temperature scanning tunneling microscopy and spectroscopy (STM/STS) on bulk CrSBr combined with ab initio simulated STM image comparison for defect identification.  
**Tags**: `quantum materials, impurity physics, scanning probe microscopy, magnetic semiconductors, defect spectroscopy`
...
**TL;DR**: On-chip programmable mechano-quantum transducer (OCPMQT) integrates voltage-controlled micromechanical actuation with in situ ODMR readout of spin defects in a 2D van der Waals host, enabling electrical programming of lattice strain that maps quantitatively onto spin Hamiltonian (axial zero-field splitting shifts). Demonstrated sensitivity to ODMR-inferred strains down to 0.0080% within a 2.05×10^-2 cm^3 chip volume and a delivered volumetric force density ≈2.6×10^4 N/m^3. A micromechanical-to-spin-Hamiltonian model links electromechanics, interfacial strain transfer, and strain–spin coupling.  
**Method**: Fabrication and electrical actuation of an on-chip micromechanical transducer integrated with a 2D van der Waals crystal hosting spin defects; mechanical programming via voltage-defined actuation and quantitative readout of axial zero-field splitting shifts using optically detected magnetic resonance (ODMR); development of a micromechanical-to-spin-Hamiltonian framework to relate electromechanical input to spin-frequency response.  
**Tags**: `Quantum materials, Impurity physics, Spintronics, Strain engineering, Quantum sensing`
...
**TL;DR**: Nonlocal spatial dispersion of Landau-level response in a 2D electron gas significantly alters the electromagnetic Green’s function and emitter electrodynamics (Purcell factors, Lamb shifts, emission spectra) up to hundreds of nanometers. Near‑field gradients at multiples of the cyclotron frequency can brighten nominally dipole‑forbidden transitions; results are relevant for terahertz nanostructures and consistent with Landau‑level polariton experiments.  
**Method**: Microscopic derivation of the nonlocal electromagnetic susceptibility for a 2DEG in a perpendicular magnetic field; analytic/numerical evaluation of the resulting Green's function and computation of emitter observables (Purcell factor, Lamb shift, emission spectra) beyond the Markov and rotating‑wave approximations, including spatial dispersion effects.  
**Tags**: `quantum materials, magneto‑optics, nonlocal electrodynamics, polaritons`
