...
**TL;DR**: Room-temperature, contact-free validation of superconductivity via detection of remnant supercurrents using a cryogen-free optically pumped atomic magnetometer; demonstrated on YBCO microcrystals and REBCO tape/disks including samples compatible with diamond anvil cells, with ferrite flux guide enabling centimeter-scale, pico-Tesla sensitivity.  
**Method**: Measure temperature-dependent magnetic field from remnant supercurrents using a cryogen-free optically pumped atomic magnetometer at room temperature; identify Tc by abrupt disappearance of the remnant-field signal and by field-reversal of induced supercurrent; use a ferrite flux guide to extend sensitive detection distances. Demonstrated on YBCO microcrystals and REBCO tape/disk, including sub-100 µm samples compatible with diamond anvil cells.  
**Tags**: `superconductivity validation, magnetometry, quantum materials, high-pressure superconductivity, non-invasive measurement techniques`
...
**TL;DR**: μSR measurements on an La1−xSrxNiO2 (0 ≤ x ≤ 0.25) series show persistent local magnetic moments that undergo spin freezing into a glassy state at T~tens of kelvin across the entire doping range, with only a subtle weakening at higher hole doping—implying magnetism and superconductivity are largely decoupled within a multi-orbital picture.  
**Method**: Temperature-dependent muon spin rotation (μSR) measurements across a Sr-doping series (0–25%) of infinite-layer La1−xSrxNiO2 to probe static and dynamic local magnetic fields and spin freezing.  
**Tags**: `unconventional superconductivity, quantum materials, magnetism, glassy magnetism, multi-orbital physics`
...
**TL;DR**: PtBi2 surfaces realize i-wave topological superconductivity with six Majorana cones per surface; in a finite-thickness slab model the authors gap the bulk Weyl cones and treat the surface Majorana cones as low-energy degrees of freedom. Two competing gap mechanisms are identified: inter-cone hybridization (trivial gap) and a Zeeman field (topological gap supporting chiral Majorana edge modes). They compute edge-mode wavefunctions, relate them to the cones’ momentum-space distribution, and map a phase diagram showing trivial and nontrivial quasi-2D regions.  
**Method**: Analysis of a simplified slab (finite-thickness) model that gaps bulk Weyl cones to isolate surface Majorana cones; study of gap-opening mechanisms (inter-cone hybridization versus Zeeman field), calculation of chiral Majorana edge-mode wavefunctions and their momentum-space structure, and construction of the quasi-two-dimensional phase diagram.  
**Tags**: `topological superconductivity, Weyl semimetal, Majorana physics, finite-size/quasi-2D effects, edge physics`
...
**TL;DR**: The paper identifies a superconducting analogue of the Peierls instability localized at the edge of a 2D superconductor: dispersing Andreev bound states with Bogoliubov Fermi points produce an enhanced quasiparticle response at Q=2k_c that softens a pairing mode (a superconducting Kohn anomaly). Condensation of that mode yields an edge pair-density wave (PDW) which gaps the ABS. The mechanism is demonstrated via self-consistent BdG calculations in a square-lattice extended Hubbard model with mixed s+d+ip order.  
**Method**: Identification of boundary quasiparticle structure and analysis of pairing-fluctuation response, combined with self-consistent Bogoliubov–de Gennes (BdG) numerical calculations on a square-lattice extended Hubbard model hosting an s+d+ip superconducting state.  
**Tags**: `unconventional superconductivity, edge superconductivity, pair-density wave, Peierls instability, quantum materials`
...
**TL;DR**: Using circularly polarized Laguerre–Gaussian beams (light with orbital angular momentum) on ultrathin topological-insulator films creates a spatially varying Floquet mass that produces a topological annulus with concentric chiral ring modes; helicity and OAM independently control mass inversion and annulus geometry, enabling real-space programmable nonequilibrium topology and vortex-core zero modes in the decoupled-surfaces limit.  
**Method**: Floquet engineering via spatially structured light: applying circularly polarized Laguerre–Gaussian beams (carrying orbital angular momentum) to ultrathin topological-insulator films to induce a radial, sign-changing Floquet mass and study resultant real-space topological domains and bound chiral/vortex zero modes.  
**Tags**: `Floquet engineering, topological superconductivity, topological insulators, vortex physics, quantum materials`
...
**TL;DR**: Treat the first lattice layer (the “edge chain”) of a semi-infinite 2D topological insulator as an independent system to compute adiabatically protected edge and corner states; using the Shemesh theorem the authors show these states are protected under chiral‑symmetry-preserving adiabatic evolutions and validate the approach on SSH3, Haldane and Breathing Kagome lattices.  
**Method**: Ansatz: isolate the first lattice layer (edge chain) and solve for its eigenstates independently of the bulk; then use the Shemesh theorem to prove those edge/corner eigenstates are adiabatically protected for adiabatic deformations that preserve chiral symmetry. Validate the procedure through explicit calculations in a 2D SSH extension (SSH3), the Haldane model and the Breathing Kagome lattice.  
**Tags**: `topological insulators, edge and corner states, higher-order topology, chiral symmetry, quantum materials`
...
**TL;DR**: The paper predicts that a tunable graphene monolayer (modeled on a metallic substrate) can reverse excitonic coupling in nearly H- or J-type molecular aggregates: varying graphene’s surface conductivity shifts the parameter region for H↔J coupling inversion, permitting dynamic control and potential observation within a single experimental run.  
**Method**: Theoretical modelling of dipole–dipole interactions between molecular aggregates in the presence of a graphene monolayer deposited on a metallic substrate; parameter-space analysis of excitonic coupling as a function of graphene surface conductivity to identify regimes where H↔J inversion occurs.  
**Tags**: `molecular excitons, energy transfer, graphene plasmonics, quantum materials, dipole-dipole interactions`
...
**TL;DR**: Proposes a covariant, Lorentz-violating modification of the (2+1)D Dirac equation to encode anisotropies in 2D Dirac materials; parameters generate shifted, tilted, and distorted Dirac cones and can be fitted to first-principles bands for strained graphene with a clear geometrical interpretation.  
**Method**: Construct an effective low-energy (2+1)-dimensional Dirac model by analogy with Lorentz-violating extensions of the Standard Model; introduce free parameters that encode anisotropy (shift, tilt, distortion) and demonstrate quantitative extraction of these parameters from first-principles electronic band-structure calculations for strained graphene.  
**Tags**: `quantum materials, Dirac materials, effective field theory, strain engineering, quantum geometry`
...
**TL;DR**: The paper theoretically analyzes Andreev reflection and nonlinear conductance in a normal–superconductor junction formed from a proximitized semiconductor nanowire with axial magnetic field, showing that finite-energy AR and conductance are strongly controlled by the relative directions of Rashba spin–orbit fields on the normal and superconducting sides; tunability is largest when the proximitized side is topologically trivial, making the spin–orbit misalignment angle an efficient electrical control knob.  
**Method**: Theoretical analysis of Andreev reflection and transport in an NS hybrid nanowire junction with Rashba spin–orbit coupling and axial magnetic field, studying energy-resolved AR coefficients and nonlinear conductance as functions of spin–orbit-field misalignment and the topological/trivial phase of the proximitized superconductor (implementation discussion for realistic setups).  
**Tags**: `topological superconductivity, Majorana physics, Andreev reflection, quantum materials, hybrid nanowire devices`
...
**TL;DR**: Flux noise couples to superconducting qubits via a quantum-geometric Faraday induction mechanism that applies to generic thin-film device geometries. The authors derive the coupling to time-varying magnetic dipoles (surface/substrate spins) and to current-carrying flux lines, and show flux noise sets a fundamental limit on qubit quality factor even for nominally non-flux-tunable (no-loop) qubits. They also derive a minimal safety distance for flux lines and identify a capacitor-wing–induced ‘lensing’ of the electromotive field that amplifies deleterious coupling largely independent of Meissner screening.  
**Method**: Analytic derivation based on a quantum-geometric formulation of the Faraday effect applied to thin-film superconducting device geometries; explicit application to models of time-varying magnetic dipoles (surface/substrate spins) and current-carrying flux lines to compute induced electromotive coupling and resulting limits on qubit Q and required flux-line spacing.  
**Tags**: `flux noise, quantum geometry, impurity physics, Josephson physics, quantum hardware`
...
**TL;DR**: Deterministic vertical-to-vertical pick-and-place transfer of site-selected nanowire quantum dots (NWQDs) to arbitrary templates enables integration with a bottom gold mirror and electrostatic gates, yielding 75% photon extraction efficiency, 3.6 GHz wavelength tuning, very low multiphoton probability (g^{(2)}(0)=0.002) and >80% photon indistinguishability (±100 ps). The technique is repeatable and supports scalable single/entangled photon sources.  
**Method**: Developed and implemented a deterministic pick-and-place vertical-to-vertical transfer of site-selected NWQDs from growth substrate to arbitrary templates; integrated bottom gold mirror and electrostatic gates around transferred NWQDs; optical characterization measuring extraction efficiency, second-order correlation g^{(2)}(0), and photon indistinguishability.  
**Tags**: `single-photon sources, entangled photon sources, nanowire quantum dots, deterministic device integration, scalable photonic devices, quantum photonics`
...
**TL;DR**: Periodic boron/nitrogen substitution along zigzag graphene nanoribbons produces an internal electric field that tunes edge-localized magnetic moments and spin-split band structure; an external transverse field further modulates AF/FM edge configurations. First-principles results predict switchable pure thermal spin current (no charge current) at room temperature, enabling doped ZGNRs as prototype spin‑caloritronic devices.  
**Method**: First-principles electronic-structure calculations of zigzag-edged graphene nanoribbons with periodic axial substitutional doping (B/N) and applied transverse static electric field, analyzing magnetic ground states and thermoelectric/thermal spin transport response.  
**Tags**: `quantum materials, impurity physics, edge magnetism, thermoelectricity, spin-caloritronics`
...
**TL;DR**: The paper presents a unified spectral "band theory" for quasiperiodic systems by (i) introducing an efficient spectral-function method that computes A(k,ω) from a small truncated Hamiltonian and converges to exact thermodynamic-limit spectra via a successive locking of energy moments, and (ii) proposing Janus quantum numbers that give each quasiperiodic eigenstate dual momentum and real-space labels (reducing to Bloch momentum and band index in the commensurate limit). Together with the incommensurate energy band (IEB) concept, these advances let one define, compute and label states in quasiperiodic systems analogously to periodic band theory.  
**Method**: Development of an efficient spectral-function calculation of A(k,ω) using small truncated Hamiltonian matrices that converge (without finite-size scaling) through a successive locking of energy moments; combined with the conceptual introduction of Janus quantum numbers and the incommensurate energy band (IEB) framework to track and label eigenstates across localization transitions.  
...
**TL;DR**: Gate-defined bilayer graphene quantum dots exhibit low-frequency charge noise with median amplitude S_μ^{1/2}(1 Hz)=1.16 μeV/√Hz, comparable to established semiconductor QD platforms; noise is insensitive to electrostatic tuning, consistent across double QDs and resonator dispersive readout, and not increased by weak TMD proximitization — supporting BLG as a viable qubit platform.  
**Method**: Transport-based low-frequency noise spectroscopy on gate-defined bilayer graphene quantum dots, supplemented by measurements on double QDs and cross-checked with a superconducting resonator-based dispersive readout; comparative measurements on devices with transition-metal-dichalcogenide (TMD) proximitization.  
**Tags**: `semiconductor qubits, charge noise, quantum dots, quantum materials, dispersive readout`
...
**TL;DR**: Variational mean-field study (no fit parameters) of doped, biased Bernal (AB) bilayer graphene predicting a rich phase diagram of symmetry-broken fractional-metal states controlled by displacement field D; results reproduce key experimental energy scales and identify regimes with multiple fractional-metal phases and first-/second-order transitions.  
**Method**: Parameter-free variational mean-field theory: short-range screened Coulomb repulsion treated via random-phase approximation (RPA) with no fitted parameters; long-range Coulomb energy set by sample geometry modeled as a parallel-plate capacitor; theory formulated directly in terms of experimentally controlled displacement field D.  
**Tags**: `quantum materials, electron correlation, bilayer graphene, phase diagram, screened Coulomb interactions, symmetry breaking`
...
**TL;DR**: Introduces an analytically tractable minimal model coupling magnetic order, electrons, holes and excitons via orbital-dependent onsite exchange (s-d-like) to capture exciton–magnetism interplay in layered magnetic semiconductors. Benchmarked to CrSBr bilayer with agreement to experiment and ab-initio; predicts conservation of a combined spin+layer pseudospin quantum number that constrains optical selection rules and yields a hierarchy of bright and dark excitons in A-type antiferromagnets, including noncollinear cases.  
**Method**: Construct an analytic minimal model treating magnetic order and itinerant carriers as distinct electronic orbitals coupled by orbital-dependent onsite exchange (s-d model analogue); apply to CrSBr bilayer and benchmark against experiments and ab-initio calculations; analyze optical selection rules using a conserved combined spin–layer pseudospin quantum number.  
**Tags**: `quantum materials, excitons, magneto-optics, layered magnetic semiconductors, antiferromagnetism`
...
**TL;DR**: Room-temperature formation of coherently coupled polaritons in an open optical cavity containing two spatially separated van der Waals materials (monolayer WS2 and quasi-2D halide perovskite) separated by 1.5 μm. The system yields three polariton branches; the middle branch has comparable excitonic weight from both materials and the photonic mode. Experimental white‑light reflectivity and photoluminescence agree with coupled harmonic‑oscillator and microscopic Wannier‑Hopfield simulations.  
**Method**: Experimental realization of an open optical cavity embedding two distinct excitonic media (monolayer WS2 and layered quasi‑2D halide perovskite) separated by 1.5 μm; optical characterization via white‑light reflectivity and photoluminescence; quantitative modelling using a coupled harmonic‑oscillator model and a microscopic Wannier‑Hopfield framework.  
**Tags**: `exciton‑polaritons, cavity quantum electrodynamics, van der Waals heterostructures, quantum materials, room‑temperature polaritons`
...
**TL;DR**: Projective measurements on fractional quantum Hall (FQH) states define a projected ensemble in which the entanglement spectrum splits into measurement-dependent sectors whose ranks are fixed by conformal field theory (CFT) counting. The authors propose a “measurement-resolved Li–Haldane” conjecture: conditioning on outcomes exposes a hierarchy within the Li–Haldane edge manifold. In the non-Abelian Moore–Read state this yields parity-resolved manifolds with internal subspaces reproducing opposite-parity CFT counting; the structure survives in realistic Coulomb-interacting ground states, making the projected ensemble a sharper probe of topological order.  
**Method**: Analyze the projected ensemble produced by projective measurements on the complement of a subsystem; derive sector-rank constraints from conformal field theory (edge-mode counting) and verify the structure (including for Moore–Read and Coulomb-interacting ground states) — combining analytic CFT-based counting arguments with explicit checks on model and realistic ground states.  
**Tags**: `topological order, fractional quantum Hall, entanglement spectrum, measurement-resolved entanglement, conformal field theory`
...
**TL;DR**: Calculated Casimir (van der Waals) free energy of thin peptide films on Si substrates using Lifshitz theory; found a thickness-dependent sign change (stabilizing for thicker films, destabilizing for thinner ones) that shifts with water content, nanoparticle type/size, and substrate dielectric-to-metal transition. Metallic Si always yields destabilizing (positive) Casimir free energy.  
**Method**: Lifshitz theory calculations of van der Waals/Casimir free energy for layered systems, with parametric scans over film thickness, water volume fraction, inclusion of nonmagnetic or magnetic nanoparticles (varying radius), and substrate state (dielectric vs laser- or dopant-induced metallic).  
**Tags**: `Casimir/van der Waals forces, thin film physics, surface/interface forces, nanoparticle coatings, quantum materials`
...
**TL;DR**: Proposes a theoretical route to realize both first- and second-order topological superconducting phases in a 2D heterostructure formed by a quantum spin Hall insulator proximitized by s-wave pairing and coupled to an unconventional p-wave magnet; topological transitions are controlled by p-wave magnet parameters, classified by chiral-symmetry-protected invariants (1D winding and quadrupolar winding), and arise from competing effective (p_x+p_y) and (p_x+ip_y) pairings set by intrinsic spin–orbit coupling and spin-split magnet bands.  
**Method**: Analytical theoretical study of a 2D QSHI/p-wave-magnet heterostructure: deriving an effective low-energy edge theory, computing bulk pairing channels, and classifying phases by symmetry-protected topological invariants (one-dimensional winding number and quadrupolar winding number); phase control via tuning p-wave magnet parameters.  
**Tags**: `topological superconductivity, second-order topological superconductivity, quantum spin Hall, unconventional superconductivity, quantum materials`
...
**TL;DR**: Measured coherent spin dynamics of native Tb3+ (non-Kramers) in CaWO4 using pulsed X-band EPR; observed that T2 is dominated not by conventional spin-bath mechanisms but by vibration-driven angular fluctuations of the crystal axis that couple via extreme g-anisotropy. A two-parameter model including angular-noise spectral density (global mechanical vibrations plus local phonon-driven jitter) reproduces T2(B_r,T) and is confirmed by mechanical-configuration-dependent experiments.  
**Method**: Pulsed X-band electron paramagnetic resonance (Hahn-echo T2 mapping versus temperature 2–10 K and resonant field 10^3–10^4 G), comparison to a parameter-free spin-bath model (spin-lattice relaxation, instantaneous diffusion, spectral diffusion) and a two-parameter extension introducing dynamical angular fluctuations; controlled experiments varying setup mechanics to isolate vibration contribution.  
**Tags**: `decoherence, impurity physics, quantum materials, electron paramagnetic resonance, spin coherence`
...
**TL;DR**: Semiclassical decomposition shows disorder-induced asymmetric scattering (third- and fourth-order skew and side-jump) can dominate the orbital Edelstein effect (OEE) in magnetized Rashba 2DEGs, yielding orbital magnetization an order of magnitude larger than spin magnetization for strong Rashba coupling.  
**Method**: Semiclassical kinetic/Boltzmann-style theory separating OEE contributions into intrinsic, Drude, side-jump, and third- and fourth-order skew-scattering channels; applied to a magnetized Rashba 2DEG to evaluate relative magnitudes.  
**Tags**: `orbitronics, orbital Edelstein effect, impurity physics, spin–orbit coupling, Rashba 2DEG, broken time-reversal symmetry`
...
**TL;DR**: Theory combining hydrodynamic and non‑Markovian memory effects for 2D electrons at T=0 in weakly disordered samples explains giant negative magnetoresistance in ultra‑high‑quality GaAs quantum wells; predicts narrow-sample sharp MR peak and wider-sample blunt peak.  
**Method**: Analytic theoretical modeling of mixed transport: incorporate non‑Markovian memory effects from electron scattering off localized defects in magnetic field together with an unconventional viscosity arising from defect scattering in the bulk and rough-edge scattering; solve the resulting magnetotransport model to obtain magnetoresistance profiles.  
**Tags**: `hydrodynamic transport, magnetotransport, impurity physics, quantum materials`
