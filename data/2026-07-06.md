...
**TL;DR**: Sb-substituted Bi2Se3 (SBS) is identified as a low–bulk-carrier, non-compensated topological insulator suitable for Majorana platforms; the authors systematically study thermal processing during microfabrication and demonstrate a room-temperature fabrication protocol that preserves low carrier density, evidenced by quantum-interference oscillations in nanowires, strong gate tunability, and clear weak antilocalization in Hall-bar and nanowire transport measurements.  
**Method**: Systematic experimental study of thermal processing effects during microfabrication: development and implementation of a room-temperature fabrication protocol for exfoliated SBS, device fabrication of Hall bars and nanowires, and low-temperature electronic transport characterization (quantum-interference oscillations, gate-dependent transport, and weak antilocalization).  
**Tags**: `topology, quantum_devices, quantum_computing, topological_insulators, weak_antilocalization, nanowires, transport, device_fabrication`
...
### [2] [Entropy of Non-Abelian Anyons from Slow Quasiparticle Dynamics in Quantum Hall Interferometers](https://arxiv.org/abs/2607.02188)
*Eran Sela, Mitali Banerjee*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.02188)

**TL;DR**: Proposes extracting the O(1) topological entropy ΔS = k_B log d of non-Abelian anyons (e.g. d=√2 at ν=5/2) from equilibrium charge measurements of an antidot by embedding it in an electronic interferometer and inferring antidot charge from observed time-dependent switching of the interference phase; works for temperatures between the interferometer-edge and antidot level spacings.  
**Method**: Embed an antidot into an electronic interferometer and use the recently observed time-dependent switching of interference phase to non-locally infer the antidot charge at equilibrium; apply Maxwell relations to the inferred charge versus temperature to extract the anyonic entropy for intermediate temperature regime (above interferometer edge level spacing but below antidot level spacing).  
**Tags**: `topology, quantum_computing, quantum_devices, fractional_quantum_hall, anyons, interferometry, entropy, antidot`
...
### [3] [The Wigner function for Integer quantum Hall effect](https://arxiv.org/abs/2607.02094)
*Yao Wang, Qi-Ming Fu, Huawei Fan, Li Yu, Kang Li*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.02094)

**TL;DR**: Analytical calculation of the Wigner quasi-probability distribution for electrons in the integer quantum Hall effect: the authors review Landau-gauge wavefunctions, summarize Wigner-function properties, and compute the phase-space Wigner function for IQHE states using an integral method.  
**Method**: Analytical derivation: review Landau-gauge electronic wavefunctions and apply the integral representation of the Wigner function to compute the phase-space distribution for integer quantum Hall states.  
**Tags**: `topology, quantum_geometry`
...
### [4] [Intrinsic orbital Hall effect in a nonuniform electric field](https://arxiv.org/abs/2607.02418)
*Min Ju Park, Jongjun M. Lee, Hyun-Woo Lee*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.02418)

**TL;DR**: The paper derives an analytic, geometric formulation of intrinsic orbital angular-momentum transport (the dc orbital Hall effect under spatially nonuniform electric fields), expressing the conductivity in universal Bloch-state geometric quantities — notably the orbital Berry curvature and quantum metric — and shows via a tight-binding example that higher-order orbital Hall responses are sensitive to sample orientation.  
**Method**: Analytic geometric derivation applied to Bloch states and linear-response calculation for the intrinsic orbital Hall conductivity in the dc, spatially nonuniform electric-field limit; recasts conductivity in terms of orbital Berry curvature and quantum metric with a term-by-term correspondence to known geometric charge-Hall formulas, supplemented by tight-binding model calculations illustrating anisotropy and higher-order responses.  
**Tags**: `quantum_geometry,orbital_Hall,Berry_curvature,quantum_metric,tight_binding,intrinsic_transport,topology`
...
### [5] [Quantum Heat Under the Microscope: A Perspective on Cryogenic Scanning Thermal Microscopy](https://arxiv.org/abs/2607.01691)
*Valentin Fonck, Jean Spiece, Pascal Gehring*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.01691)

**TL;DR**: Perspective review identifying a gap: no current method images local heat transport at the nanoscale under cryogenic conditions; argues for developing cryogenic Scanning Thermal Microscopy (SThM) and presents five case studies showing its potential to probe exotic quantum phases and enable new technologies.  
**Method**: Critical review of existing local heat-transport characterization techniques and motivational proposal for cryogenic Scanning Thermal Microscopy, illustrated by five case studies linking nanoscale thermal imaging to quantum phenomena (e.g., Wiedemann–Franz violation, phonon quantisation).  
**Tags**: `cryogenic, thermal_transport, scanning_thermal_microscopy, phonon_quantisation, Wiedemann-Franz_violation, nanoscale_imaging, quantum_phases, quantum_devices`
...
### [6] [An efficient formalism for inertial spin waves: Dzyaloshinskii-Moriya antiferromagnets as case studies](https://arxiv.org/abs/2607.02021)
*De-Yun Zhao, Ri-Xing Wang, Meng-Qiu Cai, Mikhail Cherkasskii, Peng-Bin He*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.02021)

**TL;DR**: Introduces a theoretical framework for inertial spin waves in antiferromagnets, defining chirality and polarization via an ellipticity angle; applies it to precessional and nutational modes in uniaxial AFMs with staggered and homogeneous Dzyaloshinskii–Moriya interactions across uniform, canted, and spiral textures, finding degeneracy-lifting by homogeneous DMI and full removal of degeneracy when space–time inversion is broken, lefthanded nutational vs righthanded precessional modes, backward long-wavelength nutational waves, and flat bands near a critical inertial relaxation time.  
**Method**: Develops a linearized theoretical framework for inertial spin dynamics in uniaxial antiferromagnets, defines chirality/polarization through an ellipticity angle (encoding frequency sign, phase difference, elliptical axis ratio), and systematically computes dispersions and polarization for uniform, canted, and spiral configurations including staggered/homogeneous DMI.  
**Tags**: `inertial_spin_waves, antiferromagnetism, Dzyaloshinskii-Moriya, chirality, polarization, ultrafast_magnonics, spin_dynamics, nonuniform_textures, quantum_devices`
...
### [7] [Anisotropic tunneling through magnetic barriers in 8-Pmmn borophene](https://arxiv.org/abs/2607.02077)
*Rachid El Aitouni, Sanae Zriouel, Clarence Cortes, David Laroze, Ahmed Jellal*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.02077)

**TL;DR**: The paper theoretically analyzes electron tunneling across a magnetic barrier in 8-Pmmn borophene, showing that the intrinsic tilt and anisotropy of its Dirac cones produce strongly direction-dependent transmission (directional filtering) and that barrier strength and width tune conductance, suggesting routes to anisotropic transport control in 2D Dirac materials.  
**Method**: Use a low-energy effective Hamiltonian for anisotropic, tilted Dirac fermions in 8-Pmmn borophene; solve the Dirac equation analytically in three regions with wavefunction matching at interfaces to obtain spinor solutions, compute current densities and angle/energy-resolved transmission and reflection, and evaluate conductance via the Landauer–Büttiker formalism.  
**Tags**: `borophene,tilted_Dirac_cones,Dirac_fermions,magnetic_barrier,anisotropic_transport,Landauer-Büttiker,quantum_transport,quantum_devices`
...
**TL;DR**: Using a fully quantum formulation (adiabatic ansatz in the velocity gauge combined with nonequilibrium Green functions), the authors identify a longitudinal nonreciprocal DC current sourced by the quantum-metric dipole. The effect originates from a quantum correction to the distribution (shifted quasiequilibrium) due to finite wave-packet spread during relaxation and is absent in semiclassical treatments.  
**Method**: Combine adiabatic perturbation theory (adiabatic ansatz treating a DC electric field in the velocity gauge) with the nonequilibrium Green function formalism; map the resulting adiabatic-basis Hamiltonian to the length-gauge form and extract quantum-metric contributions to the steady-state distribution and current.  
**Tags**: `quantum_geometry, adiabatic_perturbation, nonequilibrium_green_function, nonreciprocal_transport, quantum_metric_dipole, wave_packet_relaxation`
...
**TL;DR**: Time-multiplexed, solid-state coherent Ising machine implemented with propagating microwave wave packets in bulk acoustic-wave delay lines; demonstrates 2,048 time-multiplexed spins, all-to-all coupling with 15-bit resolution, solves MAX-CUT in 341 ms and tackles number-partitioning and Sudoku with high thermal stability and low power/footprint.  
**Method**: Analog time-multiplexing using two serial 20.5 MHz (707 μs) bulk acoustic-wave delay lines to encode 2,048 spins as propagating microwave wave packets, providing programmable all-to-all coupling (15-bit resolution) and benchmarking on MAX-CUT, number-partitioning and Sudoku; compares thermal stability to optical CIMs and algorithmic performance to a simulated bifurcation algorithm.  
**Tags**: `coherent_ising_machine,time-multiplexing,bulk_acoustic_wave_delay_line,microwave_delay_line,quantum_devices,combinatorial_optimization`
...
### [10] [Electrical transport in ultra-thin films: from Fuchs-Sondheimer to quantum-confinement](https://arxiv.org/abs/2607.02120)
*Alessio Zaccone*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2607.02120)

**TL;DR**: Review identifies a crossover from classical size-effect scattering (Fuchs–Sondheimer, Mayadas–Shatzkes) to a quantum-confinement regime in few-nanometre films; highlights the recently proposed reciprocal-space confinement theory, which predicts an exponential resistivity increase with decreasing thickness, and shows how that theory can be combined with classical surface- and grain-boundary-scattering models to yield a unified description consistent with recent experiments and relevant to nanoelectronic interconnects and quantum transport.  
**Method**: The paper is a theoretical and experimental review: it synthesizes existing models (Fuchs–Sondheimer and Mayadas–Shatzkes), presents and analyses the reciprocal-space confinement theory as the quantum-confinement description, and discusses how to combine this quantum theory with classical surface-scattering models; it also surveys recent experimental evidence supporting the crossover.  
**Tags**: `quantum_confinement,surface_scattering,reciprocal-space_confinement,ultra-thin_films,resistivity_scaling,nanoscale_interconnects,quantum_transport,quantum_devices`
...
**TL;DR**: The paper studies particle and spin transport in small networks of spinor exciton-polariton condensates (triangles, squares, larger rings), showing how spin-conserving and TE–TM-induced spin-flip tunnelling produce circulating particle currents, hidden spin counterflows and bond-dependent spin-current patterns; it derives analytical edge-resolved currents for minimal plaquettes, maps phases via particle and spin current diagnostics, and extends the analysis to larger rings using winding numbers and a branch-invariant common-phase coherence metric.  
**Method**: Analytical derivation of edge-resolved currents from stationary configurations obtained by energy minimization for minimal geometries (equilateral triangle, square), combined with current-resolved diagnostics applied numerically/analytically to larger polygonal rings characterized by winding numbers and a branch-invariant common-phase coherence metric.  
**Tags**: `exciton-polaritons, spinor-condensates, spin-currents, TE-TM-splitting, plaquette-geometry, polygonal-rings, winding-numbers, topology`
...
**TL;DR**: Resonant cooling of nuclear spins in MAPbI3 single crystals is demonstrated via optically generated spin-polarized holes: Hanle-effect measurements with helicity-modulated excitation show frequency-dependent shifts of a resonance attributable to 207Pb (I=1/2) nuclei; analysis of resonance sign and width implies cooling by holes (negative g-factor) and identifies strongly localized holes as the dominant cooling agents.  
**Method**: Helicity-modulated optical orientation combined with transverse-field Hanle-effect measurements at variable modulation frequency; identification of the nuclear-species (207Pb) from rotational invariance, extraction of carrier g-factor sign from resonance shape, and comparison of resonance fields to Hanle half-widths to infer carrier localization.  
**Tags**: `perovskite, nuclear_spin_cooling, Hanle_effect, optical_orientation, holes, Pb-207, hyperfine_interaction, localized_carriers, spintronics`
...
**TL;DR**: Spin-orbit coupling mixes momentum-odd orbital polarization of structurally chiral crystals with momentum-odd spin polarization of helical (p-wave) magnetic textures, producing an additional spin splitting classified by a relative chirality η=χ_c χ_m. This yields two symmetry-distinct p-wave phases (homochiral and heterochiral) with different longitudinal conductivity signatures, making relative chirality an experimentally accessible degree of freedom in chiral magnetic systems.  
**Method**: Theoretical symmetry and spin-orbit–coupling analysis showing how orbital and magnetic chirality couple; classification of emergent spin-orbital states by the relative chirality η and prediction of distinct transport (longitudinal conductivity) signatures for the two phases.  
**Tags**: `p-wave_magnetism, spin-orbit_coupling, chiral_crystals, spin_textures, transport_signatures`
...
**TL;DR**: Synthesis of Sr0.75ClNbS2 yields a bulk crystal with enforced unidirectional AA stacking (D3h, globally noncentrosymmetric) that preserves monolayer-like Ising spin–orbit coupling and spin-split bands across the bulk, producing quasi-2D, extremely anisotropic superconductivity (γ ≈ 77), an in-plane Hc2 well above the Pauli limit, and a magnetic-field-induced anomalous metallic state with finite dissipation but vanishing Hall response.  
**Method**: Chemical synthesis of Sr0.75ClNbS2 using a planar Sr–Cl network to drive global stacking reorganization from AB to AA; characterization via transport measurements (Hc2 anisotropy, magnetotransport showing anomalous metallic phase, clean-limit indicators) and direct band-structure probes to confirm layer-decoupled, spin-split electronic structure.  
**Tags**: `superconductivity, noncentrosymmetric, Ising_SOC, quasi-2D, stacking_engineering, topology, quantum_devices`
...
**TL;DR**: Low concentrations of vacancies or hydrogenation in monolayer graphene create a large density of low-energy states that enable superconductivity to emerge from arbitrarily weak attractive interactions. For conventional s-wave pairing this produces a finite order parameter and a global phase-coherent state with nonzero superfluid weight of geometrical origin; hydrogenation away from the chiral vacancy limit behaves similarly. Nearest-neighbor (unconventional) pairing is more disrupted but still shows quantum-critical-like behavior and retains phase coherence at weak coupling with mixed d-wave symmetry.  
**Method**: Theoretical analysis of disordered monolayer graphene with dilute vacancies and hydrogenation; evaluation of low-energy density of states, superconducting order parameter, transition temperature and superfluid weight for conventional s-wave and nearest-neighbor (unconventional) pairing channels (analysis highlights geometrical origin of superfluid weight and behavior away from chiral limit).  
**Tags**: `superconducting_impurity, quantum_geometry, disorder-induced_superconductivity, graphene, s-wave, d-wave, vacancies, hydrogenation, phase_coherence, unconventional_pairing`
...
**TL;DR**: PtBi2 hosts singly-degenerate, spin-polarized Fermi-arc surface states, establishing nontrivial topology and meeting a necessary condition for topological superconductivity; the Fermi-arc dispersion is strongly surface-termination dependent (nearly flat or approximately linear), consistent with first-principles calculations.  
**Method**: Spin- and angle-resolved photoemission spectroscopy (SARPES) to measure spin polarization and dispersion of surface Fermi arcs, supported by first-principles electronic-structure calculations (DFT) to model termination-dependent band shapes.  
**Tags**: `topology, topological_superconductivity, spin-resolved_ARPES, Fermi_arcs, surface_termination, first-principles`
