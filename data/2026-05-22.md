...
**TL;DR**: Non-uniform Berry curvature in a continuum Chern band drives formation of momentum-space vortices in a chiral superconducting gap; vortex nucleation lowers condensation energy, is constrained by the parent-band Chern number, and can be probed via thermal Hall response—relevant to rhombohedral graphene.  
**Method**: Solve the full BCS gap equation beyond weak coupling on a tunable continuum λ_N-model with controllable Berry-curvature profiles; derive analytic constraint linking parent-band Chern number to allowed vortex number; develop a gauge-invariant BdG Berry-curvature formulation expressed via a momentum-space phase current.  
**Tags**: `quantum_geometry, topology, vortex, chiral_superconductivity, BdG, berry_curvature, Chern_number, rhombohedral_graphene`
...
**TL;DR**: A two-mode topological phase in a Kitaev ladder is destabilized by a finite charge current: incorporating current as a quasiparticle-momentum shift in an effective Hamiltonian, the authors find that bulk invariants and an entanglement-based real-space diagnostic (edge–edge quantum conditional mutual information Iee) both signal loss of topological protection under finite current flux.  
**Method**: Derive an effective Hamiltonian that encodes quasiparticle momentum induced by an applied charge current; evaluate bulk topological invariants and real-space entanglement diagnostics (notably the edge–edge quantum conditional mutual information Iee) for the Kitaev ladder to diagnose stability of the two-mode topological phase.  
**Tags**: `topology, superconductivity, Kitaev_ladder, Majorana, entanglement, quantum_devices, current-induced_decoherence`
...
**TL;DR**: Developed a TaOx-based planar tunneling-junction platform (fabricated by magnetron sputtering) for van der Waals superconductors. Benchmarking on Bi2Sr2CaCu2O8+δ reproduces high-quality STM-like tunneling spectra and enables high-precision spectroscopy across wide temperature and magnetic-field ranges, offering a universal probe for 2D quantum materials.  
**Method**: Fabrication of planar TaOx tunneling junctions by magnetron sputtering on vdW superconductors; tunneling spectroscopy measurements as a function of temperature and magnetic field on Bi2212 and comparison to STM/STS benchmarks.  
**Tags**: `superconductivity, tunneling_spectroscopy, quantum_devices, van_der_Waals_superconductors, device_fabrication, TaOx, Bi2212, magnetron_sputtering, magnetic_field_dependence, temperature_dependence`
...
**TL;DR**: Paper proposes the anomalous acoustoelectric effect as an electrical probe of chiral p-wave pairing in two-dimensional superconductors: an acoustic wave generates a transverse DC current and boundary condensate phase difference via anisotropic quasiparticle scattering (no external magnetic field). The quasiparticle-mediated response dominates near Tc and is not suppressed by electron–hole asymmetry, making it a high-sensitivity signature of unconventional (chiral) order.  
**Method**: Theoretical proposal and analysis demonstrating that anisotropic scattering of quasiparticles by an acoustic wave in a 2D chiral p-wave superconductor produces a transverse DC (anomalous) acoustoelectric current and measurable condensate phase difference; emphasis on the quasiparticle-mediated contribution near Tc and its independence from electron–hole asymmetry.  
**Tags**: `topology,superconductivity,chiral_p-wave,acoustoelectric,quasiparticle_transport,unconventional_pairing,two-dimensional`
...
**TL;DR**: Demonstration of millimeter-scale, ultra-thin YBa2Cu3O7-x films grown by high-pressure sputtering on STO/SCAO bilayers, released as STO nanomembranes and transferred onto SiO2/Si while retaining crystallinity and robust superconducting transport (Tc=88.8 K, Jc=6.8 MA/cm2 at 77 K). Thermal boundary conductance across the van‑der‑Waals interface to SiO2/Si is strongly reduced (15–75 K), altering energy relaxation and stabilizing transient resistive states—establishing a platform for integrating high‑Tc superconducting devices with Si photonics.  
**Method**: High‑pressure sputtering growth of YBCO on an STO/SCAO bilayer, chemical release of STO nanomembranes by dissolving the water‑soluble SCAO sacrificial layer, transfer of the STO+YBCO membrane onto SiO2/Si, structural characterization (XRD) and transport measurements of patterned microbridges; thermal boundary conductance measured across the van‑der‑Waals interface over 15–75 K.  
**Tags**: `high-Tc, YBCO, nanomembrane, van_der_Waals_interface, thermal_boundary_conductance, superconducting_nanowire_detectors, photonic_integration, quantum_devices`
...
**TL;DR**: Introduces s-qpGW, a superconducting extension of quasiparticle self-consistent GW coupled to Eliashberg equations including both phonon- and plasmon-mediated pairing. The method reproduces state-of-the-art Eliashberg results for bulk metals, correctly finds no superconductivity in doped monolayer graphene, and captures dynamical Coulomb screening effects beyond standard BCS in a model graphene system with enhanced density of states.  
**Method**: Coupling quasiparticle self-consistent GW (qpGW) to superconducting Eliashberg theory to treat phonon and plasmon pairing channels on equal footing, thereby incorporating first-principles dynamical Coulomb screening in the electronic pairing interaction (method named “s-qpGW”). Benchmarked against bulk metals and applied to monolayer/model graphene.  
...
**TL;DR**: Hole-doped, strongly bound systems that map onto a universal hardcore-boson model can sustain superconducting pair formation; demonstrated in a double Kondo lattice where analytic mapping and DMRG show a pairing state persists via a crossover away from strict strong-coupling, and pair correlations emerge once binding energy is generated regardless of local spin-detail.  
**Method**: Analytic mapping to the universal hardcore-boson model in the strong-binding-energy limit, plus numerical density-matrix renormalization group (DMRG) calculations on the double Kondo lattice to track pairing, crossovers, and correlation behavior.  
**Tags**: `superconductivity,hardcore_boson,double_Kondo_lattice,Kondo_lattice,DMRG,binding_energy,pairing_correlations,strong_coupling`
...
**TL;DR**: Review of experimental charge and spin transport in topological semimetals (primarily Weyl), assessing how chiral topological surface states manifest in transport despite gapless bulk; surveys superconducting-proximity devices, spin-dependent transport, magnetic response of surface states, and nonlinear anomalous Hall measurements (Berry-curvature effects) and discusses potential applications.  
**Method**: Literature review synthesizing experimental transport and magneto-transport studies: superconducting-proximity devices, spin-resolved and magnetotransport measurements of surface states, and nonlinear Hall measurements as probes of Berry curvature.  
**Tags**: `topology, quantum_geometry, spin_transport, superconducting_proximity, Weyl_semimetal, nonlinear_anomalous_Hall`
...
**TL;DR**: Near-surface electronic spins experience an intrinsic zero-temperature relaxation channel arising from gyromagnetic coupling to the vorticity of Rayleigh (surface acoustic) waves. This mechanism requires no thermal phonons, is set by Rayleigh vorticity rather than g-factor modulation, and produces super‑Ohmic, depth‑evanescent spectral properties that yield characteristic field and depth scalings. Implications include using shallow spin sensors and hybrid SAW–spin interfaces to detect acoustic quantum friction.  
**Method**: Theoretical analysis identifying gyromagnetic coupling between near-surface spins and Rayleigh-wave vorticity, characterization of the Rayleigh-vorticity bath as super‑Ohmic and evanescent with depth, derivation of resulting field and depth scalings for spin relaxation, and proposal of sensing/interfaces to detect Rayleigh-wave acoustic quantum friction.  
**Tags**: `vortex, surface_acoustic_wave, Rayleigh_wave, spin_relaxation, super-Ohmic_bath, acoustic_friction, quantum_devices`
...
**TL;DR**: Provides a rigorous quantization framework for networks of open optical/plasmonic resonators: derives quasinormal-mode (QNM) boundary conditions for arbitrary connected geometries and constructs a system–bath Hamiltonian for multiple interacting QNMs coupled to quantum emitters and a non‑bosonic bath of propagating photons, with coupling matrix elements computable from Maxwell solvers and bath-mediated, time‑delayed correlation functions for open-system dynamics.  
**Method**: Analytical derivation of general QNM boundary conditions for resonators connected via surfaces or waveguides; formulation of a quantization scheme yielding a system–bath Hamiltonian with explicitly defined coupling elements (including light–matter coupling) that can be evaluated using electromagnetic (Maxwell) solvers; definition of system–bath correlation functions to capture bath‑mediated, time‑delayed interactions.  
**Tags**: `quantum_devices, quantum_computing, quasinormal_modes, waveguides, light-matter_coupling, system-bath, open_quantum_systems, photonics`
...
**TL;DR**: Epitaxial FeSn/Py heterostructures exhibit a giant effective spin mixing conductance g_eff=(116±7) nm^{-2}—≈10× larger than Pt/Py—and an order‑of‑magnitude larger inverse spin Hall voltage; inserting a 3 nm Al spacer halves the additional damping, implicating a topologically active [001] kagome FeSn/Py interface as the origin.  
**Method**: Experimental spin‑pumping study using epitaxial FeSn/Ni80Fe20 (Py) heterostructures: ferromagnetic resonance/damping extraction to obtain g^{↑↓}_{eff}, inverse spin Hall voltage measurements for spin‑to‑charge conversion, spacer‑layer (3 nm Al) insertion and Pt/Py reference stacks for interfacial control and comparison.  
**Tags**: `topology, spintronics, spin_pumping, spin_mixing_conductance, inverse_spin_Hall, kagome, topological_surface_states, FeSn, interfaces, quantum_devices`
...
**TL;DR**: Demonstration of photoinduced modulation doping in hBN–graphene–hBN–SiO2 heterostructures using standard white light to reversibly control carrier density and charge disorder, enabling in situ switching between diffusive and quasi‑ballistic transport and recovery of quantum Hall isospin ferromagnetic states in otherwise low‑quality devices.  
**Method**: Optical (white‑light) photoinduced modulation doping and photoannealing of hBN‑encapsulated graphene (no added fabrication steps); transport characterization and parameter extraction using Drude and Landauer models to quantify mobility and mean scattering length and to track reversible tuning of disorder and transport regime.  
**Tags**: `topology, quantum_devices, impurity_physics, graphene, van_der_Waals, transport, modulation_doping`
...
### [13] [Spintronic Neuromorphic Hardware Using Domain Wall Based Neurons and Quantized Synapses](https://arxiv.org/abs/2605.22625)
*Sakshi Kiran Bandekar, Arnab Ganguly, Debanjan Polley, Debasis Das*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.22625)

**TL;DR**: Authors simulate spintronic neuromorphic elements where transverse domain-wall (DW) motion in heavy-metal/ferromagnet nanotracks (with semicircular notch corrugations) implements neuron (ReLU via 3 ns pulse) and synapse (stepwise, pinning-mediated conductance states via 10 ns pulses). DW pinning/depinning produces stable, discrete conductance levels as synaptic weights and a history-dependent depinning delay that mimics synaptic memory. They test a fully connected ANN on MNIST/Fashion-MNIST achieving ~97%/~86% with float32 weights and ~95%/~62% after quantizing weights.  
**Method**: Numerical simulation of spin-orbit-torque-driven transverse domain-wall dynamics in corrugated HM/FM nanotracks to emulate neuron activation (short pulses) and synaptic weight storage (pinning at notches); mapping pinned-DW conductances to ANN weights and evaluating classification performance (including weight quantization) on MNIST and Fashion-MNIST.  
**Tags**: `spintronics, spin-orbit_torque, domain_wall_dynamics, neuromorphic, machine_learning, quantum_devices, synaptic_weights, MNIST`
...
**TL;DR**: TL;DR: The Comment argues the reported double-quantum-dot “quantum clock” is actually classical (no intrinsic temporal correlations between ticks) and thus inadequate as a true clock, and that the thermodynamic accounting misassigns entropy—conflating amplification/engineering dissipation with a fundamental cost of quantum timekeeping.  
**Method**: The paper is a theoretical Comment/critique that analyzes the original Letter’s claims: (i) conceptual analysis of the device’s operational statistics to show absence of intrinsic temporal correlations and classical behavior; (ii) thermodynamic bookkeeping critique distinguishing fundamental entropy production from engineering amplification/dissipation and measurement versus amplification.  
**Tags**: `quantum_devices,measurement,thermodynamics,entropy,classicality,timekeeping`
...
**TL;DR**: Demonstrates electrically tunable coupling and band hybridisation in a nanopatterned bicomponent magnonic crystal (Permalloy/heavy-metal bilayer with Co nanodot array). Inhomogeneous current-induced (field-like) spin torque periodically modulates magnon frequencies, producing avoided crossings between localized and propagating Damon–Eshbach modes, tunable hybridisation gaps, band deformation, and reconfigurable mode conversion at the nanoscale.  
**Method**: Modeling with the plane-wave method combined with the linearised Landau–Lifshitz equation including a field-like (current-induced) torque term to capture spatially inhomogeneous spin-torque modulation of the magnonic band structure and mode hybridisation.  
**Tags**: `magnonic_crystal, spin_wave, spin_orbit_torque, mode_hybridisation, Damon_Eshbach, band_structure, quantum_devices`
...
### [16] [Quantum Batteries in two-dimensional material-based Josephson Junctions](https://arxiv.org/abs/2605.22582)
*V. Varrica, G. Gemme, F. M. D. Pellegrino, E. Paladino, M. Sassetti, D. Ferraro*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.22582)

**TL;DR**: Proposal and theoretical analysis of a solid-state Dicke-like quantum battery: a 2D-material (graphene) Josephson junction inductively coupled to an LC resonator, where Andreev bound states act as non-interacting, non-degenerate two-level systems. Flux–supercurrent coupling produces longitudinal interaction terms beyond the conventional Dicke model that can enhance charging; charging can be done via photon drives or by tuning the superconducting phase difference.  
**Method**: Modeling of a Josephson-junction–LC resonator hybrid (graphene-based junction as representative) treating Andreev bound states as two-level systems; identification and derivation of single- and two-photon resonant processes and additional longitudinal coupling terms arising from flux–supercurrent interaction; parameter-space analysis showing regimes where these extra couplings boost energy storage; proposal of an equivalent charging protocol based on phase-bias control.  
**Tags**: `quantum_devices, superconductivity, Josephson_junction, Andreev_bound_states, Dicke_model, circuit_QED, two_photon_processes, phase_control`
...
### [17] [Nonlinear frequency shift and bistability of magnon-polarons](https://arxiv.org/abs/2605.22157)
...
**TL;DR**: Strong coupling between standing SAW cavity modes and finite-k spin waves in a YIG/ZnO resonator produces pronounced avoided crossings in the linear regime; at high drive power a cross-shift (from simultaneous +k and -k SW excitation) causes a positive nonlinear SW frequency shift that can bring the magnon into resonance with the SAW, producing large magnon population, broadband nonlinear scattering, bistable foldover and eventual stabilization of magnon and phonon responses. This establishes SAW-driven k≠0 magnon–phonon hybrids as a platform for nonlinear magnetoacoustics and wave-based information processing.  
**Method**: Experimental: microwave reflection measurements combined with microfocused Brillouin light scattering spectroscopy on a YIG/ZnO SAW resonator; theoretical modeling via a vector Hamiltonian formalism for nonlinear spin-wave dynamics identifying a dominant cross-shift term from counterpropagating SWs.  
**Tags**: `magnon-phonon_coupling, surface_acoustic_waves, spin_waves, nonlinear_dynamics, magnetoacoustics, bistability, YIG_ZnO, quantum_devices`
...
### [18] [Quantum-metric Bloch oscillations in weakly inhomogeneous electric fields](https://arxiv.org/abs/2605.22227)
*M. Maneesh Kumar, Md Kaif Faiyaz, Sayan Sarkar, Amit Agarwal*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.22227)

**TL;DR**: Weak spatial inhomogeneity in an applied electric field produces a quantum‑metric contribution to semiclassical wavepacket dynamics that yields oscillatory real‑space motion even when Berry curvature = 0. The induced transport has an intrinsic part and a scattering‑time‑dependent part that can dominate and saturate at large fields; mechanism is demonstrated in a tilted Dirac model and realistic realization likely needs engineered superlattices with finite quantum metric and a band gap.  
**Method**: Semiclassical wavepacket dynamics extended to include weak electric‑field inhomogeneity, deriving a quantum‑metric term in the equations of motion; analytic decomposition of transport response into intrinsic and scattering‑time‑dependent contributions; demonstration via a tilted Dirac model and discussion of experimental platform requirements (superlattices, finite quantum metric, band gap).  
**Tags**: `quantum_geometry, wavepacket_semiclassics, Berry_curvature, transport, tilted_Dirac_model, superlattice`
...
### [19] [Entanglement Dynamics across a Monitored Quantum Point Contact](https://arxiv.org/abs/2605.22555)
*Anna Delmonte, Marco Schirò*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.22555)

**TL;DR**: Monitoring single-site particle losses at a quantum point contact qualitatively alters entanglement production: instead of unitary logarithmic growth, entanglement exhibits an initial linear increase up to a volume-law maximum and then a slow decay to zero as the system empties. A quasiparticle picture explains this via an emergent, transient bias induced by losses; results are tied to Page-curve ideas and probed via full counting statistics.  
**Method**: The study computes entanglement dynamics for a monitored quantum point contact with particle losses recorded on a single site, combining explicit calculation of entanglement entropy and full counting statistics with a quasiparticle semiclassical picture that captures the crossover (loss-induced emergent bias → system depletion). Connections to Page-curve phenomenology and experimentally relevant probes are established.  
**Tags**: `measurement-induced_entanglement, entanglement_dynamics, quantum_point_contact, full_counting_statistics, Page_curve, quasiparticle_picture, monitored_quantum_systems, quantum_devices, ultracold_atoms, mesoscopic_systems`
...
### [20] [Monitored quantum transport through a disordered one-dimensional conductor](https://arxiv.org/abs/2605.22701)
*J. Sánchez Fernán, J. Tworzydło, C. W. J. Beenakker*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.22701)

**TL;DR**: Derives a quantum master equation for the many-particle density matrix of electrons in a single‑mode disordered conductor subject to time‑resolved projective measurements. Monitoring yields binomial full counting statistics (mean T, variance T(1−T)), suppresses 1D Anderson localization so transmission vs length L crosses over at L≈ℓ_φ from exponential e^{−L/ξ} to Ohmic 1/L, and for weak monitoring the coherence length scales as ℓ_φ ≃ ξ ln(v_F τ_φ/ξ).  
**Method**: Construct a quantum master equation combining elastic scattering by static disorder with stochastic/projective time‑resolved measurements of scattering outcomes; compute full counting statistics and transmission statistics analytically and by numerical solution of the master equation to extract decay laws and the dependence of the monitoring‑induced coherence length ℓ_φ on the mean measurement interval τ_φ.  
**Tags**: `quantum_master_equation,measurement-induced_decoherence,full_counting_statistics,Anderson_localization,shot_noise,single-mode_conductor,quantum_devices`
...
**TL;DR**: Counterflow conductivity of driven interlayer excitons in a bilayer with a 1D periodic potential and strong perpendicular magnetic field can be used to probe the excitons' quantum geometric dipole (QGD). The paper derives magnetoexciton bands with nontrivial QGD and shows — via a semiclassical Boltzmann transport treatment that includes inter-band tunneling and layer-antisymmetric driving — how linear-response counterflow signatures (to layer-symmetric fields) and their tuning by layer-antisymmetric fields reveal the excitons' internal quantum geometry.  
**Method**: The authors build magnetoexciton bandstructures for a bilayer with a one-dimensional periodic potential in a strong B-field, compute the exciton QGD distribution, and model exciton transport using a semiclassical Boltzmann equation including inter-band tunneling to obtain non-equilibrium momentum distributions under layer-antisymmetric driving; they analyze linear-response counterflow conductivity to extract QGD signatures.  
**Tags**: `quantum_geometry, interlayer_excitons, magnetoexciton, counterflow_conductivity, Boltzmann_transport, interband_tunneling, bilayer_systems`
...
### [22] [Nonlinear Photonic Tripartite Phase](https://arxiv.org/abs/2605.21983)
...
**TL;DR**: Experimentally demonstrates a tripartite phase (coexisting localized, critical and extended states) in a nonlinear quasiperiodic photonic lattice; Kerr nonlinearity acts as an effective interaction that enables state-selective tuning into and out of a pre-existing critical window, tracked via wavepacket dynamics.  
**Method**: Experimental realization in a nonlinear quasiperiodic photonic lattice with controlled Kerr nonlinearity; characterization via time-resolved wavepacket dynamics to separate localized, critical and extended transport and to observe state-dependent nonlinear response (weak nonlinearity delocalizes low-energy localized states into the critical window; stronger nonlinearity induces self-trapping).  
**Tags**: `quasiperiodic, Anderson_localization, mobility_edge, critical_window, Kerr_nonlinearity, photonic_lattice, nonlinear_interactions, wavepacket_dynamics`
...
### [23] [Direct observation of the transverse near field of an edge excitation and associated slow secondary dynamics in a fractional quantum Hall state](https://arxiv.org/abs/2605.21989)
...
**TL;DR**: Stroboscopic time‑resolved photoluminescence imaging of a ν=1/3 fractional quantum Hall edge reveals an immediate, non‑radiative quasi‑electrostatic near‑field that extends >30 μm into the bulk when an edge magnetoplasmon (EMP) passes the mesa boundary, showing the EMP is a spatially extended collective excitation; distinct, slower secondary bulk responses are also observed, indicating multi‑timescale bulk dynamics triggered by electrically launched edge excitations.  
**Method**: Stroboscopic time‑resolved photoluminescence (PL) microscopy and spectroscopy producing y–t maps of the transverse PL response to electrically launched edge magnetoplasmons in a ν=1/3 fractional quantum Hall mesa, distinguishing immediate near‑field (quasi‑electrostatic) signals from secondary delayed bulk responses.  
**Tags**: `fractional_quantum_Hall, edge_magnetoplasmon, near_field, time_resolved_photoluminescence, collective_excitation, bulk_dynamics`
...
### [24] [Signatures of quantum chaos in phonon-polariton billiards](https://arxiv.org/abs/2605.22753)
...
**TL;DR**: Scanning near-field optical microscopy of hyperbolic phonon polaritons in hBN billiards reveals coexistence of chaotic (Sinai-like) random-wave/scarred modes and non‑chaotic one‑dimensional boundary modes; Fourier-space statistics approach Berry’s random‑wave limit as boundaries become complex. Numerical Helmholtz simulations with angle‑dependent reflection phases and dissipative Green’s‑function theory reproduce a crossover in level statistics from Poisson‑like to Wigner‑Dyson‑like behaviour with deviations due to nonlinear, self‑consistent bulk–boundary conditions.  
**Method**: Experiment: scattering-type scanning near‑field optical microscopy (SNOM) imaging and spatial Fourier analysis of hyperbolic phonon polariton modes in patterned hBN billiards. Theory/numerics: Helmholtz equation with generalized (angle‑dependent) boundary conditions encoding polariton reflection phase shifts; level‑statistics analysis; dissipative Green’s‑function calculations to model near‑field response.  
**Tags**: `hyperbolic_polaritons,hBN,quantum_chaos,quantum_scarring,level_statistics,boundary_conditions,scanning_near-field,dissipative_Green_function`
