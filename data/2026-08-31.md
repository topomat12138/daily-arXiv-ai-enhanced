...
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28166)

**TL;DR**: Experimental magnetotransport study of ~200 nm epitaxial ZrN_x films finds signatures of a two-dimensional quantum Griffiths singularity (QGS) despite macroscopic 3D superconductivity: magnetoresistance isotherms under perpendicular and parallel fields show broad crossing ranges; 2D power-law scaling yields a diverging effective exponent zν near the quantum critical point, and resistivity follows an activated scaling consistent with an infinite-randomness critical point. The QGS is attributed to quenched disorder (Zr vacancies, N interstitials) producing inhomogeneous superconducting rare regions with effective 2D dynamics.  
**Method**: Experimental magnetotransport (low-temperature magnetoresistance isotherms in perpendicular and parallel fields) combined with scaling analyses: 2D power-law scaling to extract effective critical exponent zν and activated scaling analysis for infinite-randomness critical behavior.  
**Tags**: `quantum phase transitions, quantum Griffiths singularity, disorder-induced inhomogeneity, dimensional crossover (2D vs 3D), superconductor-insulator transition`
...
**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28485)

**TL;DR**: For a massive-Dirac s-wave superconductor at T=0, solving the Bethe–Salpeter equation with collective-mode contributions shows that the vertex correction in the static long-wavelength limit cancels the bare longitudinal response when normal-state subtraction (NSS) is applied, restoring gauge invariance; the transverse response (Meissner weight) equals the bare transverse response with NSS. Within isotropic analytic UV regularizations, gauge invariance uniquely fixes the regularization to the NSS prescription.  
**Method**: Analytic, zero-temperature calculation for a massive-Dirac model with s-wave pairing: solve the Bethe–Salpeter equation including collective-mode contributions to the electromagnetic vertex (vertex correction) and analyze the static long-wavelength electromagnetic response; compare with normal-state subtraction and examine isotropic analytic UV regularization.  
**Tags**: `Dirac superconductors, gauge invariance, electromagnetic response, collective modes, Meissner effect`
...
**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28565)

**TL;DR**: The paper explains the ‘anti-Q slope’ in superconducting RF cavities by identifying field-induced subgap surface Bogoliubov quasiparticle states via numerical Bogoliubov–de Gennes (BdG) calculations. They introduce a modified “three‑fluid” model that separates continuum and surface quasiparticle contributions and compute RF dissipation semiclassically using impurity scattering rates estimated from ab initio impurity potentials in niobium, showing that relative scattering rates can produce and switch an anti‑Q slope.  
**Method**: Numerical solution of Bogoliubov–de Gennes equations at a superconducting surface in a parallel magnetic field; formulation of a three‑fluid extension of the two‑fluid model; semiclassical conductivity calculations of RF dissipation using elastic scattering times for point‑like impurities, with impurity potential strengths informed by ab initio calculations in bulk Nb.  
**Tags**: `superconducting cavities, surface superconductivity, impurity physics, quasiparticle dynamics, quantum materials`
...
### [4] [Collinear altermagnetism for 3D chiral higher-order topological insulators](https://arxiv.org/abs/2608.27552)
*Andreas Hadjipaschalis, Jennifer Cano*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.27552)

**TL;DR**: Proposes that collinear altermagnetism realizes the long-sought chiral C4𝒯-protected higher-order topological insulator. A microscopic model (3D topological insulator coupled to a d-wave collinear altermagnet on a Lieb lattice) is analyzed analytically and numerically to show surface Dirac cones are shifted/gapped by the magnetism, producing chiral hinge channels; candidate material classes are proposed.  
**Method**: Construct and analyze a microscopic lattice model combining a three-dimensional topological insulator with a collinear d-wave altermagnet on a Lieb lattice; use analytical arguments and numerical calculations to show magnetism gaps/shifts surface Dirac cones and yields chiral hinge modes; identify prospective material classes.  
**Tags**: `higher-order topology, altermagnetism, topological insulators, symmetry-protected topology, hinge states, quantum materials`
...
### [5] [Quantum geometric bounds at finite temperature for one-dimensional chiral systems](https://arxiv.org/abs/2608.27944)
*Peng He, Hai-Tao Ding, Yu-Guo Liu*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.27944)

**TL;DR**: Derives rigorous finite-temperature geometric lower bounds for 1D chiral-symmetric systems within Uhlmann’s mixed-state framework: the Bures length is bounded below by a continuous Uhlmann geometric phase, with a temperature-dependent bound interpolating between zero-temperature topological bounds and a trivial high-T limit. Results are validated analytically and numerically on the SSH model and spinless Kitaev chain; prospects for experimental access via QITE are discussed.  
**Method**: Analytical derivation of geometric lower bounds for mixed states using the Uhlmann formalism (Bures metric and Uhlmann phase), supplemented by analytical and numerical checks on model Hamiltonians (SSH and spinless Kitaev chain) and discussion of detection via quantum imaginary time evolution (QITE) in quantum circuits.  
**Tags**: `quantum geometry, topological superconductivity, quantum materials, quantum circuits`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.27588)

**TL;DR**: Quench dynamics of driven graphene nanoribbons are analyzed: after sudden switch‑on of circularly polarized light (with/without staggered mass) the stroboscopic period‑averaged edge bond current oscillates about a dc value equal to Floquet band currents weighted by projected occupations; coupling to a fermionic bath drives the system to a nonequilibrium steady state and, in the vanishing coupling limit, a quantized sum‑rule conductance reveals the number of edge modes across quasienergy gaps.   
**Method**: Time‑dependent Floquet analysis and transport calculations on an armchair graphene nanoribbon: compute period‑averaged (stroboscopic) bond currents and analytically relate dc current to Floquet band currents with projected occupations; include coupling to a fermionic bath and perform finite‑size two‑terminal tight‑binding conductance calculations under a three‑step driving protocol, applying a sum rule over bath chemical potentials.  
**Tags**: `Floquet engineering, topological phases, edge transport, open quantum systems, quantum materials`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.27625)

**TL;DR**: A uniform Zeeman field can strongly reconfigure and even reverse the single-electron charge polarization of an asymmetric open double quantum dot without changing total electron number. Reversal occurs via two mechanisms: (i) unequal gate levels lead to different occupation responses because Zeeman-shifted resonances cross the reservoir chemical potential at different fields, and (ii) unequal onsite interactions produce different many-body addition spectra. Coulomb blockade locks the system in the single-electron sector so the effect appears as spatial charge redistribution at fixed electrostatic detuning.  
**Method**: Symmetry-preserving Green’s-function equation-of-motion treatment of an open double quantum dot coupled to reservoirs, tracking occupations and resonance shifts under a uniform Zeeman field while varying gate detuning and onsite interactions.  
**Tags**: `quantum dots, Coulomb blockade, impurity physics, quantum transport, spintronics, charge polarization`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.27823)

**TL;DR**: Under CW incoherent Gaussian pumping, polariton condensate formation departs from the usual supercritical (cubic) Stuart–Landau scenario when reservoir repulsion is strong and pump spots are small: a quintic Stuart–Landau amplitude equation governs dynamics, producing a subcritical pitchfork bifurcation, bistability (one-bit memory) and, beyond perturbative validity, a self‑trapping regime with complex dynamics. Experimental evidence is reported.  
**Method**: Analytical reduction of driven-dissipative polariton mean-field dynamics to an amplitude equation via perturbation theory (Stuart–Landau framework), identification of regime where quintic term dominates, bifurcation analysis across parameter space, and comparison with/validation by experiment.  
**Tags**: `polariton condensates, driven-dissipative condensates, nonlinear dynamics, bifurcation theory, memory effects`
...
### [9] [Multi-dimensional spectroscopy of mobile excitons in two-dimensional semiconductors](https://arxiv.org/abs/2608.27951)
*Ned Wheaton, Jeffrey A. Davis, Jesper Levinsen, Meera M. Parish*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.27951)

**TL;DR**: Microscopic theory of multi-dimensional coherent spectroscopy (MDCS) for two-dimensional semiconductors that treats delocalized, mobile excitons with continuous momentum. The exciton momentum continuum is shown to be essential for interaction-induced decoherence and for interference between exciton-polaron quasiparticles in doped samples. Calculated MDCS spectra reproduce recent doped monolayer MoSe2 experiments and indicate exciton-polaron interactions are strongly governed by phase-space filling (competition for electrons).  
**Method**: Develop a microscopic MDCS theory incorporating mobile excitons with continuous momentum degrees of freedom (beyond few-level phenomenological models), calculate interaction effects and spectra for charge-doped 2D semiconductors and compare with experimental MDCS on doped monolayer MoSe2.  
**Tags**: `quantum materials, exciton physics, polaron physics, optical spectroscopy, many-body correlations`
...
### [10] [Significant modulation of acoustoelectric current associated with charge density wave transitions](https://arxiv.org/abs/2608.27959)
*Natsumi Nikaido, Takuya Kawada, Koji Fujiwara, Jihoon Park, Nan Jiang, Kouta Kondou, Shintaro Takada, Yasuhiro Niimi*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.27959)

**TL;DR**: SAWs on a piezoelectric substrate drive sizeable acoustoelectric currents in CDW materials NbSe3 and 2H-TaSe2; both magnitude and sign of the AE current change across the CDW transition and depend on SAW propagation direction relative to the substrate crystal axes. A phenomenological strain-modified conductivity model qualitatively accounts for the observations, identifying SAW–electron coupling in van der Waals CDW systems and suggesting a probe for straintronics.  
**Method**: Experimental measurements of acoustoelectric (AE) currents induced by surface acoustic waves (SAWs) on a piezoelectric substrate coupled to CDW materials (NbSe3, 2H-TaSe2), combined with a phenomenological model that attributes the effects to strain-modified electrical conductivity and includes SAW propagation orientation dependence.  
**Tags**: `charge density waves, acoustoelectric effects, straintronics, van der Waals materials, electron-phonon/SAW interactions`
...
### [11] [Topological signatures in the curvature-induced energy response](https://arxiv.org/abs/2608.28146)
*Jaehyeok Lee, Iuegyun Hong, Jinhong Park*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28146)

**TL;DR**: In a microscopic lattice study of the nonrelativistic Haldane model, the authors show curvature-induced energy responses are bond-dependent at first order (nonuniversal) but exhibit a universal discontinuity at third order across the topological transition that matches the relativistic gravitational Chern–Simons prediction.  
**Method**: Microscopic lattice formulation of curvature-induced deformations applied to the Haldane model; compute energy response in a spatial-gradient expansion up to third order and compare the discontinuity at the topological transition with the relativistic gravitational Chern–Simons effective-field-theory prediction.  
**Tags**: `topological phases, topological response, lattice models, effective field theory, quantum materials`
...
### [12] [Quantum Geometric Origin of Nonlinear Current Induced Orbital Magnetization](https://arxiv.org/abs/2608.28231)
*Xue-Jin Zhang, Yue-Xin Huang, Wei Du, Xiaolong Feng, Shen Lai, Cong Xiao, Qian Niu, Shengyuan A. Yang*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28231)

**TL;DR**: The paper derives a microscopic theory of nonlinear current-induced orbital magnetization by obtaining the field-corrected orbital magnetic moment of Bloch electrons and shows the effect has a quantum-geometric origin (anomalous orbital polarizability and Berry-connection polarizability). First-principles calculations predict experimentally accessible nonlinear orbital magnetization in strained bilayer graphene and monolayer 1T' MoS2 and MoTe2, which can exceed spin contributions in materials with topological band features.  
**Method**: Microscopic derivation of the field-corrected orbital magnetic moment for Bloch electrons; decomposition of nonlinear orbital magnetization into anomalous orbital polarizability and Berry-connection polarizability contributions; combined with first-principles (ab initio) calculations for material predictions.  
**Tags**: `nonlinear response, orbital magnetism, quantum geometry, topological materials, first-principles calculations`
...
### [13] [Rapid Charge Stability Diagram Generation from Device-level Modeling of Semiconductor Quantum Dots](https://arxiv.org/abs/2608.28263)
*Ron Nodel, David W. Kanaar, Connor Nasseraddin, Tim J. Wilson, Hong-Wen Jiang, Jason R. Petta, Chris Anderson, Mark F. Gyure*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28263)

**TL;DR**: They use a Multi-Domain Multi-Model workflow combining self-consistent Schrödinger–Poisson simulations and an automated tuning routine to select a small set of gate-voltage points, augment those with Full Configuration Interaction energies to extract charging energies, lever arms and interdot Coulomb terms, then fit a Hubbard model to rapidly generate charge-stability diagrams. Demonstrated on an Intel Tunnel Falls Si/SiGe device with qualitative agreement to experiment and applied to lever-arm engineering across architectures, achieving large computational savings versus full voltage sweeps.  
**Method**: Self-consistent Schrödinger–Poisson MDMM simulations with an automated tuning routine to identify gate voltages for target charge configurations; supplement selected self-consistent solutions with Full Configuration Interaction calculations to compute many-body energetics (charging energies, lever arms, interdot Coulomb interactions); parameterize a Hubbard model from these extracted parameters and use it to produce charge-stability diagrams efficiently. Validation against experiment and application to lever-arm engineering on a second device.  
**Tags**: `quantum dot devices, Hubbard modeling, quantum device simulation, charge stability diagrams, digital twin models`
...
### [14] [Evidence for Three-component Interlayer Coherent Exciton Condensation](https://arxiv.org/abs/2608.28338)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28338)

**TL;DR**: Evidence for a three-component interlayer exciton condensate in a triple-layer graphene device: layer-resolved optical measurements using Rydberg excitons in an adjacent WSe2 monolayer detect interaction-induced incompressibility at zeroth-Landau-level crossings for all three pairwise layer combinations, and continuous tuning of displacement field and interlayer bias shows a smoothly connected state where all three layers coherently participate.  
**Method**: Layer-resolved optical spectroscopy using Rydberg excitons in an adjacent WSe2 monolayer as a layer-sensitive probe of Landau-level crossings and incompressibility in a triple-layer graphene device, combined with electrostatic control (displacement field and interlayer bias) to tune pairwise and threefold Landau-level degeneracies.  
**Tags**: `exciton condensation, quantum Hall, multilayer graphene, quantum materials, synthetic dimensions`
...
### [15] [Crystal-phase quantum dots in AlGaAs nanowires](https://arxiv.org/abs/2608.28353)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28353)

**TL;DR**: First report of crystal-phase quantum dots (CPQDs) realized in AlGaAs nanowires showing bright single-photon emission with narrow linewidths down to 61 μeV, low background, and a short (∼1 ns) exciton lifetime consistent with type-I band alignment; exciton fine-structure and Zeeman splitting are also observed.  
**Method**: Fabrication of CPQDs within AlGaAs nanowires followed by optical characterization: steady-state and time-resolved spectroscopy to extract emission linewidths and lifetimes, and magneto-optical measurements to resolve fine-structure and Zeeman splitting.  
**Tags**: `quantum materials, quantum dots, single-photon sources, nanowires, photonics`
...
### [16] [Electrically Tunable Two-Component Exciton Condensate in a Coulomb-Coupled Graphene Trilayer](https://arxiv.org/abs/2608.28381)
*Bo Zou, A. Okounkova, Shuaiqing Zhang, Jian Liao, J. Pack, K. Watanabe, T. Taniguchi, Yihang Zeng*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28381)

**TL;DR**: Graphene trilayer devices with negligible interlayer tunnelling and continuous layer-resolved gating realize a two-component exciton condensate: quantum-capacitance measurements show charge-incompressible quantum Hall states at total filling ν=1 and 2 persist across arbitrary layer-filling configurations, while static and time-dependent Hartree–Fock calculations predict two phase-stiffness eigenmodes and two linearly dispersing Goldstone modes when all three layers are partially filled (reducing to one when a layer is empty). The condensate-mode composition is electrically tunable as charge is moved between layers.  
**Method**: Experiment: layer-resolved electrostatic gating of a graphene trilayer with negligible interlayer tunnelling and quantum-capacitance (charge-compressibility) measurements. Theory: static Hartree–Fock and time-dependent Hartree–Fock calculations of phase stiffness and collective (Goldstone) modes.  
**Tags**: `exciton condensation, multicomponent condensates, quantum Hall physics, graphene multilayers, collective modes`
...
### [17] [Quantum transport and unified scaling law in graphene with polyadic Cantor electrostatic barriers](https://arxiv.org/abs/2608.28398)
*Sudhanshu Shekhar, Mohammad Umar, Bhabani Prasad Mandal*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28398)

**TL;DR**: Analytic study of Dirac-electron transport in graphene through a polyadic Cantor electrostatic potential: using superperiodic-potential formalism the authors obtain a closed-form transmission, show a crossover from sparse superlattice resonances to a near-transparent regime controlled by Cantor stage and polyadic order, identify distinct angular responses for n–n–n, n–p–n and Dirac-point doping, and derive double-logarithmic scaling laws (in Cantor stage, potential height, initiator length, and incidence angle) that combine into a unified scaling law tied to the potential’s hierarchical self-similarity.  
**Method**: Analytic calculation using the superperiodic (superlattice) potential formalism applied to a polyadic Cantor electrostatic potential for graphene Dirac electrons; closed-form transmission probability derived and asymptotic scaling relations extracted (double-logarithmic scaling and unified scaling law).  
**Tags**: `quantum transport, graphene, fractal potentials, scaling laws, superlattice physics`
...
### [18] [ScatterWorks: A Python package for building and solving scattering network models](https://arxiv.org/abs/2608.28479)
*R. Johanna Zijderveld, Hélène Spring, Anton R. Akhmerov*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28479)

**TL;DR**: Open-source Python package (ScatterWorks) for building and solving non-interacting network models: composable network construction, assembly of local scattering matrices into global scattering equations, and sparse/Schur solvers for evaluating quasienergies and transport observables; demonstrated on a symbolic Fabry–Pérot interferometer and the Chalker–Coddington model reproducing quantum-Hall critical transport.  
**Method**: Software framework using a compact, label-aware network representation with composable transformations (tile, cut, relink, union) to construct periodic and finite networks; assignment of local scattering matrices, assembly into global scattering equations, and numerical solution of transport (quasienergies and scattering observables) including support for sparse matrices and Schur-based solvers.  
**Tags**: `network models, quantum transport, disordered systems, topological phases, quantum Hall physics`
...
### [19] [Super-resolution Control of Two-dimensional Quantum Emitters](https://arxiv.org/abs/2608.28574)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.28574)

**TL;DR**: Platform combining cryogenic optical spectroscopy and AFM-based scanning probe to localize and control localized interlayer exciton emitters in WSe2/MoSe2 heterobilayers. AFM-induced local Stark shifts enable super-resolution (<100 nm) spatial localization and deterministic control of charge states (including trions); time-resolved measurements show tip-induced modification of the electromagnetic vacuum controlling radiative emission. The approach is positioned for multi-point charge sensing of correlated/topological phases such as fractional Chern insulators.  
**Method**: Cryogenic confocal/optical spectroscopy integrated with AFM-based scanning probe microscopy that uses a tip-induced local Stark shift for super-resolution localization and electrical tuning of interlayer exciton emitters, combined with time-resolved optical measurements to probe tip-mediated changes in radiative rates.  
**Tags**: `Quantum materials, Scanning probe microscopy, Quantum optics, Charge sensing, Fractional Chern insulators`
