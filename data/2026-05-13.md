...
**Abstract**: [arXiv](https://arxiv.org/abs/2605.11066)

**TL;DR**: Spatially nonuniform strain can systematically tune and interconvert low-energy states in superconducting hybrid systems: weak strain reshapes band parameters and wavefunction weight to convert trivial and disorder-induced partially separated Andreev bound states (psABSs) into well-separated topological Majorana bound states (MBSs) in 1D semiconductor nanowires and graphene nanoribbons, and stabilizes boundary modes. The authors also present an analytic position-dependent topological-mass/domain-wall picture giving a real-space criterion for Majorana emergence and stability.  
**Method**: Tight-binding Bogoliubov–de Gennes simulations of 1D semiconductor nanowires and graphene nanoribbons including superconductivity, Rashba spin–orbit coupling, Zeeman fields and disorder, complemented by an analytical framework based on a position-dependent topological mass and strain-driven domain-wall motion.  
**Tags**: `topology, superconducting_impurity, quantum_devices, disorder, Majorana, strain_engineering, graphene, nanowire, Bogoliubov-de_Gennes, domain_wall`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.11113)

**TL;DR**: Finite photon momentum in centrosymmetric PdTe dynamically breaks effective inversion symmetry and enables second-order (helicity-dependent) photocurrents otherwise forbidden in the bulk; polarization- and angle-resolved photocurrent measurements identify CPGE, geometric shift currents and photon-drag processes, and thickness scaling of the helicity-dependent component demonstrates a bulk quantum-geometric response set by photon momentum rather than only surface states.  
**Method**: Polarization-sensitive nonlinear photocurrent measurements on PdTe with controlled angle of incidence and film-thickness dependence; separation of signal components (CPGE, geometric shift current, photon-drag) via polarization and incidence-angle dependence, and identification of bulk vs surface origin through thickness scaling and helicity sign reversal.  
**Tags**: `quantum_geometry, topology, nonlinear_optics, photon_drag, circular_photogalvanic_effect, shift_current, topological_semimetal, surface_states`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.11164)

**TL;DR**: Design principle for realizing quadrupole (second-order) topological insulators in two-dimensional graphitic lattices by engineering positions and connections of zigzag edges; four topological classes are identified, with topologically protected massless corner states at domain intersections and additional massive localized states (nonzero angular momentum) emerging when domain-wall smoothness is tuned.  
**Method**: Topological classification and boundary/domain-wall engineering of 2D graphitic structures via controlled arrangement of zigzag edges; analysis of interfaces between four identified topological classes to predict protected corner (massless) states and, upon varying domain-wall smoothness, additional massive localized bound states with nonzero angular momentum.  
**Tags**: `topology,second-order_topological_insulator,quadrupole_insulator,graphitic_structures,corner_states,domain_walls,zigzag_edges,localized_states,quantum_geometry`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.11069)

**TL;DR**: In weakly hybridized small-angle twisted bilayer graphene, shifting the two low-energy Dirac cones (valley imbalance) provides a direct control parameter for the electronic viscosity. Increasing the valley splitting drives the system through valley depletion, a charge-neutrality crossover, and the onset of electron–hole scattering, producing a pronounced nonmonotonic viscosity vs splitting. By contrast, monolayer graphene’s kinematic viscosity falls monotonically with temperature because of the strong T-dependence of its inertial mass density. The work highlights valley control as a knob for tuning hydrodynamic transport and clarifies how band structure, scattering phase space, and screening set viscous response.  
**Method**: Theoretical transport analysis of viscous response in two-dimensional electron systems: study of shear and kinematic viscosity as functions of valley splitting and temperature for weakly hybridized twisted bilayer graphene, with explicit accounting of valley population imbalance, the onset of electron–hole scattering, and screening; comparative calculations for monolayer graphene and a 2DEG to separate band-structure and inertial-mass effects.  
**Tags**: `valley_imbalance,Dirac_fluid,twisted_bilayer_graphene,viscosity,hydrodynamic_transport,electron-hole_scattering,screening,monolayer_graphene,2DEG`
...
### [5] [Euler Topology in Superconducting Honeycomb Lattices](https://arxiv.org/abs/2605.11587)
*Rasoul Ghadimi, Chiranjit Mondal, Bohm-Jung Yang*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.11587)

**TL;DR**: IST-symmetric superconducting honeycomb lattices host nontrivial Euler band topology: s-wave spin-singlet pairing realizes a valley-Euler superconductor while f-wave spin-triplet pairing yields an Euler superconductor. Both phases produce mirror-symmetry-protected helical domain-wall modes; additionally, anisotropic hopping in the f-wave triplet state causes non-Abelian braiding of Dirac nodes in momentum space. The work positions superconducting instabilities as a route to Euler topology in Dirac materials.  
**Method**: Symmetry- and band-topology analysis of IST-symmetric superconducting honeycomb-lattice models with classification of s-wave spin-singlet and f-wave spin-triplet pairing channels; identification of Euler/valley-Euler invariants, demonstration of mirror-symmetry-protected helical domain-wall modes, and study of momentum-space Dirac-node braiding induced by anisotropic hopping.  
**Tags**: `topology, quantum_geometry, superconductivity, Euler_topology, valley_Euler, mirror_symmetry, non-Abelian_braiding, Dirac_materials, honeycomb_lattice, spin_singlet, spin_triplet`
...
### [6] [Geometry-enabled magnetic resilience in superconducting nanowire single-photon detectors](https://arxiv.org/abs/2605.10968)
...
**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.10968)

**TL;DR**: Experimental study of NbTiN superconducting nanowire single-photon detectors (SNSPDs) in magnetic fields shows that applied fields increase intrinsic detection efficiency (IDE) at lower bias currents but suppress IDE at higher currents, shrinking or removing saturation plateaus; the degradation depends strongly on nanowire width and can be mitigated by width optimization to preserve saturated IDE across photon energies under application-relevant fields.  
**Method**: Systematic experimental characterization of NbTiN SNSPDs under applied magnetic fields, measuring IDE versus bias current and photon energy for devices with varying nanowire widths and identifying width-optimized designs that retain saturation in realistic magnetic environments.  
**Tags**: `quantum_devices, superconductivity, SNSPD, superconducting_nanowire, magnetic_field_effects, detector_optimization, nanowire_width`
...
### [7] [First-principles real-space embedding theory of the superconducting proximity effect](https://arxiv.org/abs/2605.11211)
*Nicolas Baù, Mitra Dowlatabadi, Tommaso Chiarotti, Massimo Capone, Antimo Marrazzo*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.11211)

**TL;DR**: Introduces a scalable first-principles Green’s-function framework based on real-space dynamical embedding to simulate superconducting proximity at realistic interfaces; it yields diagrammatic normal and anomalous embedding self-energies, computes local spectra and proximity lengths over hundreds of nanometers, and is demonstrated on topological tight-binding models (Qi–Hughes–Zhang, Fu–Kane–Mele) and DFT+Wannier NbSe2/CrBr3 heterostructures.  
**Method**: Real-space Green’s-function dynamical embedding with a diagrammatic decomposition into normal and anomalous embedding self-energies, combined with recursive solvers; implemented for tight-binding models and first-principles DFT-derived Wannier Hamiltonians to compute local spectral functions and long-range proximity lengths without thick slabs.  
**Tags**: `topology, superconducting_proximity, Green's_function, dynamical_embedding, first_principles_DFT, Wannier_functions, mixed_parity_superconductivity, NbSe2, mesoscopic`
...
### [8] [The Meissner effect does not require radial charge flow](https://arxiv.org/abs/2605.10945)
*A. V. Nikulov*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.10945)

**TL;DR**: The paper argues that the Meissner persistent surface current is an experimentally established consequence of Cooper-pair angular-momentum quantization and therefore does not require a radial charge flow driven by the Lorentz force as proposed in Hirsch’s hole-superconductivity theory.  
**Method**: Conceptual/theoretical critique and interpretation of established experimental facts: compares the conventional quantization-based explanation with the alternative Lorentz-force radial-flow mechanism and argues the latter cannot account for the observed persistent currents.  
**Tags**: `superconductivity, Meissner_effect, Cooper_pairs, persistent_current, angular_momentum_quantization, hole_superconductivity, Lorentz_force`
