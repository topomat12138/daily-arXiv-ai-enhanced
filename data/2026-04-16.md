...
### [1] [Optimal Majoranas in Mesoscopic Kitaev Chains](https://arxiv.org/abs/2604.13945)
*M. Alvarado, R. Seoane Souto, María José Calderón, Ramón Aguado*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13945)

**TL;DR**: A full microscopic analysis of the superconducting hybrid segment coupling quantum dots shows that the quasiparticle continuum and spin-split Andreev bound states qualitatively modify the minimal Kitaev-chain picture: analytical renormalized couplings and sweet-spot conditions are derived, and ABS parity crossings mark optimal windows where Majorana zero modes are simultaneously strongly localized and protected by a large excitation gap.  
**Method**: Microscopic modeling of the hybrid superconducting segment including the quasiparticle continuum and spin-split Andreev bound states; analytical derivation of renormalized effective couplings and conditions for sweet spots, with identification of parameter regimes where ABS parity crossings produce an odd-parity spin-polarized regime favorable for optimized MZMs.  
**Tags**: `topology, superconducting_impurity, Majorana_zero_modes, Andreev_bound_states, parity_crossing, quantum_dots, quantum_devices, quantum_computing`
...
### [2] [Giant Room-Temperature Third-Order Electrical Transport in a Thin-Film Altermagnet Candidate](https://arxiv.org/abs/2604.13893)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13893)

**TL;DR**: Altermagnets can host both T-odd and T-even components of the quantum geometric tensor despite zero net magnetization; the authors observe giant room-temperature third-order nonlinear electrical responses — notably a third-order Hall effect — in (101)-oriented 8‑nm RuO2 thin films and correlate this response with altermagnetic order, proposing the third-order Hall signal as a probe of the Néel vector and supporting altermagnetism in thin-film RuO2.  
**Method**: Combined theoretical identification of T-odd and T-even quantum geometric contributions in altermagnets with experimental nonlinear transport measurements: room-temperature third-order electrical (including third-order Hall) response measurements on (101)-oriented 8-nm RuO2 thin films, correlated with altermagnetic order.  
**Tags**: `quantum_geometry, altermagnetic, quantum_devices, nonlinear_transport, third-order_Hall, RuO2, Neel_vector_detection`
...
### [3] [Automatic Charge State Tuning of 300 mm FDSOI Quantum Dots Using Neural Network Segmentation of Charge Stability Diagram](https://arxiv.org/abs/2604.13662)
*Peter Samaha, Amine Torki, Ysaline Renaud, Sam Fiette, Emmanuel Chanrion, Pierre-Andre Mortemousque, Yann Beilliard*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13662)

**TL;DR**: Deep-learning semantic-segmentation pipeline (U-Net with MobileNetV2 encoder) trained on 1,015 manually annotated experimental silicon charge-stability diagrams automatically locates transition lines and returns gate-voltage targets for the single-charge regime; achieves 80% overall tuning success (peak >88%) and supports scalable feature extraction and roadmap for real-time cryogenic wafer-prober integration.  
**Method**: U-Net–style convolutional neural network with MobileNetV2 encoder trained and validated by five-fold group cross-validation on a heterogeneous dataset of 1,015 experimental charge stability diagrams spanning nine device geometries and multiple fabrication runs; outputs segmentation masks of transition lines to infer gate-voltage targets for single-charge tuning; includes failure-mode analysis and proposals for mitigations and integration into wafer-probing workflows.  
**Tags**: `machine_learning, quantum_devices, quantum_computing, quantum_dot, charge_tuning, silicon_qubits, semantic_segmentation`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13266)

**TL;DR**: Develops a theoretical framework showing that zero net magnetization in spin-orbit-free compensated magnets enforces band nodes formed by formally spin-degenerate bands via geometric constraints, explaining unconventional degeneracies in compensated ferrimagnets without conventional spin-symmetry protection.  
**Method**: Analytical theoretical framework and constraint analysis of band structure in the weak-interaction regime, attributing spin degeneracies to geometric constraints imposed by vanishing net magnetization rather than group-theoretical spin symmetries.  
**Tags**: `quantum_geometry,altermagnetic,compensated_ferrimagnet,spin-orbit-free,band-degeneracy,weak-interaction,magnetic_symmetry`
...
### [5] [Cryogenic Loss Limits in Microwave Epitaxial AlN Acoustic Resonators](https://arxiv.org/abs/2604.13364)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13364)

**TL;DR**: Fabricated a 16 GHz epitaxial AlN FBAR, measured loaded Q from 6.5 K to 300 K (Qmax ≈1589 at 6.5 K to 363 at 294 K), and developed a physics-based loss model (including an analytical anchor‑radiation term) that reproduces the observed monotonic Q(T) decrease and predicts fundamental Q limits; validated the framework against published 23 GHz HBAR data to provide a transferable tool for designing cryogenic microwave filters for superconducting quantum hardware.  
**Method**: Experimental fabrication and small‑signal RF characterization of a 16 GHz epitaxial AlN FBAR over 6.5–300 K combined with a physics‑based analytical loss model that incorporates intrinsic/extrinsic mechanisms and an analytical anchor‑radiation loss term; model benchmarking against previously reported 23 GHz HBAR data.  
**Tags**: `quantum_devices, quantum_computing, acoustic_resonator, FBAR, HBAR, AlN, cryogenics, anchor_radiation_loss, temperature-dependent_dissipation`
...
### [6] [Emergent topological phase from a one-dimensional network of defects](https://arxiv.org/abs/2604.13532)
*Rahul Singh, Ritajit Kundu, Arijit Kundu, Adhip Agarwala*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13532)

**TL;DR**: A periodic array of tunable defects embedded in a metallic host generates emergent symmetry-protected topological phases (the “Su–Schrieffer–Heeger network”) from scattering states. A scattering-matrix network captures nontrivial quasienergy winding and transport signatures; periodic driving realizes a robust Thouless charge pump. A microscopic lattice with a defect superlattice yields Bloch minibands that map to the network; the effects are stable to disorder and accessible in solid-state platforms.  
**Method**: Construct a scattering-matrix network model of periodically modulated defect strengths (SSH-like network) and analyze its quasienergy band winding, transport signatures, and Floquet pumping; corroborate with a microscopic lattice model containing a defect superlattice that produces Bloch minibands mapping to the network; test robustness to disorder and discuss experimental realizations.  
**Tags**: `topology,scattering_network,defect_superlattice,Floquet,Thouless_charge_pump,transport_signatures,disorder_robustness,quantum_devices`
...
### [7] [Nonlinear Circular Dichroism Reveals the Local Berry Curvature](https://arxiv.org/abs/2604.13729)
*Nele Tornow, Paul Herrmann, Clemens Schneider, Ferdinand Evers, Jan Wilhelm, Giancarlo Soavi*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13729)

**TL;DR**: They prove that angular-momentum transfer between light and a crystal in harmonic generation is proportional to the local electronic Berry curvature at an optical resonance, encode this in the nonlinear harmonic circular dichroism, and demonstrate it experimentally in an atomically thin semiconductor—enabling all‑optical readout and control of local Berry curvature.  
**Method**: Analytical derivation connecting angular momentum conservation in nonlinear harmonic generation to the electronic quantum geometry (local Berry curvature) together with experimental measurement of nonlinear harmonic circular dichroism in an atomically thin semiconductor.  
**Tags**: `quantum_geometry,nonlinear_optics,Berry_curvature,circular_dichroism,harmonic_generation,atomically_thin_semiconductor,topology`
...
### [8] [Spin Qubit Leapfrogging: Dynamics of shuttling electrons on top of another](https://arxiv.org/abs/2604.13760)
*Nicklas Meineke, Guido Burkard*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13760)

**TL;DR**: Proposes exploiting the valley degree of freedom in silicon to let a mobile spin qubit ‘leapfrog’ an occupied stationary quantum dot in regions of low valley splitting, enabling additional routing choices and implementation of an entangling SWAP^γ two‑qubit gate; numerical simulations across parameter sets indicate feasibility.  
**Method**: Theoretical proposal complemented by numerical simulations of the shuttling process through an occupied dot using valley states; parameter sweeps demonstrate gate operation (SWAP^γ) feasibility in regimes of low valley splitting.  
**Tags**: `quantum_computing, quantum_devices, silicon_spin_qubits, spin_shuttling, valley_degree_of_freedom, valleytronics, entangling_gate, SWAP_gamma, numerical_simulation, quantum_transport`
...
### [9] [Topological markers for a one-dimensional fermionic chain coupled to a single-mode cavity](https://arxiv.org/abs/2604.13936)
*Anna Ritz-Zwilling, Olesia Dmytruk*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13936)

**TL;DR**: Off-resonant coupling of a Su–Schrieffer–Heeger (SSH) chain to a single photonic mode is integrated out via a high-frequency expansion to produce an effective interacting fermionic Hamiltonian. Topological properties of finite chains are diagnosed using edge two-point correlation functions (open BC) and two bulk markers for interacting systems — a winding number from the single-particle Green’s function and Resta’s many-body electric polarization (periodic BC). The three diagnostics agree, edge states are confirmed, and the work offers an effective-electron perspective on cavity-modified topology complementary to full light–matter treatments.  
**Method**: Perform high-frequency expansion in the off-resonant regime to derive an effective cavity-mediated interacting fermionic Hamiltonian; characterize topology in finite-size systems using (i) edge two-point correlation functions, (ii) Green’s-function-based winding number, and (iii) Resta’s many-body polarization to map the phase diagram and confirm edge states.  
**Tags**: `topology, cavity_QED, interacting_topology, Su-Schrieffer-Heeger (SSH), high-frequency_expansion, Green_function_winding, Resta_polarization, cavity-mediated_interactions, quantum_devices`
...
### [10] [Thermodynamic signatures of non-Hermiticity in Dirac materials via quantum capacitance](https://arxiv.org/abs/2604.14150)
*Juan Pablo Esparza, Francisco J. Peña, Patricio Vargas, Vladimir Juričić*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.14150)

**TL;DR**: Equilibrium signatures of weak non-Hermiticity in Dirac materials are identified: a non‑reciprocal hopping imbalance β renormalizes the Dirac velocity v_F=v√(1−β^2), producing a universal divergence of the low‑energy density of states, thermodynamic DOS and quantum capacitance ∝(1−β^2)^{-1} as |β|→1^−; concomitantly Landau‑level spacing collapses in a magnetic field and the biorthogonal Petermann factor K=(1−β^2)^{-1} isolates eigenvector non‑orthogonality. Quantum capacitance is proposed as an accessible bulk equilibrium probe of effective non‑Hermiticity.  
**Method**: Analytical study of a minimal non‑reciprocal graphene model (hopping imbalance parameter β) in the weakly non‑Hermitian regime: derive renormalized Fermi velocity and low‑energy DOS, compute thermodynamic density of states and quantum capacitance scaling, analyze Landau‑level spectrum in magnetic field, and evaluate biorthogonal Bloch states to obtain the Petermann factor.  
**Tags**: `quantum_geometry, quantum_devices, non-Hermitian, Dirac_materials, quantum_capacitance, Landau_levels, Petermann_factor`
...
### [11] [Spin-Dependent Charge-State Conversion in NV Ensembles Mediated by Electron Tunneling](https://arxiv.org/abs/2604.13337)
*Neil B. Manson, Morgan Hedges, Michael S. J. Barson, Carlos A. Meriles, Ronald Ulbricht, Marcus W. Doherty*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13337)

**TL;DR**: Exciting NV centers at 575 nm (the NV0 ZPL) in nitrogen-containing diamond produces NV0 mainly via spin-selective tunneling from NV- excited states to nearby nitrogen donors, so NV0 fluorescence inherits NV- spin polarization and contributes to spin contrast; this allows use of the full fluorescence signal and could improve NV-based sensing sensitivity.  
**Method**: Comparative optical excitation and fluorescence measurements on ensembles of NV centers with varying nitrogen concentrations, contrasting excitation at 575 nm (NV0 ZPL) versus 532 nm to identify charge-state generation pathways and their spin dependence (spin-selective tunneling to nitrogen donors).  
**Tags**: `quantum_devices, NV_centers, charge_dynamics, spin_tunneling, optical_readout, quantum_sensing`
...
### [12] [Emergence of Nontrivial Topological Magnon States in Skyrmionium Lattices with Zero Topological Charge](https://arxiv.org/abs/2604.13451)
*Xingen Zheng, Ping Tang, Xuejuan Liu, Zhixiong Li, Peng Yan, Hao Wu*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13451)

**TL;DR**: Prediction that a skyrmionium lattice (zero net topological charge) hosts nontrivial topological magnon bands, explained via a new ‘‘weighted magnetic flux’’ concept and an explicit mapping onto the Haldane model; two protocols for preparing the lattice are proposed and the magnon thermal Hall conductivity is computed for experimental detection.  
**Method**: Analytical and model-based theoretical approach: introduce the weighted magnetic flux to quantify magnon band topology, construct a magnon Hamiltonian for the skyrmionium lattice and map it onto the Haldane model, then compute magnon thermal Hall conductivity; propose two experimental preparation methods.  
**Tags**: `topology, topological_magnons, skyrmionium, Haldane_model, weighted_magnetic_flux, magnon_thermal_Hall, spin_textures, topological_spintronics`
...
### [13] [Coherent control of thermal transport with pillar-based phononic crystals](https://arxiv.org/abs/2604.13527)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13527)

**TL;DR**: Aluminum-pillar phononic crystals on an uncut SiN membrane achieve up to ~10× reduction of sub-Kelvin thermal conductance by coherently modifying phonon dispersion; for lattice constants >1 μm measured conductance departs from coherent-theory predictions, attributed to loss of coherence from diffusive scattering on rough Al pillar surfaces.  
**Method**: Fabrication of 2D phononic crystals formed by periodic Al pillars on suspended SiN membranes; combined experimental measurements of thermal conductance at sub-Kelvin temperatures for lattice constants 0.3–5 μm and numerical simulations based on coherent phonon-dispersion theory; interpretation of discrepancies at large lattice constants as coherence breakdown from surface-roughness-induced diffusive scattering.  
**Tags**: `phononic_crystals, thermal_conductance, phonon_coherence, surface_roughness, suspended_membrane, nanoscale_heat_transport, quantum_devices`
...
### [14] [Charge waves and dynamical signatures of topological phases in Su-Schrieffer-Heeger chains](https://arxiv.org/abs/2604.13682)
*Tomasz Kwapinski, Marcin Kurzyna, Luis E. F. Foa Torres*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13682)

**TL;DR**: The authors show that 1D SSH chains can host propagating charge waves and long-period sublattice oscillations even with chiral symmetry and a spectral gap. They derive a general condition for arbitrary oscillation periods, find that bulk charge-wave propagation is topology-independent while edge dynamics differ between trivial and nontrivial phases, and demonstrate that post-quench time evolution of local density of states and site occupancies yields dynamical fingerprints that distinguish topological phases by detecting topologically protected edge states in real time.  
**Method**: Analytical study of charge-wave conditions in the Su–Schrieffer–Heeger tight-binding model combined with nonequilibrium time-dependent analysis (quantum quench) of local density of states and site occupancies to identify dynamical signatures of topology.  
**Tags**: `topology, SSH_model, quench_dynamics, edge_states, local_density_of_states, sublattice_oscillations, nonequilibrium`
...
### [15] [Sub-nm range momentum-dependent exciton transfer from a 2D semiconductor to graphene](https://arxiv.org/abs/2604.13445)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13445)

**TL;DR**: Time-resolved PL (1 ps resolution) on MoSe2 monolayers coupled to few‑layer graphene finds a ≈2.5 ps exciton transfer at cryogenic temperature that is insensitive to graphene thickness but is suppressed by a ≥1 nm hBN spacer; results implicate charge tunnelling as the dominant transfer channel while Förster (dipolar) transfer has negligible effect on bright (k≈0) excitons but may affect hot exciton relaxation and PL quenching.  
**Method**: Ultrafast time‑resolved photoluminescence spectroscopy (1 ps resolution) of MoSe2 monolayers interfaced with a staircase-like few‑layer graphene flake, including control samples with variable‑thickness hBN spacers; analysis of PL decay times and spacer dependence to distinguish charge tunnelling versus Förster energy transfer mechanisms.  
**Tags**: `van_der_Waals, transition_metal_dichalcogenides, graphene, exciton_transfer, charge_tunnelling, Förster_energy_transfer, photoluminescence_quenching, time_resolved_PL, optoelectronics`
...
### [16] [Exciton screening in C$_{60}$ and PTCDA complexes. TDDFT calculations with GGA and hybrid functionals](https://arxiv.org/abs/2604.13661)
*N. L. Matsko, Mahmoud A. Salem*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13661)

**TL;DR**: Linear-response TDDFT calculations for C60 and PTCDA complexes find that including nonlocal exchange via hybrid functionals (B3LYP, HSE) improves exciton energies for short-range excitons but degrades accuracy for long-range charge-transfer excitons; when the exciton radius approaches the material screening length, the semi-local PBE outperforms the hybrids.  
**Method**: Linear-response time-dependent density functional theory (TDDFT) benchmarking of exchange–correlation functionals (PBE, B3LYP, HSE) for photoabsorption in C60 and PTCDA molecular complexes, analyzing exciton energies as a function of electron–hole separation with emphasis on charge-transfer excitons and screening-length effects.  
**Tags**: `TDDFT, charge-transfer_exciton, hybrid_functionals, screening_length, photoabsorption, molecular_complexes`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13920)

**TL;DR**: Introduces a multi‑tone spectroscopy protocol that uses dual‑tone excitation near chosen resonances plus probing tones at higher modes to produce sideband spectral signatures; an inverse reconstruction in the frequency domain converts those signatures into quantitative nonlinear intermodal coupling coefficients. Demonstrated by extracting ten pairwise nonlinear coupling parameters across five modes of highly tensioned nanostrings and building device‑specific reduced‑order models that agree with finite‑element nonlinear ROMs. Method is generic for mechanical and hybrid resonators.  
**Method**: Dual‑tone excitation near selected resonances combined with additional higher‑order probe tones to generate mode‑specific sidebands, followed by a frequency‑domain inverse reconstruction procedure to extract nonlinear coupling coefficients; experimental implementation on tensioned nanostrings and validation against finite‑element nonlinear reduced‑order models.  
**Tags**: `nonlinear_modal_coupling,multi-tone_spectroscopy,sideband_analysis,inverse_reconstruction,nanomechanical_resonators,reduced-order_models,finite_element_validation`
...
### [18] [Strong Correlation Drives Zero-Field Josephson Diode Effect](https://arxiv.org/abs/2604.14045)
*Yiheng Sun, Zhenyu Zhang, James Jun He*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.14045)

**TL;DR**: Strong electron–electron repulsion in a Josephson junction with an odd electron occupancy can spontaneously break time-reversal and mirror symmetries, producing a -junction with degenerate  B1 minima and a zero-field Josephson diode effect (JDE) without magnetic order. Spin-orbit coupling breaks SU(2) but does not fix diode polarity; a tiny Zeeman field enables controllable, sizable JDE whose strength is maximized at a field-driven level-crossing.  
**Method**: Theoretical modeling of an interacting Josephson junction: introduce a Hubbard U term for an odd-electron island and compute energy–phase relations and current–phase characteristics including spin-orbit coupling and small Zeeman fields to identify spontaneous symmetry breaking, -junction formation, and enhanced diode efficiency at level crossings.  
**Tags**: `superconducting_impurity, pi_junction, quantum_devices, Hubbard_model, spin-orbit_coupling, time-reversal-symmetry-breaking, Josephson_diode`
...
### [19] [Crystal structure effects on vortex dynamics in superconducting MgB$_2$ thin films](https://arxiv.org/abs/2604.14022)
...
**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.14022)

**TL;DR**: I–V measurements and TDGL simulations on MgB2 films show that current-driven resistive transitions at T≈0.25Tc proceed via formation and growth of normal domains (not flux‑flow instability). Film microstructure—columnar texture vs buffer-layer roughness—controls vortex pinning, activation energies, breakdown current and the prominence of multi-step I–V features; the single‑crystal with rough buffer exhibits stronger pinning, higher critical currents, and lower thermal boundary resistance.  
**Method**: Experimental low‑temperature current–voltage characterization of textured and single‑crystal MgB2 films combined with time‑dependent Ginzburg–Landau simulations to model vortex dynamics and reproduce multi‑step I–V behavior.  
**Tags**: `vortex, quantum_devices, pinning, time-dependent_Ginzburg-Landau, normal_domains, MgB2`
...
### [20] [Controlling the Band Filling and the Band Width in Nickelate Superconductors](https://arxiv.org/abs/2604.13875)
*M. Kriener, C. Terakura, A. Kikkawa, Z. Liu, H. Murayama, M. Nakajima, Y. Fujishiro, S. Sasano, R. Ishikawa, N. Shibata, Y. Tokura, Y. Taguchi*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.13875)

**TL;DR**: Study of bilayer nickelates (La3Ni2O7 family) using controlled high-pressure synthesis and hydrostatic high-pressure transport reveals that increasing NiO6 octahedral tilting moves the superconducting dome to higher pressure while concurrent hole doping reverses this trend; up to three distinct anomalies appear in the nonsuperconducting state, plausibly density-wave related, and sample-quality issues (impurity phases, oxygen vacancies) remain important.  
**Method**: Systematic experimental tuning of bandwidth and carrier filling via high-pressure synthesis and hydrostatic high-pressure transport measurements on bilayer nickelates, combined with controlled structural (NiO6 tilting) and chemical (hole doping) variation.  
**Tags**: `superconductivity, superconducting_impurity, density_wave, nickelates, high_pressure_synthesis, transport, hole_doping, antiferromagnetism, octahedral_tilting`
