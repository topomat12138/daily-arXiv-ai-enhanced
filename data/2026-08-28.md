...
**TL;DR**: The authors construct an interacting model on a twisted bilayer checkerboard lattice with topological flat bands and rigorously demonstrate an exact pair-density-wave (PDW) ground state driven by quantum geometric nesting (QGN) enabled by a momentum-space nonsymmorphic symmetry. They also prove a universal formula for the superfluid stiffness of any nondegenerate QGN superconductor: D_s = 2 N_flat ν(1−ν) m_pair^{-1}.  
**Method**: Analytic construction and rigorous proof: design of an interacting microscopic model on a twisted bilayer checkerboard lattice (TBCB) with topological flat bands, identification of quantum geometric nesting due to momentum-space nonsymmorphic symmetry, and derivation of an exact PDW ground state and a universal relation for superfluid stiffness.  
**Tags**: `unconventional superconductivity, topological superconductivity, quantum geometry, pair-density wave, flat-band superconductivity`
...
### [2] [Stabilization of Interband Phase Solitons in Two-Band Noncentrosymmetric Superconducting Rings](https://arxiv.org/abs/2608.26782)
*Yuriy Yerin, Boris Malomed, Stefan-Ludwig Drechsler, F. Sebastian Bergeret*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.26782)

**TL;DR**: Breaking inversion symmetry in two-band superconducting rings can make interband phase solitons (relative-phase windings) into true ground states. A magneto-electric coupling, absent in centrosymmetric systems and odd in winding number, biases chirality and, above a threshold, overcomes screening-current energy costs so that field-selected soliton branches replace metastable ones; this produces field-odd soliton branches observable in equilibrium current–flux measurements, analogous to Little–Parks fluxoid branches but in the interband phase sector.  
**Method**: Analytical and/or phenomenological free-energy analysis of two-component superconducting rings with broken inversion symmetry, identifying a magneto-electric coupling term odd in winding number and computing energy balance between screening currents and interband phase winding to determine ground-state transitions and current–flux signatures.  
**Tags**: `two-band superconductivity, magneto-electric effects, soliton physics, fluxoid physics, vortex/flux quantization`
...
### [3] [Supercurrent detection and manipulation of topological phase transitions in Shiba-Majorana hybrid systems](https://arxiv.org/abs/2608.26265)
*Debika Debnath, Ioannis Ioannidis, Paramita Dutta, Mircea Trif, Thore Posske*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.26265)

**TL;DR**: Proposes a non-invasive scheme to read out and control the fermion parity of Majorana states in magnetic-adatom / superconductor hybrids by passing supercurrent through their low-energy modes; predicts characteristic discontinuities in the critical Josephson current at zero-energy level crossings and demonstrates the effect for a setup where a single control magnetic adatom (hosting a Yu–Shiba–Rusinov state) mediates Majorana coupling, with robustness checked against finite temperature and different tunneling regimes.  
**Method**: Theoretical proposal and modeling of Josephson transport through low-energy Shiba–Majorana modes: analyze how zero-energy level crossings alter the critical supercurrent (producing discontinuities) and apply the analysis to a concrete geometry where Majorana coupling is mediated by a single magnetic adatom hosting a YSR state; test effects of finite temperature and varying tunneling regimes to assess robustness.  
**Tags**: `Majorana physics, Topological superconductivity, Impurity physics, Josephson physics, Quantum materials`
...
### [4] [Strain-driven orbital-selective reconstruction and bicollinear-to-stripe evolution in FeTe](https://arxiv.org/abs/2608.26652)
...
**TL;DR**: DFT+DMFT combined with Heisenberg-model analysis shows that tensile strain in FeTe drives an orbital‑selective reconstruction of its correlated electronic structure and a magnetic trajectory from bicollinear AFM → intermediate staggered n‑mer AFM → stripe AFM. Moderate strain produces coexisting more coherent quasiparticles and suppressed local moments; stronger strain yields an incoherent correlated state with robust local moments and Fe‑3d_{z^2} dominated low‑energy states.  
**Method**: First‑principles electronic structure with density functional theory plus dynamical mean‑field theory (DFT+DMFT), supplemented by mapping to a Heisenberg model to analyze magnetic phase competition under strain.  
...
**TL;DR**: EPR measurements of microwave power absorption in powdered Fe–Se–H (hydrogenated FeSe) show field-dependent signals at 3.6–25 K and at 295 K that the authors interpret as evidence of superconductivity at ambient pressure, including a claim of superconductivity at room temperature. The parent FeSe crystal had Tc = 8 K prior to hydrogen diffusion.  
**Method**: Electron paramagnetic resonance (EPR) spectroscopy measuring microwave power absorption as a function of applied magnetic field (up to 6000 Oe) on powdered Fe–Se–H samples, at temperatures 3.6–25 K and 295 K; analysis of the shape of field-dependent absorption traces used to infer superconductivity.  
**Tags**: `unconventional superconductivity, quantum materials, impurity physics, hydrogen-doped superconductors, high-temperature superconductivity`
...
**TL;DR**: Magic-angle helical trilayer graphene (HTG) exhibits a field-induced global Chern gap at charge neutrality with Chern number C = -6 and Hall resistance quantized to ≈ -h/6e^2 at 4.6 K, despite an underlying mosaic of domains with opposite valley-resolved Chern numbers. A moderate magnetic field drives a valley-selective topological transition that aligns occupied-state Chern numbers across neighboring domains and gaps the domain-wall modes, producing the observed quantized transport.  
**Method**: Combined experimental low-temperature magnetotransport (Hall resistance) measurements on magic-angle helical trilayer graphene and theoretical modeling using Hofstadter-butterfly band-structure calculations together with orbital Zeeman effect analysis to demonstrate a valley-selective topological transition.  
**Tags**: `quantum materials, moiré heterostructures, Chern insulators, valleytronics, magnetic-field-induced topology`
...
**TL;DR**: In a centrosymmetric altermagnet, a symmetry-allowed locally staggered Dzyaloshinskii–Moriya coupling imprints a gauge‑irremovable vortex–antivortex pair into anomalous magnon pair correlations (the squeezed magnon vacuum) at high‑symmetry momenta. In real space this manifests as an antiferrochiral array of equilibrium spin currents circulating oppositely on neighboring plaquettes—i.e., gauge‑invariant loop currents and frustration encoded entirely in quantum correlations despite classical collinearity.  
**Method**: Theoretical symmetry and many‑body analysis of magnon pair correlations in a centrosymmetric altermagnet with a locally staggered Dzyaloshinskii–Moriya coupling; identification of vortex–antivortex textures in momentum‑space anomalous correlators and mapping to real‑space equilibrium spin currents in the squeezed magnon vacuum.  
**Tags**: `altermagnetism, quantum magnetism, vortex physics, quantum correlations, spin‑current phenomena`
...
**TL;DR**: Gate-defined antidot spectroscopy in bilayer graphene reveals localized quasiparticle charge e/4 at even-denominator FQH states ν = −5/2, −1/2, 3/2 (and e/3 at ν = 2/3). Increasing coupling between antidot-bound and edge states produces a crossover in gate-voltage periodicity (minimal period → ≈2× period), attributed either to quasiparticle bunching or distinct antidot transport regimes. Results support compatibility of bilayer-graphene even-denominator states with a non‑Abelian ground state and demonstrate localized quasiparticles around an antidot—a prerequisite for topological qubit schemes.  
**Method**: Device-scale gate-defined antidot in bilayer graphene with an independent antidot-control gate; detection of trapped quasiparticle charge via periodic gate-voltage signatures as coupling to extended edge states is tuned (antidot–edge coupling control).  
**Tags**: `fractional quantum Hall, non-Abelian anyons, antidot physics, quasiparticle charge measurement, quantum materials, topological quantum computation`
...
### [9] [How quantum is quantum geometry?](https://arxiv.org/abs/2608.26269)
*Ady Stern, Felix von Oppen*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.26269)

**TL;DR**: A purely classical model—a point particle carrying a classical magnetic moment ℓ that precesses in a momentum-dependent field B(p)—reproduces signatures of the quantum geometric tensor: the ℓ-component along B yields Berry-curvature phenomena, and the transverse precessing component yields quantum-metric phenomena. The model predicts a position spread whose second moment equals the metric, an orbital magnetic moment, and an emergent inertial mass (hence a nonzero Drude weight) even for an otherwise dispersionless system.  
**Method**: Hamiltonian classical-mechanics analysis of a point particle with a classical magnetic moment in a momentum-dependent magnetic field B(p); decomposition of ℓ into longitudinal (along B) and transverse (precessing) components and calculation of resulting position moments, orbital moment, inertial mass and transport (Drude) response.  
**Tags**: `quantum geometry, Berry curvature, quantum metric, classical analogues, electronic transport`
...
### [10] [Topologically protected perfect crossed Andreev reflection in flux-engineered quantum wire junctions](https://arxiv.org/abs/2608.26702)
*Abhiram Soori*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.26702)

**TL;DR**: Proposes a flux-tunable four-terminal normal–superconductor device that achieves deterministic, 100% crossed Andreev reflection (Cooper-pair splitting) at half a flux quantum (φ=π). ET and AR are cancelled by Aharonov–Bohm and Peierls interference while electron reflection is nulled by tuning the central hopping; a Cauchy-argument-principle-based topological winding number guarantees unit CAR, with a positive cross-correlation shot-noise signature and robustness against disorder across much of the superconducting gap.  
**Method**: Analytical and theoretical transport analysis of a flux-threaded four-terminal NS junction using interference arguments (Aharonov–Bohm and Peierls phases), tuning of central junction hopping, and a topological proof based on the Cauchy argument principle; shot-noise (cross-correlation) calculations to identify experimental signatures and disorder robustness checks.  
**Tags**: `Cooper-pair splitting, crossed Andreev reflection, quantum transport, topological protection, shot-noise measurements`
...
### [11] [Majorana signatures in an asymmetrically coupled quantum dot--topological superconducting nanowire junction](https://arxiv.org/abs/2608.26341)
*Levente Máthé, Ioan Grosu, Liviu P. Zârbo, Ionel Ţifrea*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.26341)

**TL;DR**: The paper analyzes linear conductance through a nanoscale device consisting of an asymmetric quantum dot coupled to normal leads and two Majorana bound states at the ends of a topological superconducting nanowire pierced by a tunable magnetic flux. It shows that lead–QD coupling asymmetry (α) and bias asymmetry (q) strongly modify conductance signatures: for unhybridized MBSs at zero temperature conductance is nonzero only at flux phase φ=(2n+1)π with G=2qαe^2/[h(α+1)], while at finite T the conductance oscillates with period 2π and maxima shift with q. For hybridized MBSs the dependence is more complex: when ε_d=ε_F behavior resembles the unhybridized case, but for ε_d≠ε_F the oscillation period becomes 4π and peak positions depend on ε_d and other parameters. The study highlights that realistic asymmetries can mask or shift expected MBS transport signatures.  
**Method**: Theoretical quantum-transport analysis of linear conductance as a function of system parameters (lead–QD coupling asymmetry α, bias asymmetry q, magnetic flux phase φ, QD level ε_d, and MBS hybridization), evaluated in zero-temperature and finite-temperature limits.  
**Tags**: `topological superconductivity, Majorana physics, quantum transport, quantum dots, mesoscopic transport, finite-temperature effects`
...
### [12] [Occupation-Driven Josephson Diode in a Symmetric Junction](https://arxiv.org/abs/2608.27213)
*Jianxiong Zhai, Zelei Zhang, Jiawei Yan*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.27213)

**TL;DR**: Proposal of a Josephson-diode mechanism driven by nonequilibrium occupation engineered via attached reservoirs in a double-quantum-dot junction: a phase-textured nonlocal reservoir uses a quantum-Zeno-like dissipation to freeze a 'bright' Andreev channel while preserving a 'dark' channel, producing nonreciprocal steady-state supercurrent even when the intrinsic Andreev spectrum is reciprocal. Coulomb repulsion can enhance diode behavior via a dark-pair resonance; results are supported by Keldysh–Lindblad calculations including finite-gap and dissipation effects.  
**Method**: Theoretical modeling of a double-quantum-dot Josephson junction with reservoir engineering; analytic infinite-gap limit yielding I_ss = I_A P_γ factorization; open-system nonequilibrium calculations using a Keldysh–Lindblad formalism to capture dissipation, the quantum-Zeno selection, and finite-gap effects.  
**Tags**: `Josephson physics, Nonequilibrium superconductivity, Reservoir engineering, Open quantum systems, Quantum transport`
...
### [13] [Magnetic Communication with an Acoustically Actuated Magnetoelectric Resonator and a Quantum Diamond Magnetometer](https://arxiv.org/abs/2608.26396)
...
**TL;DR**: Demonstrates a hybrid magnetic wireless link using an acoustically actuated magnetoelectric resonator transmitter and a nitrogen-vacancy (NV) diamond quantum magnetometer receiver, achieving amplitude- and phase-encoded AC magnetic communication at 20 kHz with measured sensitivities (50 pT/√Hz amplitude, 1.2 mrad/√Hz phase).  
**Method**: Combine a compact, high-radiation-efficiency acoustically actuated magnetoelectric resonator as the transmitter with a micrometer-scale NV-center diamond quantum magnetometer as the receiver; implement amplitude and phase encoding of a 20 kHz AC magnetic signal and characterize receiver sensitivity.  
**Tags**: `magnetic communication, quantum sensing, magnetoelectric devices, spin defects in diamond, wireless communication`
...
### [14] [Scalable, Simple, and Versatile Encapsulation of 2D Materials and Devices](https://arxiv.org/abs/2608.27383)
...
**TL;DR**: Electron-beam evaporated aluminum oxide (AlO_x) is demonstrated as a scalable, direct- fabrication-compatible encapsulation that suppresses oxidation and preserves intrinsic optical and electronic properties of air-sensitive 2D and quasi-2D quantum materials (RTe_3, WTe_2, FeTe_xSe_{1-x}), working across a range of flake thicknesses and enabling contacts without post-encapsulation etching.  
**Method**: Direct e-beam evaporation of AlO_x as an encapsulation layer applied to flakes on substrate, with substrate-dependent optimization of layer thickness and demonstration of device compatibility (contacting and wafer-scale coverage) without transfer or etching steps.  
**Tags**: `quantum materials, 2D materials, encapsulation, device fabrication, superconductivity, plasmonics`
...
### [15] [Statistical Disorder in MBE-Grown AlGaAs/GaAs Superlattices for Quantum Bragg Mirrors using Synchrotron X-ray Diffraction](https://arxiv.org/abs/2608.26406)
*Mateus T. Souza, Germano M. Penello, Guilherme A. Calligaris, Sergio L. Morelhao*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.26406)

**TL;DR**: Non-destructive, high-precision quantification of nanoscale thickness disorder in a 203-layer AlGaAs/GaAs Quantum Bragg Mirror grown by MBE: 25 keV synchrotron XRD combined with recursive dynamical diffraction and ensemble simulated annealing yields layer-by-layer thickness profiles with ~0.2–0.6 nm precision, revealing systematic AlGaAs barrier thinning (0.3–0.6 nm) and large thickness deficits in the top contact (−35 nm) and first GaAs layer (−40 nm).  
**Method**: High-energy (25 keV) synchrotron X-ray diffraction measured diffraction from the 203-layer superlattice; data were analyzed using a recursive dynamical diffraction formalism coupled to an ensemble simulated annealing refinement to extract statistically robust, layer-by-layer thickness profiles non-destructively.  
**Tags**: `quantum materials, molecular beam epitaxy, thin-film growth, materials characterization, superlattices`
...
### [16] [Optical spectroscopy of composite fermion edge states in the fractional quantum Hall effect](https://arxiv.org/abs/2608.26521)
*Maria Sebastian, Ashutosh Singh, Alexey Belyanin*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.26521)

**TL;DR**: Sub‑terahertz (millimeter-wave) optical spectroscopy can selectively probe edge states in fractional quantum Hall samples. Using the composite‑fermion mean‑field mapping for the Jain sequence, the calculated absorbance shows edge CF peaks (e.g. 60–500 GHz at B=10 T in GaAs) whose number counts filled Λ‑levels; inversion‑symmetry breaking at the edge activates optically forbidden transitions and enables second‑order nonlinear responses. The overall frequency scale is set by the interaction‑generated composite‑fermion effective mass, so the spectrum directly probes that mass.  
**Method**: Composite‑fermion mean‑field mapping of the fractional quantum Hall problem onto an effective integer quantum Hall problem; calculation of absorbance spectra for the Jain sequence including both bulk and edge contributions, with attention to symmetry breaking near edges and electric‑dipole processes (including second‑order nonlinearities).  
**Tags**: `fractional quantum Hall effect, edge physics, composite fermions, sub‑terahertz optical spectroscopy, electron–electron interactions`
...
### [17] [Observation of dodecagonal replica bands in 30$^{\circ}$-twisted bilayer WSe$_2$](https://arxiv.org/abs/2608.26864)
...
**TL;DR**: Micro‑ARPES directly reveals dodecagonal replica bands in 30° twisted bilayer WSe2; their symmetry and intensity are explained by interlayer Umklapp scattering, and the spectral function shows a van Hove singularity near the K valleys implying possible electronic reconstruction at large twist angles.  
**Method**: Micrometer-resolved angle-resolved photoemission spectroscopy (micro-ARPES) measurements of the spectral function combined with analysis of symmetry and intensity distributions to identify interlayer Umklapp scattering as the origin of observed replica bands.  
**Tags**: `quantum materials, quasicrystals, moiré physics, 2D materials, interlayer scattering`
...
**TL;DR**: Double‑ionic gated bilayer graphene exhibits a giant, switchable room‑temperature nonlinear Hall effect (NLHE) via strong inversion‑symmetry breaking, with χ^{(2)}_{yxx} ≈ 3×10^{-3} μm·S/V and THz voltage responsivity ≈4×10^4 V/W — values comparable to low‑T WTe2 and to commercial Schottky diodes, making junction‑free nonlinear devices feasible.  
**Method**: Fabrication and electrical/transport measurement of double‑ionic gated bilayer graphene devices to induce strong, tunable inversion‑symmetry breaking and characterize the second‑order nonlinear Hall response and THz voltage responsivity at room temperature.  
**Tags**: `nonlinear transport, 2D materials, graphene devices, quantum materials, inversion symmetry breaking`
...
**TL;DR**: Anisotropic core–shell nanoparticles host an exceptional point (EP) and a non‑Hermitian phase transition without gain, loss, or non‑reciprocity: mapping the radial electrostatic problem (in a logarithmic radial coordinate) onto a Cauchy–Euler equation yields an equivalence to a damped oscillator and a two‑site Hatano–Nelson Hamiltonian. The single control parameter is dielectric anisotropy ε_t/ε_r; above a hyperbolicity threshold the shell’s field changes from monotonic decay to spatial oscillation, creating intermediate‑radius hotspots with applications in fluorescence, strong coupling, sensing, and cloaking.  
**Method**: Analytical mapping of the radial electrostatic problem in an anisotropic core–shell nanoparticle using a logarithmic radial coordinate to transform the Cauchy–Euler equation into a damped oscillator and an equivalent two‑site Hatano–Nelson non‑Hermitian Hamiltonian, identifying an EP and hyperbolicity‑driven phase transition.  
**Tags**: `non-Hermitian physics, hyperbolic media, metamaterials, nanophotonics, quantum materials`
...
**TL;DR**: Theory of hydrodynamic magnetotransport for 2D viscous electron fluids in long, ultra-clean samples with arbitrary edge roughness parameterized by a single speed-like boundary parameter. Calculated flow profiles and longitudinal/Hall resistances show that the Hall contribution from relaxation saturates at high magnetic field and can develop a field-dependent minimum for sufficiently rough edges; the minimum is suppressed by smoother edges, larger sample width, or increased bulk defect scattering. These features provide experimental diagnostics of hydrodynamic transport and edge roughness.  
**Method**: Analytical/numerical solution of a hydrodynamic transport model for 2D electron fluids in long samples with boundary conditions that encode edge roughness through a single parameter (dimension of speed); computation of steady-state viscous flow profiles and resulting longitudinal and Hall resistances as functions of magnetic field, edge roughness, sample width, and bulk scattering.  
**Tags**: `hydrodynamic transport, viscous electron fluids, magnetotransport, Hall effect, edge scattering`
...
**TL;DR**: Discrete screw symmetry in long, chiral molecules can strongly enhance spin preservation well beyond the naive dwell-time vs. spin-mixing timescale ħ/Δ by producing strong spin separation in quasi-momentum. This provides a symmetry-protected mechanism consistent with CISS; tight-binding models and transport simulations show the effect weakens when screw symmetry is broken and predict a clear magnetoresistance signature in a spin-valve geometry with magnetic leads.  
**Method**: Analytical derivation of symmetry-protected spin fidelity combined with numerical tight-binding calculations and quantum transport simulations (spin-valve setup) to test robustness under symmetry breaking and to extract an experimentally accessible magnetoresistance signature.  
**Tags**: `spintronics, chirality-induced spin selectivity (CISS), symmetry-protected transport, quantum materials, magnetoresistance`
...
### [22] [Magnon-induced phononic Chern insulator](https://arxiv.org/abs/2608.27011)
*Rui-Chang Shen, Yihao Yang, Haoran Xue*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2608.27011)

**TL;DR**: Proposal for a magnon-induced phononic Chern insulator: a honeycomb phononic crystal with ferromagnetic islands hosts a circularly polarized Kittel magnon that hybridizes with phonons, breaking time-reversal symmetry and opening full Chern gaps at GHz frequencies. In the large-detuning limit the system maps to a Haldane-type phonon model with magnon-induced complex hopping, enabling tunable Chern phases |C|=1 and |C|=2 with gaps larger than realistic linewidths.  
**Method**: Theoretical proposal and model-building: construct a hybrid system of a honeycomb phononic crystal with ferromagnetic islands at hexagon centers; derive magnon–phonon coupling (circularly polarized Kittel mode with phase winding) that breaks TRS; analyze large-detuning limit to obtain an effective Haldane-type phononic Hamiltonian with complex hopping; compute phase diagram showing tunable Chern numbers and estimate gap magnitudes relative to phonon/magnon linewidths.  
**Tags**: `topological phononics, magnonics, topological phases, quantum materials`
...
**TL;DR**: Bulk photovoltaic (BPV) response is localized to the overlap of a cross‑bar MoS2/Ta2NiSe5 van der Waals heterostructure where vertical stacking breaks MoS2 inversion symmetry. Orthogonal device geometry separates intralayer vs interfacial photocurrent channels; spontaneous interfacial charge transfer creates strong interlayer coupling, and gate/vertical field tuning yields an optimized zero‑bias photocurrent density of 247 A/cm2 and a BPV coefficient of 0.99 V−1. Theoretical modelling supports the interpretation and points to a minimalist geometry for tractable interface‑driven BPV studies.  
**Method**: Fabrication and measurement of an orthogonal (cross‑bar) MoS2/Ta2NiSe5 van der Waals heterostructure to spatially isolate overlap-region photoresponse; electrical gating and vertical electric‑field control to tune interlayer potential; spatially resolved photocurrent measurements to separate intralayer and interfacial mechanisms; theoretical modelling to interpret the BPV origin.  
...
**TL;DR**: Terahertz spectroscopy plus a semianalytical effective-model analysis shows that the giant low-frequency magneto‑optical response of Co3Sn2S2 is accounted for by intrinsic gyrotropy originating from momentum‑space separation of time‑reversal‑symmetry‑broken Weyl nodes; quantitative experiment–theory comparison constrains material parameters.  
**Method**: Terahertz (low‑frequency) magneto‑optical spectroscopy combined with semianalytical calculations based on a physically motivated effective Weyl‑node model to compute intrinsic gyrotropic optical response.  
**Tags**: `topological semimetals, anomalous Hall effect, magneto‑optics/gyrotropy, terahertz spectroscopy, quantum materials`
...
**TL;DR**: Adding a thin, electrically passive buried Si layer inside the lower SiGe barrier during RP-CVD growth on 200 mm Si(100) substrates reduces oxygen incorporation in the overgrown SiGe by ≈5× and increases electron mobility in Si/SiGe quantum wells, while leaving percolation density and low-density disorder scaling largely unchanged; the approach is process-compatible for quantum-device materials.  
**Method**: Materials-design and experimental characterization: insertion of a thin buried Si layer during reduced-pressure chemical vapor deposition (RP-CVD) growth of Si/SiGe quantum-well heterostructures on 200 mm Si(100) wafers, quantified by secondary-ion mass spectrometry (SIMS), and assessed via density- and temperature-dependent magnetotransport measurements down to 0.3 K.  
**Tags**: `quantum materials, impurity physics, semiconductor heterostructures, quantum device materials, transport measurements`
...
**TL;DR**: A geometric formalism is developed that ties local Fermi-surface and band tangent-space geometry (notably hyperbolic constant-energy regions) to intrinsic spin-current responses; under time-reversal symmetry the spin operator algebra maps to the exterior algebra of the band tangent space, and spin-separated transport is formulated via symplectic (2D) and contact (3D) geometry.  
**Method**: Construct a momentum-space geometric description: analyze local constant-energy surface curvature (hyperbolic regions) and derive a geometric contribution to Fermi velocity that couples to spin; relate spin operator algebra to the exterior algebra of the band's tangent space assuming time-reversal symmetry; formulate spin transport on Fermi surfaces using symplectic geometry for quasi-2D systems and extend to 3D via contact geometry.  
**Tags**: `quantum geometry, spin transport, Fermi-surface geometry, symplectic geometry, contact geometry`
...
**TL;DR**: Quantum-capacitance measurements in a quantum-dot interferometer can distinguish true Majorana zero modes (MZMs) in a topological superconducting (TS) wire from Majorana-like signatures produced by a gapless (Δ=0) normal wire. In the TS case the even/odd parity low-energy levels are nearly degenerate and produce a single, robust resonance region that persists under independent changes of quantum-dot potential and wire chemical potential; in the gapless case the parity signals arise from separate resonances that split under parameter variation. Parameter-space stability of the resonance (not a single tuned flux trace) is the experimental discriminator.  
**Method**: Theoretical/phenomenological analysis of quantum-capacitance resonances measured via a quantum-dot interferometer, comparing flux-dependent Aharonov–Bohm interference and parity-resolved energy spectra for (i) a topological superconducting wire hosting MZMs and (ii) a gapless normal wire segment; study of resonance positions, parity-branch degeneracy, and their dependence on quantum-dot potential and wire chemical potential.  
**Tags**: `Majorana physics, Topological superconductivity, Aharonov–Bohm interference, Quantum capacitance, Quantum-dot interferometry`
