...
**Abstract**: [arXiv](https://arxiv.org/abs/2609.12057)

**TL;DR**: STM/STS imaging of rhombohedral hexalayer graphene reveals emergent electron crystals: a low-density honeycomb lattice that transitions first-order to an oblique lattice with increasing hole doping. Quasiparticle-interference and transport indicate these are metallic electron crystals (partial carrier crystallization) rather than nesting-driven charge density waves. Magnetic field stabilizes domains and induces a √2×√2 reconstruction in the oblique phase with a linear sublattice energy splitting corresponding to g≈16, consistent with orbital-antiferromagnetic order; the honeycomb phase overlaps the region of previously observed multiferroic orbital magnetism and may be a metallic anomalous Hall crystal.  
**Method**: High-resolution scanning tunneling microscopy and spectroscopy (STM/STS) with quasiparticle-interference (QPI) analysis, combined with comparison to concurrent metallic transport data and magnetic-field tuning.  
**Tags**: `quantum materials, topological phases, electron crystallization, orbital magnetism, scanning probe microscopy`
...
### [2] [In-plane anomalous and third-harmonic Hall response in an easy-plane trigonal magnet](https://arxiv.org/abs/2609.12738)
*Arnab Das, Soumik Mukhopadhyay*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2609.12738)

**TL;DR**: Tuning magnetic anisotropy in an easy‑plane trigonal magnet produces a finite in‑plane anomalous Hall signal and a pronounced third‑harmonic (sin(3θ)) Hall response with cubic field scaling, consistent with an intrinsic, symmetry‑governed third‑order transverse conductivity emerging as the magnetization becomes coherently in‑plane.  
**Method**: Angle‑dependent Hall measurements with harmonic decomposition (first and third harmonics) under varied magnetic fields and controlled reduction of magnetic anisotropy; analysis of angular (sinθ vs sin3θ) content and field‑scaling (cubic) of the transverse response.  
**Tags**: `anomalous Hall effect, nonlinear Hall effect, magnetic anisotropy, symmetry‑controlled transport, quantum materials`
