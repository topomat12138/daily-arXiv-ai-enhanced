...
### [1] [Nodal Topological Superconductivity Driven by Crystalline Antiunitary Symmetry in Altermagnets](https://arxiv.org/abs/2605.13656)
*Xiao Xiao, Arun Bansil*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13656)

**TL;DR**: Fourfold collinear altermagnets with crystalline antiunitary symmetry T C4z generically forbid pure singlet pairing and force pairing channels that produce Bogoliubov–de Gennes Hamiltonians with emergent chiral symmetries. This yields robust nodal topological superconducting phases — a nodal-point phase with Majorana flat bands and two distinct nodal-loop phases with chiral Majorana edge states — whose nodal structure persists even if the antiunitary symmetry is spontaneously broken; tunneling spectroscopy signatures are proposed to distinguish these phases.  
**Method**: Theoretical symmetry analysis of pairing in fourfold rotational collinear altermagnets: impose the crystalline antiunitary symmetry T C4z to constrain allowed pairing channels, construct BdG Hamiltonians, identify emergent chiral symmetries and classify resulting nodal topological phases (nodal points with Majorana flat bands and two nodal-loop phases with chiral Majorana edges); study robustness under spontaneous breaking of the antiunitary symmetry and propose tunneling signatures for experimental detection.  
**Tags**: `topology, altermagnetic, nodal_superconductivity, chiral_symmetry, Majorana, BdG, quantum_computing, tunneling_spectroscopy`
...
**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.12758)

**TL;DR**: Single magnetic impurities (Yu–Shiba–Rusinov states) probe the pairing structure of Ising superconductors in 2D TMDs: including Ising spin–orbit coupling and an in‑plane magnetic field produces distinctive bound‑state spectra and tunneling signatures that differ from conventional superconductors and can reveal unconventional aspects of the condensate.  
**Method**: Theoretical analysis of Yu–Shiba–Rusinov bound states in a model of two‑dimensional Ising superconductivity, incorporating Ising spin–orbit coupling and an in‑plane magnetic field to compute bound‑state spectra and tunneling responses.  
**Tags**: `superconductivity,Ising_superconductivity,superconducting_impurity,Yu-Shiba-Rusinov,spin-orbit_coupling,in-plane_magnetic_field,tunneling_spectroscopy,2D_TMD`
...
**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13317)

**TL;DR**: The paper predicts that altermagnet/Ising-superconductor junctions with a spin-active interface produce strongly anisotropic, tunable spin-polarized and nonreciprocal charge and spin transport. Interplay of intrinsic spin–orbit coupling, the altermagnet’s anisotropic spin texture and spin-dependent interfacial scattering yields helicity-conserving transport in the weak spin-mixing regime, spin-selective Andreev reflection and up to ≈86% spin-filtering with strong angular dependence, while strong spin mixing suppresses conventional Andreev reflection and generates robust, broadband spin-polarized and nonreciprocal conductance.  
**Method**: Modified Bogoliubov–de Gennes framework combined with scattering formalism for an AM/Ising-superconductor junction with a spin-active interface; parameter sweeps of intrinsic SOC, interfacial spin-mixing, orientation between AM spin texture and interface magnetization; calculation of charge/spin conductance and Andreev reflection spectra across single/intermediate/double-band ISC regimes.  
**Tags**: `altermagnetic,Ising_superconductor,spin-filtering,spin-orbit_coupling,nonreciprocal_transport,Bogoliubov-de_Gennes,scattering_formalism,Andreev_reflection`
...
**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13259)

**TL;DR**: Extension of the exactly solvable Hatsugai–Kohmoto model to a two-orbital (D4h) multiband setting; the authors classify all symmetry-allowed superconducting gap structures including spin, orbital and momentum degrees of freedom and compute critical temperatures and order parameters for representative pairing channels as functions of interaction and pairing strength within a mean-field treatment.  
**Method**: Analytic symmetry classification of gap representations for a two-orbital D4h Hatsugai–Kohmoto model combined with mean-field calculations of Tc and the superconducting order parameter for selected pairing channels; uses the momentum-local (exactly solvable) HK interaction as the microscopic basis and varies interaction/pairing strengths to map phase behavior.  
**Tags**: `multiband_superconductivity,Hatsugai-Kohmoto_model,orbital_superconductivity,symmetry_classification,mean-field_theory,D4h`
...
**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13573)

**TL;DR**: High-field NMR on overdoped La2-xSrxCuO4 (x=0.25) finds the low-energy dynamical spin susceptibility χ''(q,ω) increases continuously down to the lowest measured temperatures—behavior consistent with quantum-critical spin fluctuations—despite being beyond the spin-stripe critical doping x=0.19. The spin dynamics are spatially inhomogeneous, implying nanoscale electronic heterogeneity may underlie the coexistence of persistent spin fluctuations and strange-metal transport in the overdoped regime.  
**Method**: Suppress superconductivity with high magnetic fields and apply an NMR protocol tailored to electronic inhomogeneity to probe the low-energy limit of the dynamical spin susceptibility χ''(q,ω) at x=0.25 in La2-xSrxCuO4.  
**Tags**: `superconductivity, spin_fluctuations, quantum_criticality, strange_metal, cuprates, NMR, electronic_inhomogeneity, spin_stripes`
...
### [6] [Coupled Topological Interface States and Phonon Molecules in GaAs/AlAs Superlattices](https://arxiv.org/abs/2605.12635)
*S. Sandeep, O. Colmegna, C. Xiang, E. R. Cardozo de Oliveira, K. Papatryfonos, M. Morassi, A. Lemaitre, N. D. Lanzillotti-Kimura*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.12635)

**TL;DR**: Demonstration of engineered topological phonon ‘‘molecules’’ and chains in GaAs/AlAs DBR superlattices: coupled SSH-type interface states hybridize into tunable symmetric/antisymmetric modes and narrow minibands (up to N=6) with splittings up to tens of GHz, observed by pump–probe and modeled with transfer matrices and an analytic splitting model.  
**Method**: Design and MBE growth of GaAs/AlAs DBR superlattices implementing SSH-style band inversion (opposite Zak phases); experimental characterization via time-domain pump–probe transient reflectivity; theoretical reproduction using transfer-matrix calculations and a simple analytical model for mode hybridization/splitting.  
**Tags**: `topology, quantum_geometry, quantum_devices, nanophononics, SSH_model, GaAs/AlAs_DBRs, pump-probe`
...
### [7] [Coherent control of spinmons](https://arxiv.org/abs/2605.12588)
*Johanne Bratland Tjernshaugen, Florinda Viñas Boström, Jeroen Danon, Jacob Linder, Karsten Flensberg, Antonio L. R. Manesco*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.12588)

**TL;DR**: Proposal of a 'spinmon' qubit: a transmon mode entangled with the spin of a trapped Andreev quasiparticle, with Kramers degeneracy lifted by a Zeeman field. Qubit control is provided by electrostatic gates or an AC flux drive; coherence times and robustness to flux and charge noise are computed.  
**Method**: Theoretical device proposal and analysis: introduce Zeeman splitting of Andreev-bound-state spin, formulate two control schemes (electrostatic gating and AC flux driving) for full qubit manipulation, and calculate coherence times and sensitivity to flux and charge noise.  
**Tags**: `spinmon, transmon, Andreev quasiparticle, Zeeman field, superconducting qubit, decoherence, flux noise, charge noise, quantum_computing, quantum_devices`
...
### [8] [Using a spin-triplet encoding to enhance shuttling fidelities in Si/SiGe quantum wells](https://arxiv.org/abs/2605.12687)
*Merritt P. R. Losert, S. N. Coppersmith, Mark Friesen*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.12687)

**TL;DR**: Proposes a two-electron valley-singlet qubit encoding for Si/SiGe conveyor-mode spin shuttling that is intrinsically robust against Landau–Zener-like valley-splitting variations; unlike single-electron encodings, shuttling fidelity improves at small valley splittings and high fidelities are attainable without special path tuning.  
**Method**: Theoretical proposal and analysis: introduce an unconventional two-electron (valley-singlet) encoding and analyze its response to spatially varying valley splittings during conveyor-mode shuttling, demonstrating suppression of Landau–Zener leakage and improved fidelity behavior for small valley splittings.  
**Tags**: `quantum_devices, quantum_computing, spin_qubits, valley_physics, Landau-Zener, spin_shuttling`
...
### [9] [Quantized Transport in Floquet Topological Insulators](https://arxiv.org/abs/2605.13066)
*Rekha Kumari, Manas Kulkarni, Abhishek Dhar*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13066)

**TL;DR**: Floquet topological systems coupled to static reservoirs exhibit quantized longitudinal conductance |W_ε| e^2/h and Hall conductance W_ε e^2/h (for quasienergy gaps at ε=0 or ε=Ω/2), but quantization appears only after summing over all Floquet sidebands (Floquet sum rule). Exact numerics (strip geometry) using Floquet NEGF and an analytic weak-coupling calculation show sideband contributions, including edge-mode velocity signs, sum to give exact quantization; convergence is fast enough for experimental observation.  
**Method**: Floquet nonequilibrium Green’s-function (NEGF) formalism with exact numerical simulations for a strip geometry, supplemented by an analytic weak-coupling analysis of sideband contributions to the Hall conductance.  
**Tags**: `topology,Floquet,NEGF,quantum_transport,edge_states,winding_invariant,Floquet_sum_rule,quantum_devices,Hall_conductance`
...
### [10] [Observation of end-to-end pumping in a quasiperiodic Fibonacci-type photonic chain](https://arxiv.org/abs/2605.13116)
*Arnob Kumar Ghosh, Ang Chen, Ashraf El Hassan, Patric Holmvall, Mohamed Bourennane, Annica M. Black-Schaffer*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13116)

**TL;DR**: Fibonacci-type quasiperiodic photonic chains support an end-to-end topological pumping mode that can be activated by a small structural change and used for robust state transfer; this is demonstrated numerically with a tight-binding model and experimentally in coupled optical waveguides, with resilience to controlled defects.  
**Method**: Tight-binding numerical simulations of a finite quasiperiodic (Fibonacci) chain to identify localized pumping states, followed by experimental realization in an array of coupled optical waveguides (paraxial approximation) where single-waveguide injection launches pumping and light is transferred end-to-end; robustness tested via structural deformations/defects.  
**Tags**: `topology, topological_pump, photonic, quasiperiodic, Fibonacci, tight_binding, waveguide_array, state_transfer, disorder_resilience, quantum_devices`
...
### [11] [Reconfigurable chiral superconductivity](https://arxiv.org/abs/2605.13303)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13303)

**TL;DR**: Nanoscale SQUID-on-tip imaging and thermodynamic measurements in rhombohedral pentalayer graphene directly detect time-reversal-symmetry breaking and establish chiral superconductivity emerging from an isospin-polarized quarter metal; chiral domain proliferation coincides with superconductivity onset, transport is governed by resistive domain walls, and domains can be reversibly switched with ultra-low currents.  
**Method**: Nanoscale SQUID-on-tip magnetometry to image isospin-polarized domains combined with spatially resolved thermodynamic detection of TRS breaking, complementary transport measurements identifying domain-wall–controlled regimes, and deterministic low-current electrical control of chiral domains.  
**Tags**: `topology, superconductivity, chiral_superconductivity, isospin_textures, domain_walls, rhombohedral_graphene, quantum_devices`
...
### [12] [Direct-write electrochemical nanofabrication of ultrasmall graphene devices](https://arxiv.org/abs/2605.12660)
*Xiao Liu, Colm Durkan*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.12660)

**TL;DR**: Direct-write, electrode-free fabrication of sub-10 nm graphene nanoribbon (GNR) field-effect transistors using electrochemical atomic-force-microscopy (AFM) lithography with an alternating-current (AC) bias; authors present the underlying electrochemical mechanism and a quantitative model, claiming higher resolution, lower defect density, contamination-free processing and in situ device modification/characterisation versus PL/EBL.  
**Method**: Electrochemical AFM lithography with an AC bias (direct-write, electrode-free nanoscale patterning using AFM tip positioning); development and presentation of a model describing the electrochemical etching/process; demonstration of sub-10 nm GNR FET fabrication and in situ modification/characterisation.  
**Tags**: `graphene_nanoribbons, AFM_lithography, electrochemical_lithography, sub-10nm, field-effect_transistor, nanoelectronics, quantum_devices`
...
### [13] [Negative Differential Resistance and Ultra-High TMR in Altermagnetic Tunnel Junctions](https://arxiv.org/abs/2605.12711)
*Sajjan Sheoran, Luke Keenan, Declan Nell, Stefano Sanvito*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.12711)

**TL;DR**: DFT+NEGF calculations predict large low-bias negative differential resistance (NDR) and a bias-driven sign inversion of tunneling magnetoresistance (TMR) in an altermagnetic tunnel junction using orbital-ordered KV2Se2O; the parallel magnetic configuration shows a current peak then near-suppression around 0.14 V, while the antiparallel configuration is monotonic.  
**Method**: First-principles non-equilibrium Green's functions combined with density functional theory applied to an altermagnetic tunnel junction incorporating quasi-2D Fermi-surface physics of orbital-ordered KV2Se2O to compute bias-dependent I–V and TMR.  
**Tags**: `altermagnetic, tunneling_magnetoresistance, negative_differential_resistance, non_equilibrium_greens_function, density_functional_theory, orbital_order, KV2Se2O, nonlinear_transport, spintronics`
...
### [14] [Terahertz detection within charge density wave state](https://arxiv.org/abs/2605.12949)
*Zhi Li*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.12949)

**TL;DR**: Charge-density-wave (CDW) materials are predicted to enable electrically tunable, room-temperature THz detectors: a static bias continuously shifts the collective-mode resonant absorption across the THz band (0→cutoff) and increases nonlinear rectification current by >10×, overcoming Drude-limit losses of conventional semiconductors.  
**Method**: Theoretical modelling/analysis of the collective electronic response of CDW states under a static bias electric field, demonstrating bias-controlled resonance frequency tuning and enhanced nonlinear rectification for THz frequencies.  
**Tags**: `quantum_devices, charge_density_wave, terahertz_detectors, nonlinear_rectification, electric-field_tunability, room_temperature`
...
### [15] [Lamb Shift of Landau Levels in Two-Dimensional Electron Systems in a Multimode Resonator](https://arxiv.org/abs/2605.13351)
*Aleksandr Shabanov, Georgy Alymov, Dmitry Svintsov*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13351)

**TL;DR**: Including many resonator modes (beyond single-mode) greatly increases softening of the cyclotron frequency in a 2D electron system; the problem reduces to coupled harmonic oscillators whose eigenfrequencies are obtained by mode-resolved self-energy and first-rank-updated eigenvalue methods.  
**Method**: Map the light–matter system to a set of coupled harmonic oscillators; compute oscillator eigenfrequencies by applying a self-energy treatment for modes in one polarization and an eigenvalue update (first-rank matrix update) technique for modes in the orthogonal polarization.  
**Tags**: `quantum_devices,multimode_resonator,cavity_QED,cyclotron_resonance,2DEG,self-energy,eigenvalue_methods`
...
### [16] [Probing Floquet topological phases via non-Hermitian skin effect of reflected waves](https://arxiv.org/abs/2605.13563)
*Fangqiao Ye, Haiping Hu*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13563)

**TL;DR**: Reflected waves from a Floquet Chern insulator exhibit a gap-dependent non-Hermitian skin effect: the non-Hermitian winding of the reflection matrix is tied to the bulk Floquet invariant via boundary resonances, and the momentum-integrated Goos–Hänchen shift of reflected wavepackets quantitatively equals the Floquet topological invariant for that quasienergy gap.  
**Method**: Use a discrete-time scattering formalism for a Floquet Chern insulator to analyze reflected waves; compute the non-Hermitian winding number of the reflection matrix, identify boundary resonances linking this winding to the bulk Floquet invariant, and relate a gap-dependent Goos–Hänchen (GH) shift — including its momentum-integrated value — to the Floquet topological invariant.  
**Tags**: `topology, Floquet, non-Hermitian_skin_effect, scattering, Goos-Hänchen_shift`
...
### [17] [Cryogenic microwave frequency combs based on quantum paraelectric superconducting resonators](https://arxiv.org/abs/2605.13571)
*Prasad Muragesh, Harikrishnan Sundaresan, Madhu Thalakulam*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13571)

**TL;DR**: An all-electrical, on‑chip cryogenic microwave frequency comb realized by phase-modulating a superconducting microwave cavity using field‑induced effective χ(2) (Pockels‑like) nonlinearity of SrTiO3 in its quantum paraelectric phase; the comb is electrically tunable via the giant, field‑dependent dielectric constant (>20,000) enabling ultra‑compact integration with cryogenic quantum devices.  
**Method**: Implement a superconducting microwave cavity incorporating SrTiO3; apply a DC/electrical field to induce an effective χ(2) nonlinearity in the quantum paraelectric SrTiO3, generating cavity phase modulation that produces an evenly spaced microwave frequency comb. Continuous tuning of the comb range is achieved by varying the SrTiO3 dielectric constant with the applied field.  
**Tags**: `quantum_devices,microwave_comb,SrTiO3,quantum_paraelectric,field-induced_chi2,superconducting_cavity,on-chip_integration,cryogenic`
...
### [18] [Shubnikov-de Haas Characterization of Superconductor-Semiconductor Heterostructures](https://arxiv.org/abs/2605.13722)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13722)

**TL;DR**: New experimental analysis uses Shubnikov–de Haas magnetoresistance data in Al/InAs hybrid heterostructures to extract 2DEG carrier density, spin–orbit coupling, and transport/quantum scattering times; those scattering times reflect metal–semiconductor coupling and can be used to infer proximity-induced superconducting gap without low-temperature device fabrication.  
**Method**: Comprehensive analysis of full magnetoresistance including SdH oscillations measured in heterostructures where an Al thin film couples to an InAs quantum-well 2DEG; fitting/extraction of density, spin–orbit strength, and transport/quantum scattering times to quantify metal–semiconductor coupling and infer proximity gap.  
**Tags**: `quantum_devices, superconductivity, proximity_effect, spin-orbit_coupling, Shubnikov-de-Haas, InAs_2DEG, scattering_times, metal-semiconductor_coupling`
...
### [19] [Magnetization-dependent and stacking-tunable Edelstein effect in two-dimensional magnet 2H-VTe2](https://arxiv.org/abs/2605.13763)
*Weiyi Pan, Jaroslav Fabian*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13763)

**TL;DR**: The paper shows via symmetry analysis and first-principles calculations that an intrinsic Edelstein effect appears in 2H-VTe2 (monolayer and bilayer) with spin-accumulation components that depend sensitively on magnetization direction and bilayer stacking; interlayer sliding (AB↔BA) can reversibly switch additional allowed spin components, making 2H-MX2 a tunable platform for Edelstein-driven spin-orbit-torque devices.  
**Method**: First-principles electronic-structure calculations combined with crystallographic symmetry analysis (D3h for monolayer; C3v for AB/BA bilayers) to determine allowed current-induced spin-accumulation components under different magnetization orientations and stacking configurations.  
**Tags**: `Edelstein_effect,2D_magnetism,spin-orbit_torque,first-principles,symmetry_analysis,stacking_control,2H-VTe2,quantum_devices`
...
### [20] [Highly Efficient Exciton Modulation in MoSe$_2$/PdSe$_2$ Heterostructures](https://arxiv.org/abs/2605.13211)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13211)

**TL;DR**: Type-I MoSe2/PdSe2 van der Waals heterostructure yields ~6× enhancement of room‑temperature A‑exciton photoluminescence (PL) and a PL quantum yield ≈6% (vs ≈1% for monolayer MoSe2). Enhancement coincides with strong B‑exciton quenching and suppression of exciton–exciton annihilation; photoluminescence excitation shows broadband (450–725 nm) enhancement, consistent with interlayer electronic coupling that redistributes exciton relaxation toward the radiative A channel without chemical or strain engineering.  
**Method**: Fabrication of a MoSe2/PdSe2 type‑I van der Waals heterostructure combined with spectroscopic characterization: steady‑state PL, power‑ and temperature‑dependent PL to probe exciton dynamics and annihilation, and photoluminescence excitation (PLE) spectroscopy to test spectral breadth of the effect; direct comparison to as‑exfoliated monolayer MoSe2.  
**Tags**: `excitons,van_der_Waals_heterostructure,interlayer_coupling,photoluminescence,exciton_recombination,exciton-exciton_annihilation,2D_semiconductors,MoSe2,PdSe2,optoelectronics`
...
### [21] [Electron - acoustic phonons scattering in quantum wells in a tilted quantizing magnetic field](https://arxiv.org/abs/2605.13274)
*M. P. Telenkov, Yu. A. Mityagin*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13274)

**TL;DR**: Derives analytic expressions for electron scattering rates by longitudinal acoustic phonons in a quantizing magnetic field tilted with respect to quantum-well layers, and analyzes how the rate changes with magnetic-field strength and orientation and with the quantum-well potential profile.  
**Method**: Analytical theoretical calculation: derive scattering-rate formulas for electron–longitudinal-acoustic-phonon interactions in a quantizing (Landau-quantized) magnetic field with arbitrary tilt to the quantum-well planes, then analyze parameter dependence (B magnitude, tilt angle, well potential).  
**Tags**: `electron_phonon, quantizing_magnetic_field, tilted_field, quantum_well, scattering_rate`
...
### [22] [Thermoelectric enhancement from an asymmetric spectral-conductivity cusp in spin-1 chiral fermions](https://arxiv.org/abs/2605.13323)
*Risako Kikuchi, Junya Endo, Ai Yamakage*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13323)

**TL;DR**: Impurity scattering in spin-1 chiral-fermion systems creates an asymmetric cusp in the spectral conductivity that significantly enhances low-temperature thermoelectric response (Seebeck coefficient and electronic figure of merit); enhancement increases with curvature of the trivial band and is strongest for a sharp, highly asymmetric cusp with small spectral conductivity at the cusp energy.  
**Method**: Linear-response calculation of thermoelectric coefficients within the self-consistent Born approximation to treat impurity scattering, complemented by a minimal analytical 'cusp' model of the spectral conductivity to identify parameter regimes maximizing the enhancement.  
**Tags**: `impurity_scattering,thermoelectric,spin-1_chiral_fermions,self_consistent_Born_approximation,spectral_conductivity,Seebeck,figure_of_merit`
...
### [23] [An Effective Scaling Framework for Non-Adiabatic Mode Dynamics](https://arxiv.org/abs/2605.13376)
*A. M. Tishin*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13376)

**TL;DR**: Nonlinear spectral feedback (a frequency regulator U) can saturate non-adiabatic parametric amplification in driven structured media: beyond a critical regulator strength exponential mode growth is suppressed and the system crosses over to a bounded, low-occupancy response (spectral blockade).  
**Method**: Analytical formulation of a non-adiabaticity parameter and a scaling ratio comparing non-adiabatic drive versus nonlinear spectral detuning; incorporation of a nonlinear frequency regulator U into the effective theory; numerical verification via time-dependent simulation in an expanded 100-level bosonic Fock basis showing crossover from hyperbolic (exponential) amplification to bounded dynamics.  
**Tags**: `non-adiabaticity,parametric_amplification,nonlinear_regulator,spectral_blockade,bosonic_Fock_basis,driven_structured_media`
...
### [24] [Enhanced Near-Field Thermal Radiation Driven by Multiple Corner and Edge Modes in Subwavelength Square Nanowires](https://arxiv.org/abs/2605.13712)
*Jose Ordonez-Miranda, Minggang Luo, Michele Diego, Roman Anufriev, Victor Guillemot, Masahiro Nomura, Sebastian Volz*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2605.13712)

**TL;DR**: Near-field radiative heat transfer between subwavelength SiC square nanowires is governed by multiple corner and edge resonances (not the planar surface-phonon-polariton), which lie in the SiC Reststrahlen band, redshift for thinner wires, and can enhance thermal conductance up to fourfold when the interwire gap is comparable to wire thickness.  
**Method**: Fluctuational electrodynamics simulations of paired SiC nanowires with square cross sections, mapping resonance spectra, thickness and gap dependence, and computing resulting thermal conductance enhancements.  
**Tags**: `near-field_heat_transfer, phonon-polaritons, nanowires, fluctuational_electrodynamics, Reststrahlen_band, geometry-controlled_heat_transfer`
