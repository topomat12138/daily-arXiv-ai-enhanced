...
### [1] [Unveiling the Superconducting Ground State of Heusler alloy Pd2ZrIn via muon spin relaxation and rotation measurement](https://arxiv.org/abs/2604.19283)
*Kavita Yadav, Anoop M Divakaran, Jumpei G. Nakamura, Tsunehiro Takeuchi, K. Mukherjee*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19283)

**TL;DR**: Pd2ZrIn (full Heusler, L21 with strong B2 antisite disorder) is a bulk type-II, weakly‑coupled, dirty‑limit superconductor (TC ≈ 2.2 K) with a fully gapped, nodeless s‑wave order parameter and preserved time‑reversal symmetry.  
**Method**: Transport (resistivity), magnetic susceptibility and muon-spin rotation/relaxation (μSR) measurements (ZF-μSR to test TRS; TF-μSR to probe vortex lattice and superfluid density), analysis of gap magnitude and Uemura TC/TF placement.  
**Tags**: `superconducting_impurity,vortex,muSR,s-wave,dirty_limit,time-reversal-symmetry`
...
### [2] [AngstromPro: A versatile software for massive N-dimensional STM data management, visualization and in-depth analysis](https://arxiv.org/abs/2604.18962)
*Huiyu Zhao, Jiahao Yan, Catherine Dawson, Haitao Yang, Hong-Jun Gao*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.18962)

**TL;DR**: AngstromPro is an open-source, modular Python package for managing, visualizing and analyzing large STM image datasets, providing built-in image-processing algorithms (background subtraction, perfect-lattice and Lawler–Fujita corrections, sub-atomic registration), GUI/Data separation, processing histories, and extensibility for custom modules.  
**Method**: Software engineering approach: a top-level manager maintains a Global Variables List and a list of modular sub-modules each with Local Variables Lists; separation of GUI from processing logic; embedded standard and recent STM algorithms enabling stepwise processing, reproducible histories, and plugin-style extensibility.  
**Tags**: `scanning_tunneling_microscopy,STM,data_analysis,image_processing,Lawler-Fujita, lattice_correction,software,reproducibility,quantum_devices`
...
### [3] [Competing Constraints on Superconductivity in Thick FeSe films](https://arxiv.org/abs/2604.19443)
*Ya-Xun He, Xing-Jian Liu, Qun Wang, Ting Chen, Hassan Ali, Jia-Ying Zhang, Bao-Juan Kang, Zheng Zhang, Jun-Yi Ge*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19443)

**TL;DR**: High-throughput off‑center pulsed laser deposition creates combinatorial FeSe film libraries with continuous gradients in lattice parameter, composition, and disorder; a competition between c‑axis expansion, stoichiometry, and defect scattering shifts the maximum Tc off the plume center and constrains Tc to a narrow optimization window (Tconset up to 17.1 K).  
**Method**: Combinatorial synthesis via off‑center pulsed laser deposition to produce spatial gradients in lattice parameter/composition/disorder across thick (>50 nm) FeSe films, systematic characterization of 80 samples, and interpretable machine‑learning analysis to identify key correlates (c‑axis, stoichiometry, disorder) and their constrained optimization landscape.  
**Tags**: `machine_learning, superconductivity, FeSe, pulsed_laser_deposition, combinatorial_synthesis, strain_engineering, stoichiometry, disorder_scattering, optimization_landscape`
...
### [4] [Spatially-resolved voltage-reversal due to Bernoulli potentials in dissipative Bi$_2$Sr$_2$CaCu$_2$O$_{8+x}$](https://arxiv.org/abs/2604.19467)
*Sharadh Jois, Gregory M. Stephen, Samuel W. LaGasse, Genda Gu, Aubrey T. Hanbicki, Adam L. Friedman*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19467)

**TL;DR**: In Bi2Sr2CaCu2O8+x Hall-bar devices with invasive voltage contacts, above the critical current and in applied magnetic field the authors observe longitudinal differential voltages of equal magnitude but opposite sign on the two edges; the effect is independent of field reversal. They attribute it to particle–hole symmetry breaking in moving vortices: invasive contacts create hotspots that nucleate vortices with opposing edge velocities, producing opposite Bernoulli potentials. The finding constrains understanding of dissipative current flow in layered superconductors.  
**Method**: Experimental magneto-transport and critical-current measurements on Bi2Sr2CaCu2O8+x Hall-bar devices, comparing longitudinal differential voltages at opposite edges under applied magnetic field and varying contact geometry (invasive vs non-invasive).  
**Tags**: `vortex,layered_superconductors,magneto-transport,Hall_bar,particle-hole_symmetry,Bernoulli_potential,contact_effects,critical_current`
...
### [5] [Observation of field-odd and field-free superconducting diode effects in $\mathrm{Mo}_2\mathrm{C}$ nanoflakes](https://arxiv.org/abs/2604.19525)
*Wei Gao, Kaixuan Fan, Menghan Li, Jinhao Cheng, Qing Zhang, Shuaishuai Ding, Wenping Hu, Fan Yang, Dechao Geng, Hechen Ren*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19525)

**TL;DR**: CVD-grown Mo2C nanoflakes (nominally centrosymmetric) exhibit both field-odd and field-free superconducting diode effects; transport measurements show tunable diode efficiency >40% at 4 K and intrinsic behavior confirmed by out-of-plane field sweeps, with domain-boundary supercurrents or CDW-like order proposed as drivers.  
**Method**: Experimental low-temperature transport characterization of chemical-vapor-deposited Mo2C nanoflakes: in-plane magnetic-field sweeps (perpendicular orientation), out-of-plane field sweeps, field-cooling tests; measurement of nonreciprocal critical currents/diode efficiency at 4 K.  
**Tags**: `nonreciprocal_superconductivity, superconducting_diodes, Mo2C, charge_density_wave, domain_walls, quantum_devices`
...
### [6] [Competition and coexistence of superconductivity and nematic order in a two-dimensional electron gas with quadrupolar interactions](https://arxiv.org/abs/2604.18777)
*Nei Lopes, Guilherme da Silva do Vale, Daniel G. Barci*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.18777)

**TL;DR**: Mean-field analysis of a 2D electron gas with s- and d-wave pairing plus quadrupolar forward-scattering finds strong competition between nematic order and d-wave superconductivity (yielding a direct first-order transition at T=0), whereas s-wave pairing can coexist with nematic order producing an anisotropic Fermi surface with a uniform gap. At finite temperature quadrupolar interactions can induce additional superconducting components and extended coexistence regimes of s-wave, d-wave and nematic order. The paper maps phase diagrams as functions of interaction strengths and temperature.  
**Method**: Mean-field calculation of the free-energy density with coupled self-consistent gap and nematic order equations; numerical solution across interaction-strength and temperature space to construct phase diagrams including first-order and coexistence transitions.  
**Tags**: `nematic_order, superconductivity, s-wave, d-wave, quadrupolar_interactions, mean-field, phase_diagram, coexistence, first-order_transition`
...
### [7] [Stripping Symmetry: Electrochemical Oxidation to a Superconducting Polar Metal in Au2Pb0.914P2](https://arxiv.org/abs/2604.18843)
...
**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.18843)

**TL;DR**: Electrochemical topotactic deintercalation of Pb from centrosymmetric Au2PbP2 produces a metastable polar, noncentrosymmetric metal Au2Pb0.914P2. The partial Pb removal drives cooperative electronic–structural symmetry-breaking (second-order Jahn–Teller and lone-pair effects) locking a (3+1)D modulated Ama2(01g)ss0 superspace structure; polarity is confirmed by nonlinear transport. The compound is a type-II superconductor (Tc = 1.52 K) with power-law heat-capacity and AC-susceptibility signatures consistent with gap structure influenced by broken inversion symmetry. The work demonstrates electrochemical oxidation as a route to metastable noncentrosymmetric superconductors.  
**Method**: Electrochemical topotactic deintercalation (Pb removal) to induce symmetry-breaking synthesis; structural determination by synchrotron single-crystal X-ray diffraction solving the full (3+1)D modulated superspace; polarity verified via nonlinear electronic transport; superconducting properties probed by heat capacity and AC susceptibility measurements.  
**Tags**: `noncentrosymmetric_superconductor, polar_metal, electrochemical_deintercalation, topotactic_synthesis, (3+1)D_modulated_structure, synchrotron_XRD, second-order_Jahn-Teller, stereochemically_active_lone_pair, type-II_superconductor, gap_symmetry`
...
### [8] [Pseudogap and Condensation in Cuprate Superconductors from NMR Shifts](https://arxiv.org/abs/2604.19215)
*Abigail Lee, Juergen Haase*

**Category**: cond-mat.supr-con  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19215)

**TL;DR**: Using only symmetry of two Cu hyperfine couplings (anisotropic A_α and isotropic B), the paper disentangles planar Cu NMR shifts into two distinct spin components (A and B). Upon doping, metallic B-spins appear above the pseudogap temperature and grow with doping (the B density of states increases sharply above x≈0.20 where the pseudogap vanishes), while A changes less; the pseudogap temperature reflects the coupling between A and B that suppresses NMR shifts but not nuclear relaxation. Spin-singlet pairing involves both components under three phenomenological condensation rules; optimal T_c requires a specific A–B match and the highest T_c is linked to nuclear relaxation and Cu–O charge sharing rather than the shifts.  
**Method**: Phenomenological, symmetry-based analysis of extensive planar Cu and O NMR datasets across many cuprates: assume two Cu hyperfine couplings (anisotropic A_α and isotropic B), disentangle measured Knight shifts into two components, track their doping- and temperature-dependence, and correlate shift behavior with pseudogap, nuclear relaxation, and superconducting condensation.  
**Tags**: `superconductivity,pseudogap,NMR,hyperfine_interactions,cuprates,nuclear_relaxation,spin_singlet,charge_sharing`
...
### [9] [Photonic Chirality for Braiding and Readout of Non-Abelian Anyons](https://arxiv.org/abs/2604.19456)
*Netzer Moriya*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19456)

**TL;DR**: Proposes a cavity-QED scheme that uses photonic chirality to create a rotating, branch-conditioned pinning potential in a fractional quantum Hall system that braids non-Abelian anyons and maps the braid outcome onto cavity intermode coherence for readout—minimal Ising (four-anyon) realization yields a calibrated phase signal; avoids electronic interferometry.  
**Method**: Theoretical proposal and effective-theory derivation: counter-propagating cavity modes interfered with a classical reference tone produce a rotating pinning landscape whose rotation direction is set by photon circulation. Opposite photonic branches drive opposite anyon loops (branch-conditioned braid). The authors derive the rotating-pinning term and a readout relation at the effective-theory level, identify an operating window constrained by subgap driving, adiabatic transport, localization, and cavity coherence, and give phenomenological diagnostics; readout is extracted from cavity intermode coherence (phase or state-dependent signal).  
**Tags**: `topology, quantum_computing, quantum_devices, cavity_QED, fractional_quantum_Hall, non_Abelian_anyons, braiding, readout`
...
### [10] [Landauer-based study of transport in Chern insulator heterostructures](https://arxiv.org/abs/2604.19581)
*J. Luna-Ramos, A. Martín-Ruiz*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19581)

**TL;DR**: Analytical study of charge transport through a trivial–topological–trivial junction in the Qi–Wu–Zhang continuum model: mass inversion at the central slab produces Klein tunneling and finite Berry-curvature–driven nonlinear responses. Closed-form linear and nonlinear conductances (including temperature dependence), effects of dephasing on Fabry–Pérot oscillations, and parameter regimes with enhanced rectification are identified.  
**Method**: Match continuum Dirac/Qi–Wu–Zhang wave functions across interfaces to compute angle- and energy-resolved transmission; incorporate transmission into a Landauer–Büttiker framework to derive closed-form linear and nonlinear conductances (finite-T). Model partial dephasing to assess coherence loss and map transport vs barrier height, slab thickness, and topological mass.  
**Tags**: `topology, quantum_geometry, quantum_devices, quantum_transport, Chern_insulator, Klein_tunneling, Landauer-Büttiker, nonlinear_transport, dephasing`
...
### [11] [Large Scale Optimization of Disordered Hubbard Models through Tensor and Neural Networks](https://arxiv.org/abs/2604.18711)
*Jacob R. Taylor, Sankar Das Sarma*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.18711)

**TL;DR**: Vision-based neural networks trained on tensor-network–generated charge-stability maps can infer on-site disorder and enable local tuning of 2D disordered quantum-dot spin-qubit arrays using a simulatable 3×3 sliding window. For the experimentally relevant case (only on-site disorder unknown) the network achieves R^2>0.99 on 3×3 data and ≈0.98 for the central dot of a 5×5 after limited fine-tuning; when all dot parameters are unknown, on-site disorder remains recoverable (R^2>0.9) while other parameters are much harder to infer.  
**Method**: Train vision-style neural networks on charge-stability diagrams produced by tensor-network ground-state simulations; use a local 3×3 sliding-window inference scheme to predict site parameters for tuning, and apply limited fine-tuning on a few larger-device samples to extend accuracy to 5×5 arrays, avoiding full-system many-body diagonalization.  
**Tags**: `machine_learning,quantum_devices,spin_qubits,quantum_dot_arrays,tensor_networks,disorder,calibration,sliding_window,neural_networks`
...
### [12] [Proximitized Topological Insulator Charge Island Fabricated via In Situ Multi-Angle Stencil Lithography](https://arxiv.org/abs/2604.18736)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.18736)

**TL;DR**: They demonstrate a fully in situ multi-angle stencil-lithography process that fabricates superconducting Al-proximitized (Bi,Sb)2Te3 nanoribbon charge islands with ultrathin oxide tunnel barriers and diffusion barriers, yielding Coulomb blockade and a magnetic-field-sensitive suppression of low-energy conductance consistent with proximity-induced superconductivity.  
**Method**: Combine selective-area growth of (Bi,Sb)2Te3 nanoribbons with angle-controlled, in situ deposition of diffusion barriers, superconducting Al, and ultrathin oxide tunnel barriers via multi-angle stencil lithography (no post-growth processing); characterize devices with low-temperature transport showing Coulomb blockade and field-dependent conductance suppression.  
**Tags**: `topology, superconductivity, proximity_effect, hybrid_superconductor_TI, stencil_lithography, Coulomb_blockade, quantum_devices`
...
### [13] [Optical conductivity of topological semimetal Nb$_{2n+1}$Si$_n$Te$_{4n+2}$](https://arxiv.org/abs/2604.19166)
*Seongjin Ahn*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19166)

**TL;DR**: Analytical study of linear optical conductivity in layered Nb_{2n+1}Si_nTe_{4n+2} with a quasi-1D nodal-line electronic structure: at T=0 the Drude weight is strongly anisotropic (finite along the nodal-line at charge neutrality; vanishes ∝E_F^2 transversely), while interband conductivity is linear in frequency in both directions with direction-dependent slope. Leading finite-temperature corrections are small, leaving T=0 trends valid at experimental temperatures.  
**Method**: Analytic zero-temperature calculation of intraband (Drude) and interband optical conductivities for a quasi-one-dimensional nodal-line model of Nb_{2n+1}Si_nTe_{4n+2}, plus perturbative evaluation of leading finite-temperature corrections.  
**Tags**: `topology, quantum_geometry, optical_conductivity, nodal_line, anisotropic_transport, van_der_Waals`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19304)

**TL;DR**: Perspective proposing magnetic domain walls as a platform for universal quantum computation: they exploit nanoscale creation/control and high mobility to realize both stationary and flying qubits; the paper synthesizes required ingredients, candidate material platforms, and key experiments while assessing challenges and opportunities at the magnetism–quantum information interface.  
**Method**: A perspective/roadmap study that synthesizes recent experimental advances (notably high-mobility, nanoscale control/probing of domain walls) with theoretical requirements to outline architectures, necessary ingredients, candidate material platforms, and experimental milestones for realizing domain-wall–based universal quantum computation.  
**Tags**: `quantum_computing, quantum_devices, magnetism, spintronics, domain_walls, flying_qubits`
...
### [15] [Josephson diode effect in multichannel Rashba nanowires: role of inter-subband coupling](https://arxiv.org/abs/2604.19385)
*Ardamon Sten, Sudeep Kumar Ghosh*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19385)

**TL;DR**: Inter-subband (multichannel) hybridization in Rashba nanowire Josephson junctions qualitatively changes the topological phase diagram and strongly enhances the Josephson diode effect (JDE). The topological phase becomes restricted to a finite Zeeman-field window where Majorana bound states amplify diode efficiency. Crucially, inter-subband coupling produces a finite diode response even for Zeeman fields aligned along the spin-orbit direction—absent in single-channel/1D models—and increases spectral asymmetry and overall diode efficiency relative to single-channel junctions.  
**Method**: Theoretical analysis of multichannel Rashba nanowire Josephson junctions including inter-subband coupling (subband hybridization); computation/characterization of the modified topological phase diagram and Josephson diode response (spectral asymmetry, diode efficiency) as functions of Zeeman field and coupling.  
**Tags**: `topology, superconductivity, quantum_devices, Rashba_spin-orbit, multichannel_transport, Majorana`
...
### [16] [Supermoiré domain-resolved effective Hamiltonians and valley topology in helical multilayer graphene](https://arxiv.org/abs/2604.19608)
*Kyungjin Shin, Nicolas Leconte, Jeil Jung, Hongki Min*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19608)

**TL;DR**: Helical multilayer (e.g., trilayer) moiré graphene relaxes into locally periodic single-moiré domains; within each domain the low-energy bands decompose into folded Dirac sectors whose topology (valley Chern numbers) is domain-dependent and gate-tunable, providing a domain-resolved continuum organizing principle for thicker helical stacks.  
**Method**: Real-space lattice relaxation calculations to find reconstructed single-moiré domains; construction of continuum/domain-resolved effective Hamiltonians by downfolding a first-shell model near Dirac points; computation of valley Chern numbers to extract domain-dependent, gate-tunable topological responses, validated against lattice spectra.  
**Tags**: `topology, quantum_geometry, moiré, helical_multilayer_graphene, valley_chern, continuum_downfolding, lattice_relaxation`
...
### [17] [Localization and universality of three-dimensional pseudospin-$s$ fermions](https://arxiv.org/abs/2604.18690)
*Arpan Gupta, Gargee Sharma*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.18690)

**TL;DR**: Unified semiclassical and quantum-interference theory for 3D disordered multifold chiral fermions with arbitrary pseudospin s. The leading weak (anti)localization correction has universal magnitude equal to conventional metals/Weyl fermions; its sign is fixed by parity of 2s (half-integer s → symplectic/WAL, integer s → orthogonal/WL). For s=3/2, interband/intervalley scattering mixes channels, suppresses WAL and can drive a crossover toward localization.  
**Method**: Start from a general short-range matrix disorder M to derive compact expressions for elastic lifetimes and ladder vertex corrections including multiband effects for arbitrary pseudospin; build a unified semiclassical transport and quantum-interference framework and solve coupled Bethe–Salpeter equations (for s=3/2) to study channel mixing and the WL/WAL crossover.  
**Tags**: `weak_localization, weak_antilocalization, pseudospin, multifold_chiral_fermions, disorder, Bethe-Salpeter, multiband_disorder, Weyl_fermions, symmetry_classes, quantum_geometry`
...
### [18] [$P$-wave Orbital Magnetism](https://arxiv.org/abs/2604.18695)
*Yantao Li, Pavlo Sukhachov*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.18695)

**TL;DR**: Proposes a new mechanism for odd-parity (p-wave) magnetism arising from loop-current–induced orbital textures rather than noncollinear spins. The p-wave orbital order is symmetry-protected (combined translation × time-reversal), produces no net magnetization, appears in a 2D lattice model with Dirac points and topology controlled by loop-current amplitude, and is detectable via orbital Hall conductivity.  
**Method**: Analytical/theoretical construction and analysis of a two-dimensional lattice tight-binding model with loop currents that generate an orbital texture. Band-structure analysis identifies Dirac points and topology as a function of loop-current magnitude; symmetry arguments establish protection by combined translation and time-reversal and predict the emergence of even-parity components when that symmetry is broken. Proposes orbital Hall conductivity as an experimental probe.  
**Tags**: `topology,p-wave_magnetism,orbital_magnetism,loop_currents,Dirac_points,orbital_Hall_conductivity,odd-parity_magnetism`
...
### [19] [Ultrafast Light-Induced Magnetoelectric Effect in van der Waals Magnetic Semiconductor Heterostructures](https://arxiv.org/abs/2604.19080)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19080)

**TL;DR**: Ultrafast optical excitation of a WS2/CrGeTe3 vdW bilayer reverses the sign of the photoinduced magnetic torque compared to isolated CGT; charge transfer across the type-II interface modifies perpendicular magnetic anisotropy and thereby launches precessional magnetization, and optically generated spin currents from WS2 can also drive precession.  
**Method**: Time-resolved magneto-optic Kerr effect (TR-MOKE) experiments on WS2/CGT bilayers combined with density functional theory (DFT) calculations and Landau–Lifshitz–Gilbert (LLG) simulations to identify a charge-transfer–induced change in perpendicular magnetic anisotropy as the torque mechanism; analysis also considers angular-momentum transfer from optically generated spin currents.  
**Tags**: `vdW_heterostructure, ultrafast_magnetization, charge_transfer, perpendicular_magnetic_anisotropy, spin_current, TR-MOKE, DFT, LLG, quantum_devices`
...
### [20] [Quantum transport in gapped graphene under strain and laser--electrostatic barriers](https://arxiv.org/abs/2604.19297)
*Hasna Chnafa, Clarence Cortes, David Laroze, Ahmed Jellal*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19297)

**TL;DR**: Laser-modulated barrier transport in gapped graphene is analyzed: raising gap or scalar potential reduces transmission in central and lower sidebands; moderate uniaxial zigzag strain induces Fano-type oscillations (which disappear at large strain) and modifies transmission depending on potential; barrier width and incidence energy shift and modulate resonances in upper sideband; larger laser amplitude enhances transmission while higher laser frequency suppresses it. Results indicate controllable electronic transport for gapped graphene via strain, potentials, and laser fields.  
**Method**: Transfer-matrix calculation with appropriate boundary conditions to obtain transmission probabilities through a laser-modulated barrier in gapped graphene with a scalar potential and uniaxial zigzag strain; analysis of central and sideband transmissions as functions of gap, potential, strain, barrier width, laser amplitude and frequency.  
**Tags**: `graphene,electronic_transport,laser_driven,transfer_matrix,energy_gap,zigzag_strain,Fano_resonances,sidebands,quantum_devices,optoelectronics`
...
### [21] [Towards Application of Nanodiamonds for in-situ Monitoring of Radicals in Liquid Phase Chemical Reactions](https://arxiv.org/abs/2604.19433)
*Emma Herbst, Sebastian Westrich, Alena Erlenbach, Jonas Gutsche, Maria Wächtler, Elke Neu*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19433)

**TL;DR**: Demonstration of in-situ detection of the nitroxide radical TEMPO via NV-center longitudinal spin relaxation (T1) relaxometry using nanodiamonds deposited on a cuvette wall; T1 shortens with TEMPO concentration (197±21 µs → 66±30 µs at 1 M), sensitivity reaches nanomolar concentrations with SNR ≈1.6–3.  
**Method**: NV-center T1 relaxometry on nanodiamonds deposited onto the inner wall of a glass cuvette, measuring concentration-dependent shortening of NV longitudinal relaxation time due to magnetic fluctuations from TEMPO unpaired electrons.  
**Tags**: `quantum_devices, NV_centers, T1_relaxometry, spin_sensing, nanodiamonds, radical_detection, TEMPO, radical_sensing`
...
### [22] [Nonequilibrium Kramers Turnover in a Kerr Parametric Oscillator](https://arxiv.org/abs/2604.19527)
*Daniel K. J. Boneß, Gabriel Margiani, Wolfgang Belzig, Alexander Eichler, Oded Zilberberg*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19527)

**TL;DR**: The authors identify and observe an analogue of Kramers turnover in an out-of-equilibrium Kerr parametric oscillator: by rescaling rotating-frame dynamics they introduce a tunable effective friction (and concomitant effective temperature) controlled by the parametric drive, enabling extraction of a nonmonotonic prefactor crossover from temperature-dependent measurements. They confirm the predicted turnover experimentally via noise-induced phase-slip rates in a micro-electromechanical device.  
**Method**: Analytical mapping of driven-dissipative Kerr parametric-oscillator dynamics to a rescaled rotating-frame description that decouples intrinsic damping via a drive-tunable effective friction and effective temperature, combined with temperature-dependent measurements of noise-induced phase slips in a micro-electromechanical experiment.  
**Tags**: `kramers_turnover, driven_dissipative, kerr_parametric_oscillator, activation_dynamics, effective_friction, effective_temperature, noise_induced_switching, microelectromechanical, quantum_devices`
...
### [23] [Landau levels and magneto-optics in 30$^\circ$ quasi-periodic twisted bilayer graphene](https://arxiv.org/abs/2604.18854)
*Masaru Hitomi, Takuto Kawakami, Mikito Koshino*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.18854)

**TL;DR**: Theory for Landau levels in 30° twisted bilayer graphene (a quasicrystalline, non‑periodic system with 12‑fold rotational symmetry). Using a quasi‑band formalism with magnetic field introduced via momentum substitution, the authors identify Landau levels as quantized orbits of quasi‑band pockets, predict nearly flat, weakly B‑dependent bands and highly degenerate levels from twelve off‑center pockets, classify states by Landau index and quasicrystalline angular momentum, and compute magneto‑optical conductivity with 12‑fold angular‑momentum selection rules.  
**Method**: Quasi‑band formalism built from the zero‑field Hamiltonian; magnetic field included by conventional momentum substitution. Landau levels obtained as quantized orbits of quasi‑band pockets and classified by Landau index plus angular momentum tied to 12‑fold symmetry. Magneto‑optical conductivity computed to extract symmetry‑enforced optical selection rules.  
**Tags**: `twisted_bilayer_graphene,quasicrystal,Landau_levels,magneto-optics,quasi-band_formalism,12-fold_symmetry`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19164)

**TL;DR**: Microwave-driven resonant excitation of a domain wall pinned by a Pt stripline in a ferrimagnetic garnet yields a low-frequency localized mode inside the magnon gap; nonlinear driving reduces the external field required for depinning and, with increased power, produces partial relocation and eventual escape from the pinning site. Experimental identification uses scanning NV magnetometry and nonlocal spin‑pumping, supported by micromagnetic simulations.  
**Method**: Combined experimental and computational approach: resonant microwave drive of a pinned domain wall probed by scanning nitrogen‑vacancy (NV) magnetometry and nonlocal spin‑pumping measurements to detect a localized low‑frequency mode; micromagnetic simulations to map the nonlinear progression from localized oscillation to depinning and escape.  
**Tags**: `magnetic_textures, domain_wall, ferrimagnet, resonant_excitation, magnon_gap, nonlinear_dynamics, scanning_NV_magnetometry, spin_pumping, micromagnetic_simulation, pinning`
...
### [25] [When heat goes astray -- non-local heating in a semiconductor](https://arxiv.org/abs/2604.19203)
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19203)

**TL;DR**: Focused laser heating of laterally structured semiconductor membranes produces non-local lattice heating extending several micrometers; ballistic phonon transport (far above cryogenic temperatures) causes heat spots to decouple from the laser absorption region and leads to violations of Fourier’s law, with remote heating sometimes exceeding local heating.  
**Method**: Experimentally heat laterally patterned semiconductor membranes with a tightly focused laser while varying interface density, and map lattice temperatures using Raman thermometry; attribute observed micron-scale non-local temperature rises to ballistic phonon transport.  
**Tags**: `ballistic_phonon_transport, nonlocal_heat_transport, Fourier_law_violation, Raman_thermometry, semiconductor_membranes, thermal_management`
...
**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19239)

**TL;DR**: Rigorous discrete-to-continuum Γ-convergence derivation showing that particle systems with frame‑invariant, lattice‑favoring interactions and finite surface‑energy scaling converge to a continuum model of polycrystals: piecewise‑constant orientation fields with interfacial energy concentrated on grain boundaries. The interfacial density depends on the two grain orientations and the interface normal, and—because rigid interactions preclude smooth solid–solid transition layers—reduces to twice the solid–vacuum transition energy.  
**Method**: Mathematical Γ-convergence (discrete‑to‑continuum) analysis of a frame‑invariant atomistic energy that penalizes deviations from local isometry to a reference lattice; study of configurations with finite surface‑energy scaling, identification of limiting piecewise constant orientation fields, and characterization of the interfacial energy density on grain boundaries under rigidity assumptions.  
**Tags**: `Γ-convergence, discrete-to-continuum, polycrystalline, grain_boundaries, atomistic_model, surface_energy, crystal_orientation`
...
### [27] [Intra- and Interlayer Excitonic Fine Structure of the Two-Dimensional Perovskite (PEA)$_2$PbI$_4$](https://arxiv.org/abs/2604.19327)
*Patrick Grenzer, Fabian Lie, Klaus H. Eckstein, Tobias Hertel, Linn Leppert*

**Category**: cond-mat.mes-hall  
**Abstract**: [arXiv](https://arxiv.org/abs/2604.19327)

**TL;DR**: Polarization-resolved low-temperature PL combined with first-principles G0W0+BSE calculations disentangle the excitonic fine structure of n=1 (PEA)2PbI4: the low-energy multiplet is a purely intralayer excitonic fine structure set by crystal symmetry, octahedral distortions and the two-layer unit cell (not Rashba or exciton-polaron effects), while a weaker doublet ~45 meV higher is identified as interlayer excitons whose optical visibility is enhanced by distortion-induced mixing with bright intralayer states.  
**Method**: Experimental polarization-resolved low-temperature photoluminescence measurements correlated with ab initio quasiparticle and excitonic calculations (G0W0 + Bethe–Salpeter equation); symmetry analysis of octahedral distortions and two-layer unit-cell effects; comparison of calculated energies, splittings and oscillator strengths with observed spectra.  
**Tags**: `2D_perovskites,excitons,interlayer_excitons,intralayer_excitons,exciton_fine_structure,G0W0-BSE,photoluminescence,octahedral_distortions,Rashba,exciton-polaron`
